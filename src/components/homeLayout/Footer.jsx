				...
				<div className="grid grid-cols-1 md:grid-cols-5 gap-10">
					...
					<div className="md:col-span-2 space-y-4">
						...
						<p className="text-xs text-white/50 leading-relaxed max-w-sm">
							Licensed Banking-as-a-Service infrastructure providing real-time
							local collections, payouts, treasury and cards across Africa.
						</p>
					...
					<div>
						...
						<ul className="space-y-2.5 text-xs text-white/60">
							...
							<li>
								<a href="/fx" className="hover:text-white transition-colors">
									Treasury & FX
								</a>
							</li>
						</ul>
