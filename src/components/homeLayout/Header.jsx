...
export default function Header() {
	...
	useEffect(() => {
		const handleMouseMove = (e) => {
			const targets = document.querySelectorAll(
				".nav-item, .panel-card, .btn-primary, .btn-secondary, .social-icon, .top-tab",
			);
			targets.forEach((el) => {
	...
	const checkClosePanel = () => {
		...
		if (
			!mouseInTriggersRef.current &&
			!mouseInPanelRef.current &&
			!isPinnedByClick
		) {
	...
	return (
		<>
			...
			>
				...
				<div
					id="top-bar"
					className="max-w-[1240px] mx-auto mb-2 overflow-hidden transition-all duration-300"
				>
					<div className="flex items-center justify-between px-4 py-1.5 rounded-full bg-white/[0.02] border border-white/5 text-xs text-white/50">
							...
							<div className="overflow-hidden max-w-md">
								<div className="fx-ticker">
									<div className="fx-pair">
										<span class="text-white/60">USD/NGN</span>
										<span className="text-white font-medium">1,520.50</span>
										<span className="fx-change positive">+0.2%</span>
									</div>
									<div className="fx-pair">
										<span class="text-white/60">USD/KES</span>
										<span className="text-white font-medium">128.75</span>
										<span className="fx-change positive">+0.5%</span>
									</div>
									<div className="fx-pair">
										<span class="text-white/60">USD/GHS</span>
										<span className="text-white font-medium">15.20</span>
										<span className="fx-change negative">-0.1%</span>
									</div>
									<div className="fx-pair">
										<span class="text-white/60">EUR/XOF</span>
										<span className="text-white font-medium">655.95</span>
										<span className="fx-change positive">+0.0%</span>
									</div>
									<div className="fx-pair">
										<span class="text-white/60">USD/ZAR</span>
										<span className="text-white font-medium">18.45</span>
										<span className="fx-change positive">+0.3%</span>
									</div>
								</div>
							</div>
						</div>
						...
						<div className="hidden lg:flex items-center gap-1 mx-auto">
							<a href="/" className="top-tab active">
								<span className="border-ring"></span>Personal
							</a>
							<a href="/business" className="top-tab">
								<span className="border-ring"></span>Business
							</a>
							<a href="/developers" className="top-tab">
								<span className="border-ring"></span>Developers
							</a>
							<a href="/enterprise" className="top-tab">
								<span className="border-ring"></span>Enterprise
							</a>
						</div>
				...
				<div className="max-w-[1240px] mx-auto">
					<div className="glass-pill rounded-full px-4 py-2 flex items-center justify-between border border-white/10 shadow-2xl relative">
						...
						{/* Desktop Navigation */}
						<div
							className={`nav-zone hidden lg:block ${activePanel ? "is-open" : ""}`}
							id="nav-zone"
						>
							<nav className="flex items-center gap-1">
								{["product", "solutions", "developers", "resources"].map(
									(panelKey) => (
										<button
											key={panelKey}
								...
								<a
									href="/pricing"
									className="nav-item px-4 py-1.5 text-[13.5px] font-medium text-white/80 hover:text-white"
								>
									<span className="border-ring"></span>
									Pricing
								</a>
							...
							>
								{/* PANE: Product */}
								<div
									className={`panel-pane ${activePanel === "product" ? "active" : ""}`}
								>
									<div className="panel-split">
										<div className="panel-featured">
											...
											<svg className="animated-svg-wave" viewBox="0 0 200 200">
												<path
													...
													stroke="#10b981"
													strokeWidth="1.5"
													d="M 10 80 Q 50 10 100 80 T 190 80"
												/>
												<path
													fill="none"
													stroke="#34d399"
													strokeWidth="1"
													d="M 10 110 Q 50 40 100 110 T 190 110"
												/>
												<path
													fill="none"
													stroke="#0ea5e9"
													strokeWidth="0.75"
													d="M 10 140 Q 50 70 100 140 T 190 140"
												/>
											</svg>
											<div>
												...
												<h3 class="font-display font-bold text-white text-xl mt-3 leading-snug">
													Product Infrastructure
												</h3>
												<p className="text-xs text-white/60 mt-1.5 leading-relaxed">
													Unified API engine connecting 40+ fiat & digital rails
													across Africa.
												</p>
											</div>
											<div className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between">
												...
												<a
													href="/platform"
													className="w-8 h-8 rounded-full bg-emerald-500/20 hover:bg-emerald-500 text-emerald-400 hover:text-slate-950 flex items-center justify-center transition-all"
												>
										...
										<div className="p-4 grid grid-cols-2 gap-2.5 bg-[#080c14]/50">
											<a href="/platform" className="panel-card">
												<span className="border-ring"></span>
												<div className="panel-card-icon bg-blue-500/15 border border-blue-500/25 text-blue-400">
												...
												<div>
													...
													<p className="text-[11px] text-white/50 mt-0.5">
														One API for 40+ currencies & 30+ rails.
													</p>
												</div>
											</a>
											<a href="/payments" className="panel-card">
												<span className="border-ring"></span>
												<div className="panel-card-icon bg-emerald-500/15 border border-emerald-500/25 text-emerald-400">
											...
											<a href="/payouts" className="panel-card">
												<span className="border-ring"></span>
												<div className="panel-card-icon bg-purple-500/15 border border-purple-500/25 text-purple-400">
												...
												<div>
													...
													<p className="text-[11px] text-white/50 mt-0.5">
														Instant mass payouts to accounts & wallets.
													</p>
												</div>
											</a>
											<a href="/fx-treasury" className="panel-card">
												<span className="border-ring"></span>
												<div className="panel-card-icon bg-amber-500/15 border border-amber-500/25 text-amber-400">
												...
												<div>
													...
													<p className="text-[11px] text-white/50 mt-0.5">
														Competitive cross-border exchange rates.
													</p>
												</div>
											</a>
											<a href="/virtual-cards" className="panel-card">
												<span className="border-ring"></span>
												<div className="panel-card-icon bg-teal-500/15 border border-teal-500/25 text-teal-400">
												...
												<div>
													...
													<p className="text-[11px] text-white/50 mt-0.5">
														Issue USD & local Visa/Mastercards.
													</p>
												</div>
											</a>
											<a href="/compliance" className="panel-card">
												<span className="border-ring"></span>
												<div className="panel-card-icon bg-cyan-500/15 border border-cyan-500/25 text-cyan-400">
								...
								{/* PANE: Solutions */}
								<div
									className={`panel-pane ${activePanel === "solutions" ? "active" : ""}`}
								>
									<div className="panel-split">
										<div className="panel-featured">
											<div className="vector-wave-bg"></div>
											<svg className="animated-svg-wave" viewBox="0 0 200 200">
												<path
													...
													stroke="#10b981"
													strokeWidth="2"
													d="M 10 50 Q 80 150 190 50"
												/>
												<path
													fill="none"
													stroke="#0ea5e9"
													strokeWidth="1.2"
													d="M 10 90 Q 80 180 190 90"
												/>
											</svg>
											<div>
												<span className="px-2 py-0.5 rounded-full bg-teal-500/20 text-teal-300 text-[10px] font-bold uppercase tracking-wider border border-teal-500/30">
													SOLUTIONS
												</span>
												<h3 className="font-display font-bold text-white text-xl mt-3 leading-snug">
													Tailored for Every Market
												</h3>
												<p className="text-xs text-white/60 mt-1.5 leading-relaxed">
													Engineered specifically for banks, marketplaces &
													importers.
												</p>
											</div>
											<div className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between">
												...
												<a
													href="/solutions"
													className="w-8 h-8 rounded-full bg-teal-500/20 hover:bg-teal-500 text-teal-400 hover:text-slate-950 flex items-center justify-center transition-all"
												>
													<ArrowRight className="w-4 h-4" />
												</a>
											</div>
										...
										<div className="p-4 grid grid-cols-1 gap-2 bg-[#080c14]/50">
											<a href="/solutions/banks" className="panel-card">
												...
												<div>
													...
													<p className="text-[11.5px] text-emerald-400/90 mt-0.5 font-medium">
														Core banking rails & clearing infrastructure.
													</p>
												</div>
											</a>
											<a href="/solutions/merchants" className="panel-card">
												...
												<div>
													...
													<p className="text-[11.5px] text-emerald-400/90 mt-0.5 font-medium">
														Accept African payment methods globally.
													</p>
												</div>
											</a>
											<a href="/solutions/traders" className="panel-card">
												...
												<div>
													<h4 className="font-semibold text-white text-[13.5px]">
														Cross-Border Traders & Importers
													</h4>
													<p className="text-[11.5px] text-emerald-400/90 mt-0.5 font-medium">
														Seamless foreign exchange and FX settlement.
													</p>
												</div>
											</a>
											<a href="/solutions/platforms" className="panel-card">
												<span className="border-ring"></span>
												<div className="panel-card-icon bg-pink-500/15 border border-pink-500/25 text-pink-400">
												...
												<div>
													...
													<p className="text-[11.5px] text-emerald-400/90 mt-0.5 font-medium">
														Mass automated payouts and multi-split collections.
													</p>
												</div>
											</a>
											<a href="/solutions/smes" className="panel-card">
												...
												<div>
													...
													<p className="text-[11.5px] text-emerald-400/90 mt-0.5 font-medium">
														All-in-one financial dashboard & corporate tools.
													</p>
												</div>
											</a>
										</div>
								...
								{/* PANE: Developers */}
								<div
									className={`panel-pane ${activePanel === "developers" ? "active" : ""}`}
								>
									<div className="panel-split">
										<div className="panel-featured">
											<div className="vector-wave-bg"></div>
											<svg className="animated-svg-wave" viewBox="0 0 200 200">
												<path
													...
													stroke="#0ea5e9"
													strokeWidth="2"
													d="M 10 100 Q 100 20 190 100 T 10 100"
												/>
											</svg>
											<div>
												...
												<p className="text-xs text-white/60 mt-1.5 leading-relaxed">
													Comprehensive REST API, webhooks & native SDKs.
												</p>
											</div>
											<div className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between">
												<div>
												...
												<a
													href="/docs"
													className="w-8 h-8 rounded-full bg-blue-500/20 hover:bg-blue-500 text-blue-400 hover:text-slate-950 flex items-center justify-center transition-all"
												>
													<ArrowRight className="w-4 h-4" />
												</a>
											</div>
										...
										<div className="p-4 grid grid-cols-2 gap-2.5 bg-[#080c14]/50">
											<a href="/docs" className="panel-card">
												...
												<div>
													...
													<p className="text-[11px] text-white/50 mt-0.5">
														Interactive REST docs & Sandbox keys.
													</p>
												</div>
											</a>
											...
											<a href="/webhooks" className="panel-card">
												...
												<div>
													...
													<p className="text-[11px] text-white/50 mt-0.5">
														Real-time payment state callbacks.
													</p>
												</div>
											</a>
											<a href="/changelog" className="panel-card">
												...
												<div>
													...
													<p className="text-[11px] text-white/50 mt-0.5">
														Weekly release notes & API updates.
													</p>
												</div>
											</a>
										</div>
								...
								{/* PANE: Resources */}
								<div
									className={`panel-pane ${activePanel === "resources" ? "active" : ""}`}
								>
									<div className="panel-split">
										<div className="panel-featured">
											<div className="vector-wave-bg"></div>
											...
											<div>
												...
												<p className="text-xs text-white/60 mt-1.5 leading-relaxed">
													Industry insights & cross-border merchant guides.
												</p>
											</div>
											<div className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between">
												<div>
												...
												<a
													href="/guides"
													className="w-8 h-8 rounded-full bg-purple-500/20 hover:bg-purple-500 text-purple-400 hover:text-slate-950 flex items-center justify-center transition-all"
												>
													<ArrowRight className="w-4 h-4" />
												</a>
											</div>
										...
										<div className="p-4 grid grid-cols-2 gap-2.5 bg-[#080c14]/50">
											...
											<a href="/contact" className="panel-card">
												...
												<div>
													...
													<p className="text-[11px] text-white/50 mt-0.5">
														Speak with infrastructure team.
													</p>
												</div>
											</a>
										</div>
						...
						<div className="flex items-center gap-3 pr-1">
							<div className="hidden xl:flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs text-white/40">
								...
								<span className="px-1.5 py-0.2 bg-white/10 text-[10px] text-white/60 rounded">
									⌘K
								</span>
							</div>
							...
							<a
								href="/auth/login"
								className="hidden sm:inline-block text-xs font-semibold text-white/70 hover:text-white transition-colors px-2"
							>
								Sign In
							</a>
			...
			{/* Mobile Drawer */}
			<div
				className={`mobile-menu bg-[#07090e] fixed inset-0 z-50 overflow-y-auto p-6 flex flex-col justify-between ${mobileOpen ? "open" : ""}`}
			>
				<div>
					...
					<div className="py-6 space-y-4">
						<div>
							...
							>
								Product{" "}
								<ChevronDown
									className={`w-5 h-5 text-white/40 transition-transform ${accordionState.product ? "rotate-180" : ""}`}
								/>
							</button>
							{accordionState.product && (
								<div className="pl-4 space-y-2 pt-2 text-sm text-white/60">
									<a href="/platform" className="block py-1">
										Platform Overview
									</a>
									<a href="/payments" className="block py-1">
										Accept Payments
									</a>
									<a href="/payouts" className="block py-1">
										Global Payouts
									</a>
								</div>
							)}
						...
						<div>
							...
							>
								Solutions{" "}
								<ChevronDown
									className={`w-5 h-5 text-white/40 transition-transform ${accordionState.solutions ? "rotate-180" : ""}`}
								/>
							</button>
							{accordionState.solutions && (
								<div className="pl-4 space-y-2 pt-2 text-sm text-white/60">
									<a href="/solutions/banks" className="block py-1">
										Financial Institutions
									</a>
									<a href="/solutions/merchants" class="block py-1">
										Global Merchants
									</a>
									<a href="/solutions/traders" class="block py-1">
						...
						<a
							href="/pricing"
							class="block text-lg font-semibold text-white py-2"
						>
							Pricing
						</a>
					</div>
