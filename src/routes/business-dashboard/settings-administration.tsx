...
import SettingsAdministration from '@/features/business-dashboard/settings-administration/pages/SettingsAdministration'
 ...
 */
export const Route = createFileRoute('/business-dashboard/settings-administration')({
