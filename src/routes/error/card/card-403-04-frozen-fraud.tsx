...
import { ShieldAlert, Info, Zap, ArrowUpRight, Home, History } from 'lucide-react';
...
import styles from './card-403-04-frozen-fraud.module.css';
...
function Card40304() {
  ...
  const unfreeze = () => {
    addToast('Unfreeze — It Was Me', 'CARD-403-04 logged', 'red');
  };

  const reportFraud = () => {
    addToast('Report Fraud — Not Me', 'Opening', 'emerald');
  };
    ...
    <ErrorLayout
      ...
      rightAction={
        <div className="flex gap-2">
          <span className="px-3 py-1.5 rounded-full bg-white border border-[#E8E2D9] font-bold text-[10px]">CARD-403-04</span>
          <button
    ...
    >
      <div className="bg-white border border-[#E8E2D9] rounded-[28px] shadow-xl overflow-hidden animate-rise">
        ...
        <div className="p-6.5 sm:p-7 text-center">
          ...
          <div className="w-24 h-24 mx-auto mb-3.5 rounded-[28px] bg-[#FEF2F2] border border-[#FECACA] flex items-center justify-center text-[44px] text-[#EF4444] relative">
            ...
            <ShieldAlert size={48} className="animate-shake" />
          </div>
          ...
          <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#FEF2F2] border border-[#FECACA] text-[#B91C1C] font-bold text-[11px] uppercase tracking-wider mb-3">
            <ShieldAlert size={14} />
            Cards • Fraud • Auto-Frozen
          </div>

          {/* Title */}
          <div className="font-['Space_Grotesk'] text-[22px] font-bold mb-2">
            Card Frozen Due To Fraud — Suspicious Spending
          </div>

          {/* Subtitle */}
          <div className="text-[14px] text-[#4B5563] leading-relaxed">
            $500 Amazon unusual spend flagged — card auto-frozen 12 min ago, vault safe.
          </div>
          ...
          <div className="bg-[#FEF2F2] border border-[#FECACA] border-l-4 border-l-[#EF4444] rounded-xl p-3.5 flex gap-2.5 items-start text-left mt-4">
            ...
            <div>
              ...
              <span className="text-[12px] text-[#4B5563] leading-relaxed mt-1 block">
                Risk engine flagged $500 Amazon at 2am, new country, high amount — auto-freeze to prevent fraud. Legit? Unfreeze via OTP.
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2.5 mt-4 text-left">
            <div className="bg-[#FFFCF5] border border-[#E8E2D9] rounded-xl p-3">
              <span className="font-bold text-[11px] uppercase tracking-wider block">Transaction</span>
              <span className="text-[12px] text-[#4B5563]">$500 • Amazon</span>
            </div>
            <div className="bg-[#FFFCF5] border border-[#E8E2D9] rounded-xl p-3">
              <span className="font-bold text-[11px] uppercase tracking-wider block">Time</span>
              <span className="text-[12px] text-[#4B5563]">2:14 AM — unusual</span>
            </div>
            <div className="bg-[#FFFCF5] border border-[#E8E2D9] rounded-xl p-3">
              <span className="font-bold text-[11px] uppercase tracking-wider block">Location</span>
              <span className="text-[12px] text-[#4B5563]">US — new country</span>
            </div>
            <div className="bg-[#FFFCF5] border border-[#E8E2D9] rounded-xl p-3">
              <span className="font-bold text-[11px] uppercase tracking-wider block">Status</span>
              <span className="text-[12px] text-[#4B5563]">Frozen — auto</span>
            </div>
          </div>
      ...
      >
        ...
        <div className="p-3 rounded-2xl bg-[#FFFCF5] border border-[#E8E2D9]">
          ...
          <code className="bg-white border border-[#E8E2D9] px-1.5 py-0.5 rounded text-[11px]">card-403-04_xxx_KE</code> • Funds safe • No double charge
        </div>
      </ErrorModal>
