...
import { TrendingUp, Info, Zap, ArrowUpRight, Home, ShieldCheck, History } from 'lucide-react';
...
import styles from './card-402-02-limit-exceeded.module.css';
...
function Card40202() {
  ...
  const increaseLimit = () => {
    addToast('Increase Daily Limit', 'CARD-402-02 logged', 'amber');
  };

  const viewSpending = () => {
    addToast('View Spending', 'Opening', 'emerald');
  };
    ...
    <ErrorLayout
      ...
      rightAction={
        <div className="flex gap-2">
          <span className="px-3 py-1.5 rounded-full bg-white border border-[#E8E2D9] font-bold text-[10px]">CARD-402-02</span>
          <button
    ...
    >
      <div className="bg-white border border-[#E8E2D9] rounded-[28px] shadow-xl overflow-hidden animate-rise">
        ...
        <div className="p-6.5 sm:p-7 text-center">
          ...
          <div className="w-24 h-24 mx-auto mb-3.5 rounded-[28px] bg-[#FFFBEB] border border-[#FDE68A] flex items-center justify-center text-[44px] text-[#F59E0B] relative">
            ...
            <TrendingUp size={48} className="animate-float" />
          </div>
          ...
          <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#FFFBEB] border border-[#FDE68A] text-[#92400E] font-bold text-[11px] uppercase tracking-wider mb-3">
            <Zap size={14} />
            Cards • Limit 200k Daily • Reached
          </div>

          {/* Title */}
          <div className="font-['Space_Grotesk'] text-[22px] font-bold mb-2">
            Card Spending Limit Exceeded — Daily/Monthly
          </div>

          {/* Subtitle */}
          <div className="text-[14px] text-[#4B5563] leading-relaxed">
            KES 200k daily limit reached at 11:42 — reset midnight. Current KES 210k attempted.
          </div>
          ...
          <div className="bg-[#FFFBEB] border border-[#FDE68A] border-l-4 border-l-[#F59E0B] rounded-xl p-3.5 flex gap-2.5 items-start text-left mt-4">
            ...
            <div>
              ...
              <span className="text-[12px] text-[#4B5563] leading-relaxed mt-1 block">
                Daily limit 200k, used 200k today, attempted 210k total. Monthly 1M also 80% used. Upgrade or wait midnight.
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2.5 mt-4 text-left">
            <div className="bg-[#FFFCF5] border border-[#E8E2D9] rounded-xl p-3">
              <span className="font-bold text-[11px] uppercase tracking-wider block">Daily Limit</span>
              <span className="text-[12px] text-[#4B5563]">KES 200k</span>
            </div>
            <div className="bg-[#FFFCF5] border border-[#E8E2D9] rounded-xl p-3">
              <span className="font-bold text-[11px] uppercase tracking-wider block">Used Today</span>
              <span className="text-[12px] text-[#4B5563]">KES 200k • 100%</span>
            </div>
            <div className="bg-[#FFFCF5] border border-[#E8E2D9] rounded-xl p-3">
              <span className="font-bold text-[11px] uppercase tracking-wider block">Attempted</span>
              <span className="text-[12px] text-[#4B5563]">KES 210k</span>
            </div>
            <div className="bg-[#FFFCF5] border border-[#E8E2D9] rounded-xl p-3">
              <span className="font-bold text-[11px] uppercase tracking-wider block">Reset</span>
              <span className="text-[12px] text-[#4B5563]">00:00</span>
            </div>
          </div>
      ...
      >
        ...
        <div className="p-3 rounded-2xl bg-[#FFFCF5] border border-[#E8E2D9]">
          ...
          <code className="bg-white border border-[#E8E2D9] px-1.5 py-0.5 rounded text-[11px]">card-402-02_xxx_KE</code> • Funds safe • No double charge
        </div>
      </ErrorModal>
