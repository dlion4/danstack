...
import { Lock, Info, Zap, ArrowUpRight, Home, ShieldAlert, History } from 'lucide-react';
...
import styles from './card-401-03-cvv-attempts-exceeded.module.css';
...
function Card40103() {
  ...
  const unlockOTP = () => {
    addToast('Unlock via OTP', 'CARD-401-03 logged', 'red');
  };

  const contactSupport = () => {
    addToast('Contact Support', 'Opening', 'emerald');
  };
    ...
    <ErrorLayout
      ...
      rightAction={
        <div className="flex gap-2">
          <span className="px-3 py-1.5 rounded-full bg-white border border-[#E8E2D9] font-bold text-[10px]">CARD-401-03</span>
          <button
    ...
    >
      <div className="bg-white border border-[#E8E2D9] rounded-[28px] shadow-xl overflow-hidden animate-rise">
        ...
        <div className="p-6.5 sm:p-7 text-center">
          ...
          <div className="w-24 h-24 mx-auto mb-3.5 rounded-[28px] bg-[#FEF2F2] border border-[#FECACA] flex items-center justify-center text-[44px] text-[#EF4444] relative">
            ...
            <Lock size={48} className="animate-shake" />
          </div>
          ...
          <div className="font-['Space_Grotesk'] text-[22px] font-bold mb-2">
            CVV Attempts Exceeded — Security Lock
          </div>

          {/* Subtitle */}
          <div className="text-[14px] text-[#4B5563] leading-relaxed">
            CVV tried 5x wrong online — security lock 30 min, card temporarily blocked online.
          </div>
          ...
          <div className="bg-[#FEF2F2] border border-[#FECACA] border-l-4 border-l-[#EF4444] rounded-xl p-3.5 flex gap-2.5 items-start text-left mt-4">
            ...
            <div>
              ...
              <span className="text-[12px] text-[#4B5563] leading-relaxed mt-1 block">
                Online checkout CVV 000,111,222,333,444 — all wrong. Security lock 30 min prevents brute force.
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2.5 mt-4 text-left">
            <div className="bg-[#FFFCF5] border border-[#E8E2D9] rounded-xl p-3">
              ...
              <span className="text-[12px] text-[#4B5563]">Jumia • Online</span>
            </div>
            <div className="bg-[#FFFCF5] border border-[#E8E2D9] rounded-xl p-3">
              <span className="font-bold text-[11px] uppercase tracking-wider block">CVV Attempts</span>
              <span className="text-[12px] text-[#4B5563]">5/5 failed</span>
            </div>
            <div className="bg-[#FFFCF5] border border-[#E8E2D9] rounded-xl p-3">
              <span className="font-bold text-[11px] uppercase tracking-wider block">Locked Until</span>
              <span className="text-[12px] text-[#4B5563]">12:30</span>
            </div>
            <div className="bg-[#FFFCF5] border border-[#E8E2D9] rounded-xl p-3">
      ...
      >
        ...
        <div className="p-3 rounded-2xl bg-[#FFFCF5] border border-[#E8E2D9]">
          ...
          <code className="bg-white border border-[#E8E2D9] px-1.5 py-0.5 rounded text-[11px]">card-401-03_xxx_KE</code> • Funds safe • No double charge
        </div>
      </ErrorModal>
