...
import { Phone, Info, Zap, ArrowUpRight, Home, ShieldAlert, ShieldCheck, History } from 'lucide-react';
...
import styles from './card-403-06-not-activated.module.css';
...
function Card40306() {
  ...
  const activateCard = () => {
    addToast('Activate Card Now', 'CARD-403-06 logged', 'amber');
  };

  const viewGuide = () => {
    addToast('View Activation Guide', 'Opening', 'emerald');
  };
    ...
    <ErrorLayout
      ...
      rightAction={
        <div className="flex gap-2">
          <span className="px-3 py-1.5 rounded-full bg-white border border-[#E8E2D9] font-bold text-[10px]">CARD-403-06</span>
          <button
    ...
    >
      <div className="bg-white border border-[#E8E2D9] rounded-[28px] shadow-xl overflow-hidden animate-rise">
        ...
        <div className="p-6.5 sm:p-7 text-center">
          ...
          <div className="w-24 h-24 mx-auto mb-3.5 rounded-[28px] bg-[#FFFBEB] border border-[#FDE68A] flex items-center justify-center text-[44px] text-[#F59E0B] relative">
            ...
            <Phone size={48} className="animate-float" />
          </div>
          ...
          <div className="text-[14px] text-[#4B5563] leading-relaxed">
            Physical card not activated via app — activate before first use. Scan QR + set PIN.
          </div>
          ...
          <div className="bg-[#FFFBEB] border border-[#FDE68A] border-l-4 border-l-[#F59E0B] rounded-xl p-3.5 flex gap-2.5 items-start text-left mt-4">
            ...
            <div>
              ...
              <span className="text-[12px] text-[#4B5563] leading-relaxed mt-1 block">
                Card •••• 8888 delivered but not activated. Must activate via app scan QR + set PIN before ATM use.
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2.5 mt-4 text-left">
            ...
            <div className="bg-[#FFFCF5] border border-[#E8E2D9] rounded-xl p-3">
              <span className="font-bold text-[11px] uppercase tracking-wider block">Delivered</span>
              <span className="text-[12px] text-[#4B5563]">2026-08-02</span>
            </div>
            <div className="bg-[#FFFCF5] border border-[#E8E2D9] rounded-xl p-3">
              <span className="font-bold text-[11px] uppercase tracking-wider block">Status</span>
              <span className="text-[12px] text-[#4B5563]">Not activated</span>
            </div>
            <div className="bg-[#FFFCF5] border border-[#E8E2D9] rounded-xl p-3">
              <span className="font-bold text-[11px] uppercase tracking-wider block">Action</span>
              <span className="text-[12px] text-[#4B5563]">Activate in app</span>
            </div>
          </div>
      ...
      >
        ...
        <div className="p-3 rounded-2xl bg-[#FFFCF5] border border-[#E8E2D9]">
          ...
          <code className="bg-white border border-[#E8E2D9] px-1.5 py-0.5 rounded text-[11px]">card-403-06_xxx_KE</code> • Funds safe • No double charge
        </div>
      </ErrorModal>
