...
import { ShieldAlert, Info, Zap, ArrowUpRight, Home, ShieldCheck, History } from 'lucide-react';
...
import styles from './card-403-01-kyc-tier-insufficient.module.css';
...
function Card40301() {
  ...
  const upgradeKYC = () => {
    addToast('Upgrade KYC to Tier 2', 'CARD-403-01 logged', 'amber');
  };

  const viewTierLimits = () => {
    addToast('View Tier Limits', 'Opening', 'emerald');
  };
    ...
    <ErrorLayout
      ...
      rightAction={
        <div className="flex gap-2">
          <span className="px-3 py-1.5 rounded-full bg-white border border-[#E8E2D9] font-bold text-[10px]">CARD-403-01</span>
          <button
    ...
    >
      <div className="bg-white border border-[#E8E2D9] rounded-[28px] shadow-xl overflow-hidden animate-rise">
        ...
        <div className="p-6.5 sm:p-7 text-center">
          ...
          <div className="w-24 h-24 mx-auto mb-3.5 rounded-[28px] bg-[#FFFBEB] border border-[#FDE68A] flex items-center justify-center text-[44px] text-[#F59E0B] relative">
            ...
            <ShieldAlert size={48} className="animate-float" />
          </div>
          ...
          <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#FFFBEB] border border-[#FDE68A] text-[#92400E] font-bold text-[11px] uppercase tracking-wider mb-3">
            <Zap size={14} />
            Cards • Tier 1 • Need Tier 2
          </div>

          {/* Title */}
          <div className="font-['Space_Grotesk'] text-[22px] font-bold mb-2">
            KYC Tier Insufficient for Card Issuance
          </div>

          {/* Subtitle */}
          <div className="text-[14px] text-[#4B5563] leading-relaxed">
            Personal KYC tier 1, need tier 2 for USD virtual cards — upgrade KYC before issuance.
          </div>
          ...
          <div className="bg-[#FFFBEB] border border-[#FDE68A] border-l-4 border-l-[#F59E0B] rounded-xl p-3.5 flex gap-2.5 items-start text-left mt-4">
            ...
            <div>
              ...
              <span className="text-[12px] text-[#4B5563] leading-relaxed mt-1 block">
                Tier 1 limit USD 500 virtual, Tier 2 needed for USD cards &gt;500. Complete address + source of income.
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2.5 mt-4 text-left">
            <div className="bg-[#FFFCF5] border border-[#E8E2D9] rounded-xl p-3">
              <span className="font-bold text-[11px] uppercase tracking-wider block">Your Tier</span>
              <span className="text-[12px] text-[#4B5563]">Tier 1 — USD 500 max</span>
            </div>
            <div className="bg-[#FFFCF5] border border-[#E8E2D9] rounded-xl p-3">
              <span className="font-bold text-[11px] uppercase tracking-wider block">Needed</span>
              <span className="text-[12px] text-[#4B5563]">Tier 2 — USD 5k</span>
            </div>
            <div className="bg-[#FFFCF5] border border-[#E8E2D9] rounded-xl p-3 col-span-2">
              <span className="font-bold text-[11px] uppercase tracking-wider block">Missing</span>
              <span className="text-[12px] text-[#4B5563]">Proof of address + income</span>
            </div>
          </div>
        ...
        <div className="p-4.5 sm:p-7 bg-[#FFFEFB] border-t border-[#E8E2D9] flex flex-wrap gap-2.5 justify-center">
          ...
          >
            <Zap size={18} />
            Upgrade KYC to Tier 2
          </button>
          <button
            onClick={viewTierLimits}
      ...
      >
        ...
        <div className="p-3 rounded-2xl bg-[#FFFCF5] border border-[#E8E2D9]">
          ...
          <code className="bg-white border border-[#E8E2D9] px-1.5 py-0.5 rounded text-[11px]">card-403-01_xxx_KE</code> • Funds safe • No double charge
        </div>
      </ErrorModal>
