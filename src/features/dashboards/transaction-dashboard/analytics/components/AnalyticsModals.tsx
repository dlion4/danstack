...
const QUICK_MODALS: {
...
}[] = [
	{
		...
		body: "Max attempts 3 • Delay 5 min. Adjust per merchant policy.",
		action: "Save",
		msg: "Settings saved.",
	},
	{
		id: "healthCheckModal2",
		icon: "bi-heart-pulse",
		title: "System Health",
		body: "All systems operational. Last check: 2 minutes ago.",
	},
	{
		id: "trendModal2",
		icon: "bi-graph-up",
		title: "Trend Details",
		body: "Peak volume day: Tuesday (KES 124.8M). Best performing hour: 10-11 AM.",
	},
	{
		id: "merchantDrillModal2",
		icon: "bi-shop",
		title: "Merchant Risk",
		body: "Top 3 merchants = 47% volume. Diversification score: 42/100.",
	},
	{
		id: "categoryModal2",
		icon: "bi-tags",
		title: "Category Insights",
		body: "Government payments: KES 892M (89.2% success). Utilities: 98.4% success.",
	},
	{
		id: "exportModal2",
		icon: "bi-download",
		title: "Quick Export",
		body: "Export last 30 days transactions in CSV format.",
		action: "Export",
		msg: "Export ready for download.",
	},
	{
		id: "reportBuilderModal2",
		icon: "bi-file-earmark-plus",
		title: "Quick Report",
		body: "Generate monthly reconciliation report.",
		action: "Generate",
		msg: "Report generated and emailed.",
	},
	{
		id: "scheduledReportsModal2",
		icon: "bi-calendar-event",
		title: "Quick Schedule",
		body: "Schedule weekly failure report.",
		action: "Schedule",
		msg: "Report scheduled successfully.",
	},
	{
		id: "failureDrillModal2",
		icon: "bi-x-circle",
		title: "Quick Failure View",
		body: "KRA iTax: 318 failures (52% retry success).",
	},
	{
		id: "merchantDrillModal3",
		icon: "bi-shop",
		title: "Quick Merchant View",
		body: "KRA concentration risk: 24.1% of volume.",
	},
	{
		id: "trendModal3",
		icon: "bi-graph-up",
		title: "Quick Trend",
		body: "Tuesday is the best performing day (+18%).",
	},
	{
		id: "categoryModal3",
		icon: "bi-tags",
		title: "Quick Category",
		body: "Government payments: KES 892M (89.2% success).",
	},
	{
		id: "exportModal3",
		icon: "bi-download",
		title: "Quick Export",
		body: "Export last 7 days in Excel.",
		action: "Export",
		msg: "Export ready.",
	},
	{
		id: "reportBuilderModal3",
		icon: "bi-file-earmark-plus",
		title: "Quick Report",
		body: "Generate failure analysis report.",
		action: "Generate",
		msg: "Report generated.",
	},
	{
		id: "scheduledReportsModal3",
		icon: "bi-calendar-event",
		title: "Quick Schedule",
		body: "Schedule daily summary.",
		action: "Schedule",
		msg: "Scheduled successfully.",
	},
	{
		id: "failureDrillModal3",
		icon: "bi-x-circle",
		title: "Quick Failure",
		body: "KRA iTax: 318 failures today.",
	},
];
		...
		<>
						...
						<div className="row g-3">
							...
							<div className="col-md-6">
								...
								<select
									className={styles.fc}
									multiple
									defaultValue={["Equity Bank", "Co-op Bank", "DTB Kenya"]}
								>
									{[
										"Equity Bank",
										"Co-op Bank",
							...
							<div className="col-md-6">
								...
								<select
									className={styles.fc}
									defaultValue="All (Success + Failed)"
								>
									{[
										"All (Success + Failed)",
										"Success Only",
								...
								{RB_COLS.map((c) => (
									<div className="form-check mb-1" key={c}>
										<input
											...
											type="checkbox"
											defaultChecked={c !== "Merchant Name"}
											id={`col-${c}`}
										/>
				...
				{flow === 3 && (
					<div className={styles.fstepActive}>
						...
						<div className="mt-3">
							...
							<input
								className={styles.fc}
								defaultValue="finance@company.com, risk@company.com"
							/>
						</div>
					</div>
				)}
				{flow >= 4 && (
					<div className={`${styles.receipt} ${styles.fstepActive}`}>
						...
						<p className={styles.receiptSub}>
							Your custom report "Q2 Bank-to-Bank Summary" has been generated
							and delivered.
						</p>
						<div
			...
			<MBox
				...
				footer={actionFooter(
					"exportModal",
					"Generate Export",
					"Export generated successfully. 42,891 records ready for download.",
					"EXP-20250627-9912",
				)}
			>
				{actionBody(
							...
							{[
								...
								<div className="col-md-4" key={t.label}>
									<div
										...
										style={{ background: t.bg, textAlign: "left" }}
									>
										<div
											style={{
												fontSize: 11,
										...
										<div
											style={{ fontSize: 28, fontWeight: 700, color: t.color }}
										>
											{t.value}
										</div>
									</div>
					...
					<div className={`${styles.fstepActive} table-responsive`}>
						<table className={styles.tbl}>
							...
							<tbody>
								{[
									{
										row: ["KRA iTax", "KES 684M", "8,421", "89.2%", "KES 81K"],
										risk: "High",
					...
					<div className={styles.fstepActive}>
						<div className={styles.summaryBoxDanger}>
							...
							<div style={{ fontSize: 12, color: "#fecaca" }}>
								Top 3 merchants account for 47% of total volume. Diversification
								recommended.
							</div>
						</div>
					</div>
				...
				{tabs.merch === "loyalty" && (
					<div className={styles.fstepActive}>
						{[
							{
								name: "KRA iTax",
								sub: "4,201 repeat customers",
								badge: "High Loyalty",
								tone: "badgeS" as BadgeTone,
							},
							{
								name: "Equity Bank",
								sub: "3,882 repeat customers",
								badge: "Medium Loyalty",
								tone: "badgeI" as BadgeTone,
							},
						].map((l) => (
							<div className={styles.sr} key={l.name}>
								...
								<span className={`${styles.badge} ${styles[l.tone]}`}>
									{l.badge}
								</span>
							</div>
						))}
			...
			<MBox
				...
				footer={
					<>
						...
						<button
							className={`${styles.btnPm} ${styles.btnPmP}`}
							onClick={() => onOpen("reportBuilderModal")}
						>
							Export This View
						</button>
					</>
					...
					<div className={styles.fstepActive}>
						<div className={styles.summaryBox}>
							...
							<div className={styles.mutedSmall}>
								Average 4,821 transactions per hour
							</div>
						</div>
					</div>
				)}
			...
			<MBox
				...
				footer={actionFooter(
					"autoRetryModal",
					"Save Rules",
					"Auto-retry rules updated successfully.",
				)}
			>
				{actionBody(
					"autoRetryModal",
					<>
						...
						<div className="mb-3">
							...
							<select
								className={styles.fc}
								multiple
								defaultValue={["KRA iTax", "Co-op Bank"]}
							>
			...
			<MBox
				...
				footer={
					<>
						...
						<button
							className={`${styles.btnPm} ${styles.btnPmP}`}
							onClick={() => onOpen("scheduledReportsModal")}
						>
							View Scheduled Jobs
						</button>
					</>
							...
							results[m.id] ? (
								...
								<>
									...
									<button
										className={`${styles.btnPm} ${styles.btnPmP}`}
										disabled={busy === m.id}
										onClick={() => doAction(m.id, m.msg ?? "Done.")}
									>
										{m.action}
									</button>
								</>
