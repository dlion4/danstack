				...
				{actionBody(
					...
					<>
						...
						<div
							...
							style={{ fontSize: 12 }}
						>
							<i className="bi bi-info-circle me-1" /> Retry will incur
				...
				{actionBody(
					...
					<>
						...
						<div className={styles.summaryBoxInfo} style={{ fontSize: 12 }}>
							<i className="bi bi-info-circle me-1" /> Template: Bank Code,
							Amount, Purpose, Reference. Max 500 rows per upload.
						</div>
					</>,
				)}
			</MBox>
