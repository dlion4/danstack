...
export default function CustomersModals({
	...
	const attentionRows = [
		...
		},
		{
			...
			sub: "External bank links expiring in 7 days",
			label: "Renew",
	...
	const tixRows = [
		...
		},
		{
			t: "TKT-8834",
			c: "Grace Wanjiku Ltd",
			s: "Account statement not received",
			p: "Low",
					...
					{flow === 4 && (
						<div className={styles.receipt}>
							...
							<p className={styles.receiptSub}>
								KYC verification initiated. Customer will receive welcome SMS
								and email with login details.
							</p>
							<div
					...
					<>
						...
						<div className="row g-3">
							...
							<div className="col-12">
								...
								<input
									className={styles.fc}
									placeholder="Salary, Business, Savings, Project..."
								/>
							</div>
						</div>
					</>,
				...
				{actionBody(
					...
					<>
						...
						<div className={styles.summaryBoxWarn} style={{ fontSize: 12 }}>
							<i className="bi bi-exclamation-triangle me-1" /> Closing this
							account will cancel all standing orders and linked cards. This
			...
			>
				{actionBody(
					...
					<>
						...
						<div className={styles.summaryBoxInfo} style={{ fontSize: 12 }}>
							<i className="bi bi-info-circle me-1" /> Customer will receive
							consent request via their bank app or USSD.
						</div>
					</>,
				)}
			</MBox>
			...
			>
				<div className="text-center">
					...
					<p style={{ fontSize: 13, color: "var(--pm-muted)" }}>
						james.kamau@paymo.co.ke · Relationship Manager
					</p>
