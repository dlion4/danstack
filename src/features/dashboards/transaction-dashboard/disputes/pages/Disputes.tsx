...
const initialMockData: DisputesConfig = {
	...
	headerSub:
		"End-to-end dispute lifecycle, evidence management, chargeback tracking and resolution analytics",
						...
						>
							<div>
								...
								<p className={styles.ss}>
									Create new disputes, select transactions, choose reason codes,
									attach initial evidence and route to the correct workflow.
								</p>
							</div>
							...
							<div className="col-lg-5">
								<div className={styles.ub}>
									<h4 className={styles.ubTitle}>
										Recent Transactions Eligible for Dispute
									</h4>
						...
						>
							<div>
								<h3 className={styles.st}>
									...
									/>{" "}
									Evidence Management &amp; Submission
								</h3>
								<p className={styles.ss}>
									Upload, organise and submit evidence packages to networks with
						...
						>
							<div>
								<h3 className={styles.st}>
									...
									/>{" "}
									Chargeback Workflow &amp; Tracking
								</h3>
								<p className={styles.ss}>
									Track chargeback lifecycle, respond to representments, manage
						...
						>
							<div>
								<h3 className={styles.st}>
									...
									/>{" "}
									Resolution Analytics &amp; Insights
								</h3>
								<p className={styles.ss}>
									Analyse win/loss rates, merchant performance, reason code
									effectiveness and financial recovery metrics.
								</p>
							</div>
							<div className="d-flex" style={{ gap: 8 }}>
								<button
