...
export default function InvoicingBillingModals({
	...
	const renderInvoiceDetail = () => (
		<MBox
			...
			footer={
				<>
					<button className={cx(s.btnPm, s.btnPmD)} onClick={onClose}>
						Remind
					</button>
					<button className={cx(s.btnPm, s.btnPmA)} onClick={onClose}>
						Record Payment
					</button>
					<button
						className={cx(s.btnPm, s.btnPmP)}
						onClick={() =>
							doAction("invoiceDetailModal", "Invoice link shared.", "")
						}
					>
						Share Link
					</button>
