...
export const ACTIVITY: { time: string; icon: string; text: string; by: string }[] = [
  { time: "2 min ago", icon: "bi-cash-coin", text: "M-Pesa payment KES 2,450 received", by: "System" },
  { time: "15 min ago", icon: "bi-box-seam", text: "Stock adjustment: 2× Ankole Mug written off", by: "Mwangi Kamau" },
  { time: "1 hr ago", icon: "bi-receipt", text: "Invoice INV-0091 paid (KES 410,000)", by: "System" },
  { time: "2 hrs ago", icon: "bi-person-plus", text: "Naomi Chemtai joined as Sales Staff", by: "Wanjiku Maina" },
];
