...
import { BUSINESSES, ORDER, CUR_RATES, TREND, fmt, shortM } from "./paymoData";
import type { Business, BizType, Range, Tone } from "./paymoData";
...
export default function PayMoDashboard() {
	...
	const typeTone: Tone = b.type === "physical" ? "success" : b.type === "online" ? "info" : "purple";
	...
	const mixTotal = b.revenueMix.reduce((a, x) => a + x.v, 0);
