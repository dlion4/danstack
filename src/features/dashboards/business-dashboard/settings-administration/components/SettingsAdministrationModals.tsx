						...
						<table className={s.tbl}>
							...
							<tbody>
								<tr>
									...
									<td data-label="Account No.">****1234</td>
									<td data-label="Account Name">J.K. Holdings Ltd</td>
									<td data-label="Branch">Westlands</td>
									<td data-label="Status">
										<span className={cx(s.badge, s.badgeS)}>Active</span>
									</td>
									<td data-label="Action">
								...
								<tr>
									...
									<td data-label="Account No.">****5678</td>
									<td data-label="Account Name">JK Retail Mombasa</td>
									<td data-label="Branch">City Square</td>
									<td data-label="Status">
										<span className={cx(s.badge, s.badgeS)}>Active</span>
									</td>
									<td data-label="Action">
								...
								<tr>
									...
									<td data-label="Account No.">****9012</td>
									<td data-label="Account Name">J.K. Holdings Ltd</td>
									<td data-label="Branch">Mombasa</td>
									<td data-label="Status">
										<span className={cx(s.badge, s.badgeW)}>Inactive</span>
									</td>
									<td data-label="Action">
										<button
											className={cx(s.btnPm, s.btnSm)}
