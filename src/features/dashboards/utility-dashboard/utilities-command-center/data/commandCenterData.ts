...
export const initialMockData: CommandCenterConfig = {
	...
	hero: {
		...
		detail:
			"Electricity, water, gas, internet, TV, airtime & solar managed in one place.",
		actions: [
	...
	statCards: [
		...
		},
		{
			...
			badge: {
				...
				text: "-8.2% vs last month",
				tone: "badgeS",
			},
			progress: { label: "Budget usage", pct: "74%", color: "var(--pm-info)" },
		},
		{
			key: "savings",
			...
			badge: {
				icon: "bi-piggy-bank",
				text: "Smart auto-pay active",
				tone: "badgeS",
			},
			accentBorder: true,
			lines: [
				"Auto-pay saved: <strong>KES 3,200</strong>",
				"Bundle deals: <strong>KES 2,850</strong>",
			],
		},
	],
	attention: [
		{
			...
			title: "KPLC bill overdue by 3 days",
			sub: "Meter #14825739 · KES 4,850",
			actionLabel: "Pay",
			actionClass: "btnPmP",
			modal: "payElectricityModal",
		},
		{
			initials: "WT",
			...
			sub: "NCWSC Acc #290081 · KES 3,200",
			actionLabel: "Pay",
			modal: "payWaterModal",
		},
		{
			...
			title: "DSTV expires in 2 days",
			sub: "Compact Plus · KES 11,500",
			actionLabel: "Renew",
			modal: "payTVModal",
		},
		{
			...
			title: "Zuku Internet low data",
			sub: "3.2GB remaining · Resets in 8 days",
			actionLabel: "Top-up",
			modal: "payInternetModal",
		},
	],
	suggestions: [
		{
			...
			title: "Auto-pay 5 recurring bills",
			sub: "Save KES 1,200/mo in late fees",
			actionLabel: "Setup",
		...
		},
		{
			...
			iconBg: "var(--pm-info-soft)",
			iconColor: "var(--pm-info)",
			title: "Switch to Faiba 40Mbps plan",
			sub: "Save KES 1,500/mo vs current plan",
			actionLabel: "Compare",
		...
		},
		{
			...
			iconBg: "var(--pm-warning-soft)",
			iconColor: "var(--pm-warning)",
			title: "Buy KPLC tokens in bulk",
			sub: "KES 5,000 tokens save 3% on tariff",
			actionLabel: "Buy",
			modal: "buyTokenModal",
		},
		{
			...
			iconBg: "var(--pm-purple-soft)",
			iconColor: "var(--pm-purple)",
			title: "13kg gas refill due soon",
			sub: "Based on 28-day usage cycle",
			actionLabel: "Order",
			modal: "orderGasModal",
		},
	],
	...
	connectedServices: [
		{
			...
			color: "#F59E0B",
			bg: "#FEF3C7",
			provider: "KPLC Prepaid",
			account: "14825739",
			status: "active",
			lastPay: "27 Jun 2025",
			nextDue: "24 Jun (overdue)",
			amount: "KES 4,850",
			autoPay: true,
			modal: "payElectricityModal",
		},
	...
	trend: [
		...
		{ month: "Apr", height: "90%" },
		{ month: "May", height: "65%" },
		{ month: "Jun", height: "60%", highlight: true },
	],
	tips: [
	...
	autoPayRules: [
		{
			name: "KPLC Prepaid",
			rule: "Top-up KES 2,000 when < 50 units",
			next: "Auto",
			active: true,
		},
		{
		...
		{
			name: "Safaricom Fibre",
			rule: "Monthly KES 5,999 on 1st",
			next: "01 Jul",
			active: true,
		},
		{
			name: "Safaricom Data",
			rule: "Auto-renew 12GB monthly",
			next: "03 Jul",
			active: true,
		},
		{
			name: "Airtel Airtime",
			rule: "Weekly KES 200 top-up",
			next: "04 Jul",
			active: true,
		},
	],
...
export async function fetchCommandCenter(): Promise<CommandCenterConfig> {
	try {
		const res = await fetch("/api/utilities-command-center", {
