...
const P: Record<IconName, ReactNode> = {
	...
	flame: (
		<path d="M12 2.5c4 4.2 6.5 6.7 6.5 10.3A6.5 6.5 0 0 1 5.5 12.8c0-1.5.6-2.8 1.6-4 .2 1.3 1 2.2 2 2.2 1.2 0 2-1 2-2.6 0-1.8-.7-3.5-2.1-5.9z" />
	),
	sun: (
		<>
	...
	shield: (
		<path d="M12 2.8 4.5 5.8v6c0 4.4 3.1 8.1 7.5 9.4 4.4-1.3 7.5-5 7.5-9.4v-6z" />
	),
	settings: (
		<>
	...
	logout: (
		<path d="M15 4.5H19a1.5 1.5 0 0 1 1.5 1.5v12A1.5 1.5 0 0 1 19 19.5h-4M10 8l-4 4 4 4M6 12h10" />
	),
	...
	bell: (
		<path d="M6.5 10a5.5 5.5 0 0 1 11 0c0 4 1.5 5.5 1.5 5.5H5S6.5 14 6.5 10zM10 19a2.2 2.2 0 0 0 4 0" />
	),
	...
	star: (
		<path d="m12 3.5 2.7 5.6 6 .9-4.4 4.2 1.1 6-5.4-2.9-5.4 2.9 1.1-6L3.3 10l6-.9z" />
	),
	alert: (
		<>
	...
	"eye-off": (
		<path d="M4 4l16 16M9.9 5.9A9.8 9.8 0 0 1 12 5.5c6 0 9.5 6.5 9.5 6.5a17 17 0 0 1-2.7 3.5M6.3 8.2A17 17 0 0 0 2.5 12S6 18.5 12 18.5c.8 0 1.5-.1 2.2-.3M9.9 9.9a3 3 0 0 0 4.2 4.2" />
	),
	edit: <path d="M4.5 19.5h4L20 8a2.1 2.1 0 0 0-3-3L5.5 16.5zM15 5.5 18.5 9" />,
	trash: (
		<path d="M4.5 7h15M9.5 7V4.5h5V7M6.5 7l1 13h9l1-13M10 10.5v6M14 10.5v6" />
	),
	...
	repeat: (
		<path d="M4 9V7.5A2.5 2.5 0 0 1 6.5 5H19l-3-3M20 15v1.5a2.5 2.5 0 0 1-2.5 2.5H5l3 3" />
	),
	mail: (
		<>
	...
	sparkle: (
		<path d="M12 3.5 13.8 9l5.7 1.8L13.8 12.6 12 18.5l-1.8-5.9L4.5 10.8 10.2 9zM18.5 16l.8 2.2 2.2.8-2.2.8-.8 2.2-.8-2.2-2.2-.8 2.2-.8z" />
	),
