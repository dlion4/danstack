...
export default function VirtualCreditCardsModals({
	active,
	onClose,
	onOpen,
}: ModalsProps) {
			...
			footer={
				<>
					...
					<button
						...
						onClick={nextCardStep}
					>
						{cardStep >= 4 ? (
							"Done"
						) : cardStep === 3 ? (
							<>
								Issue Card <i className="bi bi-lock" />
							</>
						) : (
							<>
					...
					<div className="row g-3">
						{CARD_TYPES.map((type) => (
							<div key={type} className="col-md-4">
								...
								>
									<i
										className={`bi ${type === "Single-Use Card" ? "bi-lightning-charge" : type === "Subscription Card" ? "bi-arrow-repeat" : "bi-wallet2"} d-block mb-2`}
										style={{
											fontSize: 28,
											color:
									...
									>
										{type === "Single-Use Card"
											? "Destroys itself after one successful transaction. High security."
											: type === "Subscription Card"
												? "Locks to the first merchant it transacts with. Great for Netflix, AWS."
				...
				<div className={styles.fstepActive}>
					...
					<div className="p-3 border rounded mb-3">
						<div className="d-flex justify-content-between mb-1">
							...
							<strong>{selectedCardType || "Multi-Use Card"}</strong>
						</div>
						<div className="d-flex justify-content-between mb-1">
			...
			{cardStep === 4 && (
				<div className={styles.fstepActive}>
					<div className={styles.receipt}>
						...
						<div
							className={`${styles.creditCardUi} ${styles.bgGradientHero} mx-auto mt-3`}
						...
						>
							...
							<div className={styles.vcardBottom}>
								<div>
									...
									<div className={styles.vcardValue}>11/26</div>
								</div>
							</div>
						</div>
					</div>
				...
				<div className={styles.fstepActive}>
					...
					<div className="mb-3">
						...
						<div
							...
							onClick={() => setSelectedPayAmount("minimum")}
						>
							<input
								type="radio"
								name="payamt"
								checked={selectedPayAmount === "minimum"}
							/>
							<div>
						...
						>
							<input
								type="radio"
								name="payamt"
								checked={selectedPayAmount === "statement"}
							/>
							<div>
								<strong>Statement Balance</strong>
								<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
									KES 42,300 (Avoids interest)
								</div>
							</div>
						</div>
						<div
							className="p-3 border rounded d-flex align-items-center gap-3"
							onClick={() => setSelectedPayAmount("custom")}
						>
							<input
								type="radio"
								name="payamt"
								checked={selectedPayAmount === "custom"}
							/>
							<div>
				...
				<div className={styles.fstepActive}>
					<div className="mb-3">
						...
						<div className="p-3 border rounded mb-2 d-flex align-items-center gap-3">
							...
							<div>
								<strong>PayMo Wallet Balance</strong>
								<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
									Available: KES 45,000
								</div>
							</div>
						</div>
						<div className="p-3 border rounded d-flex align-items-center gap-3">
							...
							<div>
								<strong>Linked Equity Bank (***4521)</strong>
								<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
									Instant transfer
								</div>
							</div>
			...
			{renderActionBody(
				...
				<>
					<p style={{ fontSize: 13, color: "var(--pm-muted)" }}>
						For your security, please enter your PIN to view full card details
						and CVV.
					</p>
					...
					>
						<div
							className={styles.creditCardUi}
							style={{ background: "var(--pm-gradient-slate)" }}
						>
							<div className="d-flex justify-content-between align-items-start">
								<div className={styles.vcardBrand}>PayMo</div>
								<div className={styles.vcardMastercard}>
							...
							<div className={styles.vcardBottom}>
								<div>
									<div className={styles.vcardLabel}>Cardholder</div>
									<div className={styles.vcardValue}>JAMES KAMAU</div>
								</div>
								<div>
									<div className={styles.vcardLabel}>Valid Thru</div>
									<div className={styles.vcardValue}>11/26</div>
								...
								<div>
									<div className={styles.vcardLabel}>CVV</div>
									<div
										className={styles.vcardValue}
						...
						<p
							style={{ fontSize: 11, color: "var(--pm-danger)", marginTop: 12 }}
						>
			...
			{renderActionBody(
				...
				<>
					...
					<div className={styles.statusRow}>
						<div>
							<strong>3D Secure Verification</strong>
							<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
								Active on all multi-use cards
							</div>
						</div>
					...
					<div className={styles.statusRow}>
						<div>
							...
							<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
								Approvals restricted to this iPhone 14
							</div>
						</div>
						<span className={`${styles.badge} ${styles.badgeS}`}>Pass</span>
					</div>
					<div className={styles.statusRow}>
						<div>
							<strong>CVV Rotation</strong>
							<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
								AWS Hosting CVV hasn't changed in 6 months
							</div>
						</div>
					...
					<div className={styles.statusRow}>
						<div>
							<strong>Dark Web Scan</strong>
							<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
								Checking card numbers against breaches
							</div>
						</div>
	...
	const renderFraudAlert = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-shield-x text-danger me-2" />
					Fraud Alert Review
				</>
			}
			footer={
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"fraudAlertModal",
								"Card has been permanently destroyed and new single-use card issued.",
								"FRAUD-9912",
							)
						}
					>
				...
				<>
					...
					>
						<div className="d-flex align-items-center gap-3">
							<div style={{ fontSize: 24, color: "var(--pm-danger)" }}>
							...
							<div>
								...
								<div style={{ fontSize: 12, color: "#7F1D1D" }}>
									A single-use card was attempted multiple times.
								</div>
							</div>
						</div>
					</div>
						...
						<table className={styles.tbl}>
							<tbody>
								<tr>
									...
									<td>Unknown Crypto Exchange</td>
								</tr>
								<tr>
									<td>
										<strong>Amount</strong>
									</td>
									<td>USD 450.00 (KES 58,500)</td>
								</tr>
								<tr>
									<td>
										<strong>Card</strong>
									</td>
									<td>Single-Use (ends 3302)</td>
								</tr>
								<tr>
									<td>
										<strong>Location</strong>
									</td>
									<td>Kyiv, Ukraine (IP based)</td>
								</tr>
								<tr>
									<td>
										<strong>Time</strong>
									</td>
									<td>Today, 03:14 AM EAT</td>
								</tr>
							</tbody>
						</table>
					</div>
					...
					<div className="d-flex flex-column gap-2">
						<button
							className={`${styles.btnPm} ${styles.btnPmD} w-100`}
							onClick={() =>
								doAction(
									"fraudAlertModal",
									"Card has been permanently destroyed and new single-use card issued.",
						...
						<button
							className={`${styles.btnPm} w-100`}
							onClick={() =>
								doAction(
									"fraudAlertModal",
									"Transaction unblocked. You can retry the payment.",
									"",
								)
							}
						>
						...
						<div className="col-12 mt-2">
							...
							>
								<div
									...
									style={{ width: "72%", background: "var(--pm-info)" }}
								/>
							</div>
						</div>
					</div>
				...
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"freezeCardModal",
								"Card frozen successfully. All transactions are blocked.",
								"",
							)
						}
					>
		...
		>
			{renderActionBody(
				...
				<>
					...
					>
						<i className="bi bi-info-circle me-1" /> Freezing a card blocks all
						new transactions immediately. Pre-authorized payments may still
						process. You can unfreeze at any time.
					</div>
				</>,
			)}
		</MBox>
	...
	const renderGenerateCVV = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-arrow-clockwise text-danger me-2" />
					Rotate Security Code (CVV)
				</>
			}
			footer={
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"generateCVVModal",
								"CVV rotated. Your new CVV is 491.",
								"ROT-20250627",
							)
						}
					>
		...
		>
			{renderActionBody(
				...
				<>
					...
					>
						<i className="bi bi-exclamation-triangle me-1" /> Warning: Rotating
						the CVV will immediately invalidate the current 3-digit code. Any
						saved checkouts using the old CVV will fail until updated.
					</div>
	...
	const renderSubscriptionManage = () => (
		<MBox
			...
			title={
				<>
					<i
						className="bi bi-arrow-repeat text-purple me-2"
								...
								<tr>
									<td>
										<div className="d-flex align-items-center gap-2">
											<div
												className={styles.iconCircle}
												style={{ background: "#1473E6", color: "#fff" }}
											>
												A
											</div>
											AWS
			...
			footer={
				<>
					...
					<button
						className={`${styles.btnPm} ${styles.btnPmP}`}
						onClick={() =>
							doAction("autoPayModal", "Auto-pay successfully configured.", "")
						}
					>
						Save Settings
					</button>
		...
		>
			{renderActionBody(
				...
				<>
					...
					<div className="mb-3">
						<label className={styles.formLabel}>Deduction Date</label>
						<select className={styles.formControl}>
					...
					>
						Auto-pay ensures you never miss a payment and avoids late fees. If
						your balance is lower than the amount you owe, we will notify you 24
						hours prior.
					</div>
				</>,
			)}
	...
	const renderTransactionHistory = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-list-columns text-primary me-2" />
					Virtual Card Statements
				</>
			}
			footer={
				<button className={styles.btnPm} onClick={onClose}>
	...
	const renderDisputeTransaction = () => (
		<MBox
			id="disputeTransactionModal"
			active={active}
			onClose={onClose}
			title={
				<>
					<i
						className="bi bi-shield-exclamation text-accent me-2"
					...
					<button
						...
						onClick={() =>
							doAction(
								...
								"Dispute submitted. Tracking ID: CHB-92014.",
								"CHB-92014",
							)
						}
					>
		...
		>
			{renderActionBody(
				...
				<>
					...
					<div className="mb-3">
						<label className={styles.formLabel}>Reason for Dispute</label>
						<select className={styles.formControl}>
					...
					<div className="mb-3">
						...
						<textarea className={styles.formControl} rows={3}>
							I cancelled this subscription on the merchant's website on June
							20th, but I was still charged.
						</textarea>
					</div>
					<div
						className="p-3 rounded"
						style={{ background: "var(--pm-info-soft)", fontSize: 12 }}
					>
						<i className="bi bi-info-circle me-1" /> Disputes may take up to 14
						days to resolve. A temporary credit may be issued while we
						investigate with Visa/Mastercard.
					</div>
				</>,
			)}
		</MBox>
		...
		>
			{renderActionBody(
				...
				<>
					...
					<h6 style={{ fontWeight: 700, marginTop: 24, marginBottom: 12 }}>
					...
					>
						<div
							className={styles.progressBarFill}
							style={{ width: "45%", background: "var(--pm-primary)" }}
							title="Digital Ads"
						/>
						<div
							className={styles.progressBarFill}
							style={{ width: "30%", background: "var(--pm-info)" }}
							title="Software"
						/>
						<div
							className={styles.progressBarFill}
							style={{ width: "15%", background: "var(--pm-warning)" }}
							title="Travel"
						/>
						<div
							className={styles.progressBarFill}
							style={{ width: "10%", background: "var(--pm-accent)" }}
							title="Entertainment"
						/>
					</div>
	...
	const renderStatements = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-file-earmark-pdf me-2"></i> Download Statements
				</>
			}
			footer={
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"statementsModal",
								"Statement generated and downloaded to your device.",
								"",
							)
						}
					>
				...
				<>
					...
					<div className="form-check">
						...
						<label className="form-check-label" style={{ fontSize: 13 }}>
							Include merchant category codes (MCC)
						</label>
					</div>
				</>,
			)}
	...
	const renderLimitIncrease = () => (
		<MBox
			id="limitIncreaseModal"
			active={active}
			onClose={onClose}
			title={
				<>
					<i
						className="bi bi-graph-up text-accent me-2"
						style={{ color: "var(--pm-accent)" }}
					/>
				...
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"limitIncreaseModal",
								"Limit increase application submitted! You will receive a decision within 5 minutes.",
								"",
							)
						}
					>
		...
		>
			{renderActionBody(
				...
				<>
					...
					<div className="mb-3">
						<label className={styles.formLabel}>Requested Limit (KES)</label>
						<input
							type="number"
							className={styles.formControl}
							defaultValue={250000}
					...
					<div className="mb-3">
						<label className={styles.formLabel}>Reason for Increase</label>
						<select className={styles.formControl}>
					...
					<p style={{ fontSize: 11, color: "var(--pm-muted)" }}>
						Approval is subject to an instant soft credit check. This will not
				...
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"deleteCardModal",
								"Card permanently deleted. Limit returned to pool.",
								"",
							)
						}
					>
			...
			{renderActionBody(
				...
				<>
					<p style={{ fontSize: 13, color: "var(--pm-ink-soft)" }}>
						...
						<strong>AWS Hosting (ends in 9173)</strong>?
					</p>
					<div
						className="p-3 rounded mb-3"
						style={{
					...
					>
						<i className="bi bi-exclamation-triangle me-1" /> Any pending
						transactions or future subscriptions tied to this card will fail.
	...
	const renderDeletedCards = () => (
		<MBox
			id="deletedCardsModal"
			active={active}
			onClose={onClose}
			title={
				<>
					<i className="bi bi-archive me-2"></i> Inactive & Deleted Cards
				</>
			}
			footer={
				<button className={styles.btnPm} onClick={onClose}>
		...
		>
			{renderActionBody(
				...
				<>
					...
					<p style={{ fontSize: 11, color: "var(--pm-muted)", marginTop: 12 }}>
						Historical statements for deleted cards are still available in the
						Statements section.
					</p>
				</>,
			)}
	...
	const renderManageCard = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-gear me-2"></i> Manage Virtual Card
				</>
			}
			footer={
				<button className={styles.btnPm} onClick={onClose}>
		...
		>
			...
			<div id="managev-settings" className={styles.tpanelActive}>
				...
				<div className="form-check form-switch mb-3">
					...
					<label className="form-check-label">
						Lock to single merchant (Facebook Ads)
					</label>
				</div>
			</div>
			...
			<div id="managev-danger" className={styles.tpanel}>
				...
				<button
					className={`${styles.btnPm} ${styles.btnPmD} w-100 mb-2`}
					onClick={() => {
						onOpen("deleteCardModal");
						onClose();
					}}
				>
				...
				<>
					...
					<div className={styles.statusRow}>
						<div>
							...
							<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
								&apos;Marketing Ads&apos; card at 92% of limit
							</div>
						</div>
						<button
							className={styles.btnPm}
							onClick={() => {
								onOpen("limitAllocationModal");
								onClose();
							}}
						>
							Adjust
	...
	const renderNotifications = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-bell me-2"></i> Card Notifications
				</>
			}
			footer={
				<>
			...
			{renderActionBody(
				...
				<>
					...
					>
						...
						<strong>Limit Warning</strong> — Software Subs card is at 90% of its
						monthly limit.
					</div>
					<div
						className="p-3 rounded mb-2"
					...
					>
						<i
							...
							style={{ color: "var(--pm-purple)" }}
						/>{" "}
						<strong>Statement Ready</strong> — Your May 2025 virtual card
	...
	const renderProfile = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-person-circle me-2"></i> Profile & Card Settings
				</>
			}
			footer={
				<button className={styles.btnPm} onClick={onClose}>
	...
	const renderCardExpiry = () => (
		<MBox
			...
			title={
				<>
					<i
						className="bi bi-calendar-x text-purple me-2"
						style={{ color: "var(--pm-purple)" }}
					/>
					Card Expiring Soon
				</>
				...
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"cardExpiryModal",
								"Card successfully renewed. Valid Thru is now 06/28.",
								"",
							)
						}
					>
			...
			{renderActionBody(
				...
				<>
					<div className="text-center mb-4">
						...
						<p style={{ fontSize: 13, color: "var(--pm-muted)" }}>
							Ends in 9173 · Expires 06/25
						</p>
					</div>
					<p style={{ fontSize: 13 }}>
						This virtual card is expiring in 5 days. Subscriptions tied to this
						card (like AWS) will fail if not updated.
					</p>
					<div className="p-3 border rounded mb-3">
						<div className="form-check">
							<input
							...
							<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
								Generates a new expiry date. PAN remains same, CVV changes.
							</div>
						</div>
					</div>
					<div className="p-3 border rounded mb-3">
						<div className="form-check">
							...
							<label
								...
								style={{ fontWeight: 700, fontSize: 13 }}
							>
								Close Card on Expiry
							</label>
							<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
								Let it expire. Future charges will be declined.
							</div>
						</div>
					</div>
				</>,
