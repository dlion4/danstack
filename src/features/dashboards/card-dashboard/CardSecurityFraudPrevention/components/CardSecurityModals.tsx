...
export default function CardSecurityModals({
	active,
	onClose,
	onOpen,
	config,
	...
	const renderHealthCheck = () => (
		...
		>
			...
			<div className={styles.sr}>
				<div>
					<strong>PIN Strength</strong>
					<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
						Changed &lt; 90 days ago
					</div>
				</div>
				<span className={`${styles.badge} ${styles.badgeS}`}>+20</span>
			</div>
			<div className={styles.sr}>
				<div>
					<strong>3DS Enrollment</strong>
					<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
						Biometric push enabled
					</div>
				</div>
				<span className={`${styles.badge} ${styles.badgeS}`}>+30</span>
			</div>
			<div className={styles.sr}>
				<div>
			...
			<div className={styles.sr}>
				<div>
					...
					<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>Active</div>
				</div>
				<span className={`${styles.badge} ${styles.badgeS}`}>
					<i className="bi bi-check" />
				</span>
			...
			<div className={styles.sr}>
				<div>
					<strong>VPN Protection</strong>
					<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>Disabled</div>
				</div>
				<span className={`${styles.badge} ${styles.badgeW}`}>0</span>
			</div>
			<div className="mt-3">
				<button
					className={`${styles.btnPm} ${styles.btnPmP} w-100`}
					onClick={() => onOpen("vpnProxyBlockerModal")}
				>
					Improve Score
				</button>
			</div>
		...
		>
			...
			>
				...
				<div style={{ fontSize: 12, marginTop: 4 }}>
					KES 12,500 at AliExpress (CN). Reason: Geo-mismatch.
				</div>
				<button
					className={`${styles.btnPm} ${styles.btnSm} ${styles.btnPmD} mt-2`}
					onClick={() => onOpen("reviewSuspiciousTxModal")}
				>
					Review
				</button>
			</div>
			...
			>
				<div className="d-flex justify-content-between">
					<strong style={{ color: "var(--pm-warning)", fontSize: 13 }}>
						Velocity Warning
					</strong>
					<span style={{ fontSize: 10, color: "var(--pm-muted)" }}>
						Yesterday
				...
				<div style={{ fontSize: 12, marginTop: 4 }}>
					Virtual Card 1011 had 4 transactions in 10 minutes.
				</div>
			</div>
		</MBox>
	);
			...
			<div className="row g-2 text-start mt-3" style={{ fontSize: 13 }}>
				...
				<div className="col-6">
					...
					>
						...
						<br />
						<strong style={{ color: "var(--pm-accent)" }}>92/100</strong>
					</div>
				</div>
			</div>
		</MBox>
					...
					<div className={styles.fstepActive}>
						...
						>
							...
							<div className="d-flex justify-content-between mb-2">
								...
								<strong>Today, 04:12 AM</strong>
							</div>
							<div className="d-flex justify-content-between">
								<span className="text-muted">Risk Flag</span>
								<strong>Device in KE, Tx in CN</strong>
							</div>
						</div>
					...
					<div className={styles.fstepActive}>
						{rsDecision === "no" && (
							<>
								...
								<p style={{ fontSize: 13, color: "var(--pm-ink-soft)" }}>
									We will immediately freeze Virtual Card 4412 and block this
									merchant.
								</p>
							</>
						)}
						{rsDecision === "yes" && (
							<>
								...
								<p style={{ fontSize: 13, color: "var(--pm-ink-soft)" }}>
									We will clear the block. The transaction can be retried.
								</p>
							</>
						)}
					</div>
				...
				{step === 3 && (
					<div className={styles.fstepActive}>
						<div className={styles.receipt}>
							...
							<p style={{ fontSize: 13, color: "var(--pm-ink-soft)" }}>
								{rsDecision === "no"
									? "Card has been frozen. A replacement is being issued."
									: "The transaction has been cleared with no action needed."}
							</p>
						</div>
					</div>
				)}
				...
				footer={
					<>
						...
						{step < 4 && (
							<button
								className={`${styles.btnPm} ${styles.btnPmP}`}
								onClick={() => nextFlow("fr", 4)}
							>
								{step >= 3
									? 'Activate Rule <i className="bi bi-check" />'
			...
			>
					...
					<div className={styles.fstepActive}>
						...
						<div className="mb-3">
							...
							<input
								...
								defaultValue="Block Late Night International"
							/>
						</div>
						<div className="mb-3">
				...
				{step === 3 && (
					<div className={styles.fstepActive}>
						...
						>
							<i className="bi bi-info-circle me-1" /> Rules can be overridden
							by trusted merchants or device binding settings.
						</div>
					</div>
				)}
				{step === 4 && (
					<div className={styles.fstepActive}>
						<div className={styles.receipt}>
							...
							<p style={{ fontSize: 13, color: "var(--pm-ink-soft)" }}>
								Block Late Night International is now active.
							</p>
						</div>
					</div>
				)}
	...
	const renderMCCBlocker = () => (
			...
			footer={
				<>
					...
					<button
						className={`${styles.btnPm} ${styles.btnPmP}`}
						onClick={() =>
							doAction("mccBlockerModal", "MCC rules updated successfully")
						}
					>
						Save
					</button>
		...
		>
			<p style={{ fontSize: 13, color: "var(--pm-ink-soft)" }}>
				Block spending at specific types of merchants globally.
			</p>
			<div className={styles.sr}>
				<div>
					<strong>Gambling & Betting</strong>
				</div>
			...
			<div className={styles.sr}>
				<div>
					<strong>Bars & Liquor Stores</strong>
				</div>
				<div className="form-check form-switch">
	...
	const renderVelocityLimits = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-speedometer2 text-info me-2" />
					Velocity Limits
				</>
			}
			footer={
				<>
					...
					<button
						className={`${styles.btnPm} ${styles.btnPmP}`}
						onClick={() =>
							doAction("velocityLimitsModal", "Velocity limits saved")
						}
					>
						Save
					</button>
		...
		>
			...
			<div className="form-check">
				...
				<label className="form-check-label" style={{ fontSize: 13 }}>
					Block transactions exceeding limits (otherwise just flag)
				</label>
			</div>
		</MBox>
	);
	...
	const renderVPNProxyBlocker = () => (
			...
			footer={
				<>
					...
					<button
						className={`${styles.btnPm} ${styles.btnPmP}`}
						onClick={() =>
							doAction("vpnProxyBlockerModal", "VPN rules updated")
						}
					>
						Save
					</button>
		...
		>
			<p style={{ fontSize: 13, color: "var(--pm-ink-soft)" }}>
				Automatically reject online transactions if the buyer's IP address
				belongs to a known VPN, Tor node, or anonymous proxy.
			</p>
			<div className={styles.sr}>
				<div>
					<strong>Block Anonymous IPs</strong>
				</div>
				<div className="form-check form-switch">
					<input className="form-check-input" type="checkbox" defaultChecked />
				</div>
			...
			<div className={styles.sr}>
				<div>
					<strong>Block Cloud Provider IPs</strong>
					<br />
		...
		>
			<div className={styles.sr}>
				<div>
					...
					<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
						Biometric 3DS Push Enabled
					</div>
				</div>
				<span className={`${styles.badge} ${styles.badgeS}`}>Verified</span>
			</div>
			<div className={styles.sr}>
				<div>
					<strong>MacBook Air M2</strong>
					<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
						Web access · Last used yesterday
					</div>
				</div>
			...
			<button className={`${styles.btnPm} ${styles.btnSm} w-100 mt-3`}>
				<i className="bi bi-plus" /> Add New Trusted Device
			</button>
		</MBox>
	);
	...
	const renderManage3DS = () => (
		<MBox
			...
			title={
				<>
					<i
						className="bi bi-shield-lock text-accent me-2"
						style={{ color: "var(--pm-accent)" }}
					/>
					3D Secure Preferences
				</>
			}
			footer={
				<>
					...
					<button
						className={`${styles.btnPm} ${styles.btnPmP}`}
						onClick={() => doAction("manage3DSModal", "3DS Preferences Saved")}
					>
						Save
					</button>
				</>
		...
		>
			...
			<div className="form-check">
				...
				<label className="form-check-label" style={{ fontSize: 13 }}>
					Skip 3DS for saved subscriptions (Netflix, Spotify)
				</label>
			</div>
		</MBox>
	);
	...
	const renderGeoFencing = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-geo-alt text-info me-2" />
					Geo-Fencing
				</>
			}
			footer={
				<>
					...
					<button
						className={`${styles.btnPm} ${styles.btnPmP}`}
						onClick={() => doAction("geoFencingModal", "Geo-Fencing Updated")}
					>
						Save
					</button>
				</>
		...
		>
			<div className="form-check form-switch mb-3">
				...
				<label className="form-check-label fw-bold">
					Enable Phone Location Enforcement
				</label>
			</div>
			<p style={{ fontSize: 12, color: "var(--pm-ink-soft)" }}>
				Blocks physical POS/ATM transactions if your physical card is used more
				than X kilometers away from your phone's GPS location.
			</p>
			<div className="mb-3">
	...
	const renderTravelMode = () => (
		<MBox
			...
			title={
				<>
					<i
						className="bi bi-airplane text-purple me-2"
				...
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"travelModeModal",
								"Travel itinerary logged. Cards will work smoothly abroad.",
							)
						}
					>
						Set Travel Mode
		...
		>
			<p style={{ fontSize: 12, color: "var(--pm-ink-soft)" }}>
				Pre-declare travel destinations to ensure your card is not blocked for
			...
			<div className="mb-3">
				...
				<input
					type="text"
					className={styles.formControl}
					placeholder="e.g. UAE, South Africa"
				/>
			</div>
			<div className="row g-2 mb-3">
				<div className="col-6">
	...
	const renderContactlessLimit = () => (
		<MBox
			id="contactlessLimitModal"
			active={active}
			onClose={onClose}
			title={
				<>
					<i
						className="bi bi-wifi text-accent me-2"
						style={{ color: "var(--pm-accent)" }}
					/>
					Contactless Limits
				</>
			...
			footer={
				<>
					...
					<button
						className={`${styles.btnPm} ${styles.btnPmP}`}
						onClick={() =>
							doAction("contactlessLimitModal", "Contactless settings saved")
						}
					>
						Save
					</button>
		...
		>
			<div className="mb-3">
				<label className={styles.formLabel}>
					Max amount per tap without PIN (KES)
				</label>
				<input
					type="number"
					className={styles.formControl}
	...
	const renderFreezeCard = () => (
			...
			footer={
				<>
					...
					<button
						className={`${styles.btnPm} ${styles.btnPmP}`}
						onClick={() =>
							doAction("freezeCardModal", "Card frozen successfully")
						}
					>
						Freeze
					</button>
		...
		>
			...
			>
				Freezing is reversible. You can unfreeze it instantly from the app
				later. Subscriptions may fail while frozen.
			</div>
		</MBox>
	);
		...
		return (
				...
				footer={
					<>
						...
						{step < 4 && (
							<button
								className={`${styles.btnPm} ${styles.btnPmP}`}
								onClick={() => nextFlow("rc", 4)}
							>
								{step === 3
									? 'Freeze & Issue New <i className="bi bi-shield-lock" />'
									: 'Continue <i className="bi bi-arrow-right" />'}
							</button>
						)}
					</>
			...
			>
				...
				{step === 1 && (
					<div className={styles.fstepActive}>
						<h6 style={{ fontWeight: 700 }}>
							Step 1: Which card is compromised?
						</h6>
						<div className="mb-3">
							<label className={styles.formLabel}>Select Card</label>
							<select className={styles.formControl}>
				...
				{step === 2 && (
					<div className={styles.fstepActive}>
						<h6 style={{ fontWeight: 700 }}>
							Step 2: Flag Unauthorized Transactions
						</h6>
						<p style={{ fontSize: 12, color: "var(--pm-muted)" }}>
							Select any transactions you did not make. They will be pushed to
							disputes.
						</p>
				...
				{step === 3 && (
					<div className={styles.fstepActive}>
						...
						<div className={styles.sr}>
							<div>
								<strong>Permanent Card Block</strong>
							</div>
						...
						<div className={styles.sr}>
							<div>
								<strong>Disputes Created</strong>
							</div>
				...
				{step === 4 && (
					<div className={styles.fstepActive}>
						<div className={styles.receipt}>
							...
							<h5 style={{ fontWeight: 700, color: "var(--pm-accent)" }}>
								Compromise Report Filed
							</h5>
							<p style={{ fontSize: 13, color: "var(--pm-ink-soft)" }}>
								Card has been frozen. Replacement will arrive in 3-5 business
								days.
							</p>
						</div>
					</div>
	...
	const renderDisputeCenter = () => (
		<MBox
			id="disputeCenterModal"
			active={active}
			onClose={onClose}
			title={
				<>
					<i className="bi bi-life-preserver text-warning me-2" />
					Dispute Transaction (Chargeback)
				</>
			}
			footer={
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"disputeCenterModal",
								"Dispute logged. CB-11921 created.",
								"CB-11921",
							)
						}
					>
		...
		>
			...
			>
				Chargebacks may take 7-45 days to resolve via the Visa/Mastercard
				network. Please upload any evidence in the vault next.
			</div>
		</MBox>
	);
	...
	const renderEvidenceVault = () => (
		<MBox
			id="evidenceVaultModal"
			active={active}
			onClose={onClose}
			title={
				<>
					<i className="bi bi-cloud-arrow-up text-primary me-2" />
					Upload Evidence
				</>
			}
			footer={
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"evidenceVaultModal",
								"Evidence securely uploaded and attached to case.",
							)
						}
					>
						Upload
	...
	const renderSecurityScoreDetails = () => (
		<MBox
			id="securityScoreDetailsModal"
			active={active}
			onClose={onClose}
			title={
				<>
					<i
						className="bi bi-bar-chart-steps text-accent me-2"
						style={{ color: "var(--pm-accent)" }}
					/>
	...
	const renderMerchantWhitelist = () => (
		<MBox
			id="merchantWhitelistModal"
			active={active}
			onClose={onClose}
			title={
				<>
					<i className="bi bi-card-checklist text-success me-2" />
					Trusted Merchants
				</>
			}
			footer={
		...
		>
			<p style={{ fontSize: 12, color: "var(--pm-ink-soft)" }}>
				These merchants bypass standard velocity and geo-fencing checks based on
				your history.
			</p>
			<div className={styles.sr}>
				<div>
					<strong>Netflix (US)</strong>
					<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
						Recurring Sub
					</div>
				</div>
			...
			<div className={styles.sr}>
				<div>
					<strong>Safaricom PLC</strong>
					<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>Utility</div>
				</div>
				<button className={`${styles.btnPm} ${styles.btnSm} ${styles.btnPmD}`}>
					Remove
				</button>
			...
			<div className="mt-3">
				<input
					type="text"
					className={styles.formControl}
					placeholder="Search to add merchant manually"
				/>
			</div>
		</MBox>
	);
	...
	const renderCardReplacementTracker = () => (
		<MBox
			id="cardReplacementTrackerModal"
			active={active}
			onClose={onClose}
			title={
				<>
					<i className="bi bi-truck text-info me-2" />
					Replacement Tracker
				</>
			}
			footer={
		...
		<MBox
			...
			footer={
				<>
					...
					<button
						className={`${styles.btnPm} ${styles.btnPmP}`}
						onClick={() => onOpen("exportSecurityReportModal")}
					>
						Export
					</button>
				</>
