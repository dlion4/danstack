...
export function DefaultsSection() {
  ...
  return (
    <section id="card-defaults" className="scroll-mt-24">
      <SectionHead title="Programme Defaults" sub="Every newly issued card inherits these settings. Existing cards are unaffected.">
...
export function SupportSection() {
  ...
  return (
    <section id="support" className="scroll-mt-24">
      <SectionHead  title="Get Support" sub="Reach a card specialist through whichever channel suits you." />
...
export function FaqSection() {
  ...
  return (
    <section id="faq" className="scroll-mt-24">
      <SectionHead  title="Help & FAQs" sub="Answers to the questions card administrators ask most." />
      <div className="grid gap-3 lg:grid-cols-5">
        <Reveal className="lg:col-span-3">
...
export function ResourcesSection() {
  ...
  return (
    <section id="resources" className="scroll-mt-24">
      <SectionHead  title="Resources & Trust" sub="Documentation, guides and the compliance foundations behind the programme." />
