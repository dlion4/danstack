...
function showLoading(target: string | HTMLElement, cb: () => void) {
	...
	ov.innerHTML =
		'<div class="${styles.spinner}"></div><p style="margin-top:12px;font-size:13px;font-weight:600;color:${"var(--pm-primary)"}>Processing...</p>';
...
function pickChip(el: HTMLElement, target: string, val: string) {
	el.parentElement
		?.querySelectorAll(".pm-amount-chip")
	...
	return (
		<div>
			<p style={{ fontSize: 13, color: "var(--pm-ink-soft)" }}>
				Temporarily block all transactions on card <strong>****4921</strong>.
				You can unfreeze it instantly at any time.
			</p>
			<div className="mb-3">
			...
			>
				<i className="bi bi-info-circle me-1" /> Freezing blocks new purchases
				and ATM withdrawals. Recurring subscriptions may also be declined.
			</div>
		</div>
	);
}
...
function ShowCvvModal() {
	return (
		<div className="text-center">
			<p style={{ fontSize: 13, color: "var(--pm-ink-soft)" }}>
				Enter your PayMo PIN to reveal the CVV and full card number for Virtual
				Debit ****8810.
			</p>
	...
	return (
		<div>
			<div className="text-center mb-4">
				<div
					className={`${styles.iconCircle} mx-auto mb-2`}
					style={{
						width: 56,
						height: 56,
				...
				<p style={{ fontSize: 14, fontWeight: 600, color: "var(--pm-danger)" }}>
					Declined: USD 45.00
				</p>
			</div>
			<div className="p-3 border rounded mb-3" style={{ fontSize: 13 }}>
				<div className="d-flex justify-content-between mb-2">
					...
					<strong>26 Jun 2025, 08:14 AM</strong>
				</div>
				<div className="d-flex justify-content-between mb-2">
					<span className="text-muted">Card Used</span>
					<strong>Virtual Debit ****8810</strong>
				</div>
				<div className="d-flex justify-content-between mb-2">
					<span className="text-muted">Category</span>
					<strong>Online / Tech</strong>
				</div>
				<div className="d-flex justify-content-between mb-2">
					<span className="text-muted">Decline Reason</span>
					<strong className="text-danger">Insufficient Prepaid Balance</strong>
				</div>
				<div className="d-flex justify-content-between">
					<span className="text-muted">Transaction ID</span>
					<strong>TXN-CRD-991204</strong>
				</div>
			</div>
			<div
				className="p-3 rounded"
				style={{ background: "var(--pm-info-soft)", fontSize: 12 }}
			>
				Your current prepaid balance is KES 2,150. You need approx KES 5,900 to
				clear this.
			</div>
		</div>
	);
		...
		<div>
			...
			<div className="form-check form-switch mb-3">
				...
				<label className="form-check-label">
					Notify on international transactions
				</label>
			</div>
			<div className="form-check form-switch mb-3">
				<input className="form-check-input" type="checkbox" defaultChecked />
				<label className="form-check-label">
					Notify on declined transactions
				</label>
			</div>
			<div className="form-check form-switch mb-3">
				<input className="form-check-input" type="checkbox" defaultChecked />
				<label className="form-check-label">
					Notify on Card-Not-Present (Online) usage
				</label>
			</div>
			<div className="mb-3">
	...
	return (
		<div>
			<div
				...
				style={{ borderLeft: "3px solid var(--pm-warning)!important" }}
			>
				<strong>Physical Debit ****3105</strong>
				<br />
				<span style={{ fontSize: 12, color: "var(--pm-muted)" }}>
					Expires: 09/26 (72 days remaining)
				</span>
			</div>
			<div className="form-check form-switch mb-3">
				<input className="form-check-input" type="checkbox" defaultChecked />
				...
				<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
					A new card will be generated 30 days before expiry.
				</div>
			</div>
			<div className="mb-3">
				<label className={styles.formLabel}>
					Delivery Address for New Card
				</label>
				<textarea className={styles.formControl} rows={2}>
					Apt 4B, Kilimani Heights, Nairobi
				</textarea>
			</div>
		</div>
	);
...
function RenewCardModal() {
	return (
		<div>
			<p style={{ fontSize: 13 }}>
				Initiate an early renewal for card ****3105. Your current card will
				remain active until you activate the new one or until it expires.
			</p>
			<div className="mb-3">
		...
		<div>
			<div className="row align-items-center mb-4">
				<div className="col-md-4 text-center">
					<div
						style={{
							...
							height: 120,
							borderRadius: "50%",
							border: "8px solid var(--pm-accent-soft)",
							borderTopColor: "var(--pm-accent)",
							borderRightColor: "var(--pm-accent)",
							position: "relative",
						}}
					>
						<div
				...
				<div className="col-md-8">
					...
					<p style={{ fontSize: 13, color: "var(--pm-ink-soft)" }}>
						Your card settings are highly secure. Implement the recommendations
						below to reach 100.
					</p>
				</div>
			</div>
				...
				<table className={styles.table}>
					...
					<tbody>
						...
						<tr>
							...
							<td>Medium</td>
							<td>
								<button className={styles.btnPm}>Change</button>
							</td>
						</tr>
						<tr>
							<td>International Txn Limits</td>
							<td>
								<span className={`${styles.badge} ${styles.badgeW}`}>
									Global allowed
								</span>
							...
							<td>High</td>
							<td>
								<button className={styles.btnPm}>Restrict</button>
							</td>
						</tr>
						<tr>
							<td>Contactless Limits</td>
							<td>
								<span className={`${styles.badge} ${styles.badgeS}`}>
									Capped KES 2,500
								</span>
...
function BudgetSettingsModal() {
	return (
		<div>
			<div className="mb-3">
				<label className={styles.formLabel}>
					Global Monthly Card Spend Limit
				</label>
				<input
					className={styles.formControl}
					type="number"
			...
			<h6 style={{ fontWeight: 700, marginTop: 20, marginBottom: 12 }}>
				Category Budgets
			</h6>
			<div className="row g-3">
				<div className="col-md-6">
					<label className={styles.formLabel}>Online Purchases</label>
					<input
						className={styles.formControl}
						type="number"
						defaultValue={50000}
				...
				<div className="col-md-6">
					<label className={styles.formLabel}>Dining & Entertainment</label>
					<input
						className={styles.formControl}
						type="number"
						defaultValue={30000}
				...
				<div className="col-md-6">
					<label className={styles.formLabel}>Groceries</label>
					<input
						className={styles.formControl}
						type="number"
						defaultValue={40000}
				...
				<div className="col-md-6">
					<label className={styles.formLabel}>Transport & Fuel</label>
					<input
						className={styles.formControl}
						type="number"
						defaultValue={20000}
			...
			<div className="form-check form-switch mt-4">
				<input className="form-check-input" type="checkbox" defaultChecked />
				<label className="form-check-label">
					Block transactions that exceed category limits
				</label>
			</div>
...
function MerchantAnalyticsModal() {
	return (
		<div>
			...
			<div className="table-responsive">
				<table className={styles.table}>
					...
					<tbody>
						<tr>
							<td>
								<strong>Carrefour Supermarket</strong>
							</td>
							<td>Groceries</td>
							<td>4</td>
							<td>KES 32,450</td>
						...
						<tr>
							...
							<td>
								<span className="text-success">
									<i className="bi bi-arrow-down" /> 4%
								</span>
							</td>
						</tr>
						<tr>
			...
			>
				<i className="bi bi-exclamation-triangle me-1" /> You have 2 active
				subscriptions to Netflix on different cards.
			</div>
		</div>
	);
}
		...
		<div>
			<div className={styles.stepper} id="lostStepper">
				<div className="pm-step active">
					...
					<div className="pm-step-label">Select</div>
				</div>
				<div className="pm-step-line"></div>
				<div className="pm-step">
					<div className="pm-step-num">2</div>
					<div className="pm-step-label">Confirm</div>
				</div>
				<div className="pm-step-line"></div>
				<div className="pm-step">
					<div className="pm-step-num">3</div>
					<div className="pm-step-label">Replace</div>
				</div>
			</div>
			...
			<div id="lostStep2" className="fade-step">
				...
				>
					<strong>WARNING:</strong> This will permanently cancel card ****3105.
					Any linked subscriptions will fail until updated with a new card. This
					action cannot be undone.
				</div>
				<label className={styles.formLabel}>
					Enter PIN to authorize cancellation
				</label>
				<div className={styles.pinInput}>
					<input
						type="password"
			...
			<div id="lostStep3" className="fade-step">
				<div className="text-center mb-3">
					...
					<p style={{ fontSize: 13 }}>
						Your card has been terminated. Reference: BLK-499120
					</p>
				</div>
				...
				<div className="mb-3">
					...
					<input
						className={styles.formControl}
						value="KES 500 (Deducted from Wallet)"
						disabled
					/>
				</div>
			</div>
...
function ReplaceCardModal() {
	return (
		<div>
			...
			<div className="mb-3">
				<label className={styles.formLabel}>
					Upload image of damaged card (Optional, waives fee)
				</label>
	...
	return (
		<div>
			...
			<div className="text-center mt-3">
				<a
					href="#"
					style={{ fontSize: 12, color: "var(--pm-primary)" }}
					onClick={(e) => {
						e.preventDefault();
					}}
				>
					Forgot current PIN? Reset via OTP.
				</a>
			</div>
		</div>
	);
...
function ResetPinModal() {
	return (
		<div>
			...
			<button className={`${styles.btnPm} ${styles.btnSm} w-100 mb-4`}>
				Send OTP
			</button>
...
function ContactlessLimitModal() {
	return (
		<div>
			...
			<div className="mb-3">
				<label className={styles.formLabel}>
					Maximum per tap without PIN (KES)
				</label>
				<input
					className={styles.formControl}
					type="number"
			...
			<div className="mb-3">
				<label className={styles.formLabel}>
					Maximum daily contactless limit (KES)
				</label>
				<input
					className={styles.formControl}
					type="number"
			...
			>
				Transactions above these limits will require you to insert the card and
				enter your PIN.
			</div>
		</div>
	);
	...
	return (
		<div>
			...
			<div className="form-check form-switch mb-3">
				<input className="form-check-input" type="checkbox" defaultChecked />
				<label className="form-check-label">
					Enable Online/E-commerce Purchases
				</label>
			</div>
			<div className="form-check form-switch mb-3">
				<input className="form-check-input" type="checkbox" defaultChecked />
				<label className="form-check-label">
					Require 3D Secure OTP for all online txn
				</label>
			</div>
			<div className="mb-3">
				<label className={styles.formLabel}>
					Allow Subscriptions / Recurring billing
				</label>
				<select className={styles.formControl}>
					<option>Yes</option>
					<option>No</option>
	...
	return (
		<div>
			...
			<p style={{ fontSize: 12, color: "var(--pm-muted)" }}>
				Pre-declare travel dates to prevent security blocks.
			</p>
			...
			<input
				...
				className={styles.formControl}
				mb-3
				placeholder="Destination Countries (e.g. UAE, UK)"
			/>
		</div>
	);
}
	...
	return (
		<div>
			...
			<div className="form-check form-switch">
				...
				<label className="form-check-label">
					Allow International ATM Withdrawals
				</label>
			</div>
		</div>
	);
...
function TempLimitModal() {
	return (
		<div>
			<p style={{ fontSize: 13 }}>
				Set a temporary spending cap that automatically expires after a specific
				time.
			</p>
			<div className="mb-3">
				<label className={styles.formLabel}>Select Card</label>
	...
	return (
		<div>
			<div className={styles.stepper} id="payBillStepper">
				...
				<div className="pm-step">
					<div className="pm-step-num">2</div>
					<div className="pm-step-label">Pay</div>
				</div>
			</div>
			...
			<div id="payBillStep2" className="fade-step">
				...
				<div className="mb-3">
					<div
						...
						onClick={(e) => selectRadioCard(e.currentTarget as HTMLElement)}
					>
	...
	return (
		<div>
			...
			>
				...
				<div className="d-flex justify-content-between">
					<span>Max Allowed Balance</span>
					<strong>KES 100,000</strong>
				</div>
			</div>
			<div className="mb-3">
				...
				<div className={styles.amountChips} mb-2>
					<span
						...
						onClick={(e) =>
							pickChip(e.currentTarget as HTMLElement, "topAmt", "1000")
						}
					>
						1,000
					</span>
					<span
						className={styles.amountChip}
						onClick={(e) =>
							pickChip(e.currentTarget as HTMLElement, "topAmt", "5000")
						}
					>
						5,000
					</span>
					<span
						...
						onClick={(e) =>
							pickChip(e.currentTarget as HTMLElement, "topAmt", "10000")
						}
					>
						10,000
					</span>
	...
	return (
		<div>
			<div className={styles.stepper} id="addCardStepper">
				...
				<div className="pm-step">
					<div className="pm-step-num">2</div>
					<div className="pm-step-label">Design</div>
				</div>
				<div className="pm-step-line"></div>
				<div className="pm-step">
					<div className="pm-step-num">3</div>
					<div className="pm-step-label">Deliver</div>
				</div>
			</div>
			...
			<div id="addCardStep2" className="fade-step">
				...
				<div className="d-flex gap-3 mb-3">
					<div
						className={`${styles.bankCard} ${styles.bankCardBg1}`}
						style={{
							width: 180,
							height: 114,
					...
					></div>
					<div
						className={`${styles.bankCard} ${styles.bankCardBg2}`}
						style={{ width: 180, height: 114, opacity: 0.6 }}
					></div>
					<div
						className={`${styles.bankCard} ${styles.bankCardBg4}`}
						style={{ width: 180, height: 114, opacity: 0.6 }}
					></div>
				</div>
				<div className="mb-3">
			...
			<div id="addCardStep3" className="fade-step">
				...
				<div
					...
					style={{ background: "var(--pm-info-soft)", fontSize: 12 }}
				>
					You will receive an OTP via SMS upon delivery to authorize the release
					of the card.
				</div>
			</div>
		</div>
...
function HealthCheckModal() {
	return (
		<div className="text-center">
			...
			<p style={{ fontSize: 13, color: "var(--pm-ink-soft)" }}>
				Your card portfolio is healthy. No active fraud alerts or impending
				expiries.
			</p>
...
function ProfileModal() {
	return (
		<div className="text-center">
			...
			<hr className={styles.divider} />
			<button
				className={`${styles.btnPm} ${styles.btnSm} w-100 mb-2`}
				style={{ marginBottom: 12 }}
			>
				Settings
			</button>
		...
		<div style={{ maxHeight: 400, overflowY: "auto" }}>
			<div className="p-3 border rounded mb-2">
				...
				<div style={{ fontSize: 12 }}>
					Amazon AWS (USD 45.00) declined due to insufficient prepaid balance.
				</div>
			</div>
			<div className="p-3 border rounded mb-2">
				<div className="d-flex justify-content-between">
			...
			<div className="p-3 border rounded mb-2">
				...
				<div style={{ fontSize: 12 }}>
					You have reached 85% of your global monthly card limit.
				</div>
			</div>
		</div>
	);
