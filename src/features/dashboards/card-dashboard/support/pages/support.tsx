...
const initialMockData: SupportConfig = {
	...
	headerSub:
		"Self-service help, troubleshooting, disputes, and emergency support",
		...
		suggestions: [
			{
				...
				sub: "Increase fraud detection coverage",
				actionLabel: "Enable",
				modal: "notifSettingsModal",
			},
			{
				icon: "bi-globe",
				...
				sub: "Only enable when travelling",
			...
			},
			{
				...
				sub: "No default contactless card selected",
				actionLabel: "Set",
...
async function fetchSupportConfig(): Promise<SupportConfig> {
	try {
		const res = await fetch("/api/card-support", {
				...
				<div className="row g-3">
					<div className="col-lg-4">
						...
						>
							...
							>
								Support center live <span style={{ color: "#86efac" }}>●</span>
							</p>
							<div
								className={styles.sv}
							...
							>
								Self-service tools, live chat, phone hotline, and emergency
					...
					<div className="col-lg-3 col-md-4 col-6">
						<div className={styles.card} style={{ minHeight: 170 }}>
							...
							<span className={`${styles.badge} ${styles.badgeS}`}>
								<i className="bi bi-chat-left-text" /> Live chat
							</span>
							<div
								className="mt-2"
								style={{ fontSize: 12, color: "var(--pm-ink-soft)" }}
							>
								Phone: +254 800 723 001
								<br />
								Email: cards@paymo.co.ke
							</div>
						</div>
					</div>
					<div className="col-lg-2 col-md-4">
						...
						>
							<p className={styles.sl} style={{ color: "var(--pm-danger)" }}>
								EMERGENCY
							</p>
							<div className={styles.sv} style={{ margin: "6px 0" }}>
								24/7
							...
							<div className="row g-3">
								...
								<div className="col-lg-4">
									<div className={styles.ub}>
										...
										>
											<i className="bi bi-chat-dots text-info me-1"></i> Support
											Channels
										</h4>
										<div
											className={styles.sr}
