...
export default function SupportModals({ active, onClose }: ModalsProps) {
			...
			footer={
				<button
					...
					onClick={() =>
						doAction(
							"freezeCardModal",
							"Card freeze status updated successfully!",
						)
					}
				>
					Update Status
		...
		>
			<div className="mb-3">
				...
				<select className={styles.formControl}>
					...
					<option>Online Shopping ****1190</option>
				</select>
			</div>
			<div
			...
			>
				<div className="form-check form-switch mb-2">
					...
					<label className="form-check-label fw-bold">Temporary Freeze</label>
	...
	const renderTroubleshoot = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-wrench text-warning me-2" />
					Transaction Troubleshooter
				</>
			}
			footer={
				<button
					...
					onClick={() =>
						doAction(
							"troubleshootModal",
							"Diagnosis complete. Recommendations generated.",
						)
					}
				>
					Run Diagnosis
		...
		>
			<div className="mb-3">
				<label className={styles.formLabel}>Select Failed Transaction</label>
				<select className={styles.formControl}>
					<option>
			...
			>
				<strong>Common causes:</strong> Insufficient funds, card frozen, daily
				limit exceeded, 3DS authentication pending, MCC blocked.
			</div>
				...
				<div className="col-md-6">
					<div className="form-check">
						<input
							...
							defaultChecked
						/>
						<label className="form-check-label">Insufficient funds</label>
					</div>
					<div className="form-check">
						<input className="form-check-input" type="radio" name="issue" />
						<label className="form-check-label">Card frozen / blocked</label>
					</div>
					<div className="form-check">
						<input className="form-check-input" type="radio" name="issue" />
						<label className="form-check-label">Daily limit exceeded</label>
					</div>
				</div>
				<div className="col-md-6">
					<div className="form-check">
					...
					<div className="form-check">
						<input className="form-check-input" type="radio" name="issue" />
						<label className="form-check-label">MCC / merchant blocked</label>
					</div>
					<div className="form-check">
						<input className="form-check-input" type="radio" name="issue" />
	...
	const renderContactSupport = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-headset text-primary me-2" />
					Contact Support
				</>
			}
			footer={
				...
				<div className="col-md-6">
					<div className={styles.ub}>
						...
						<button
							...
							style={{ width: "100%" }}
							onClick={() =>
								doAction("contactSupportModal", "Chat session started!")
							}
						>
				...
				<div className="col-md-6">
					<div className={styles.ub}>
						...
						<button
							...
							style={{ width: "100%" }}
							onClick={() =>
								doAction("contactSupportModal", "Call request submitted!")
							}
						>
				...
				<div className="col-md-6">
					<div className={styles.ub}>
						...
						<button
							...
							style={{ width: "100%" }}
							onClick={() =>
								doAction("contactSupportModal", "Email support ticket created!")
							}
						>
				...
				<div className="col-md-6">
					<div className={styles.ub}>
						...
						<button
							...
							onClick={() =>
								doAction("contactSupportModal", "WhatsApp chat initiated!")
							}
						>
	...
	const renderFaq = () => (
		...
		>
			...
			<div className={styles.ub}>
				...
				<div className={styles.sr}>
					<div>
						<strong>What should I do if my card is lost or stolen?</strong>
					</div>
					<i className="bi bi-chevron-down text-muted" />
				</div>
				<div className={styles.sr}>
					<div>
						<strong>How can I increase my transaction limits?</strong>
					</div>
					<i className="bi bi-chevron-down text-muted" />
				</div>
				<div className={styles.sr}>
					<div>
						<strong>Why was my transaction declined?</strong>
					</div>
					<i className="bi bi-chevron-down text-muted" />
				</div>
				<div className={styles.sr}>
					<div>
						<strong>How do I set up contactless payments?</strong>
					</div>
					<i className="bi bi-chevron-down text-muted" />
				</div>
			</div>
	...
	const renderCardStatus = () => (
		...
		>
			<div className="mb-3">
				<label className={styles.formLabel}>Enter Card Number</label>
				<input
			...
			<div className={styles.ub}>
				...
				<div className={styles.sr}>
					...
					<span className={`${styles.badge} ${styles.badgeD}`}>Disabled</span>
				</div>
			</div>
		</MBox>
	);
	...
	const renderBinLookup = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-search text-info me-2" />
					BIN Lookup Tool
				</>
			}
			footer={
		...
		>
			<div className="mb-3">
				<label className={styles.formLabel}>Enter BIN / IIN</label>
	...
	const renderReportLost = () => (
				...
				<button
					...
					onClick={() =>
						doAction(
							...
							"LST-" + Math.random().toString(36).slice(2, 8).toUpperCase(),
						)
					}
				>
					Report Card
		...
		>
			...
			>
				<div
					style={{ fontSize: 13, fontWeight: 700, color: "var(--pm-danger)" }}
				>
					Immediate Action Required
				</div>
				<div style={{ fontSize: 12, color: "var(--pm-ink-soft)" }}>
					Your card will be blocked immediately and a replacement will be
					ordered.
				</div>
			</div>
			<div className="mb-3">
	...
	const renderRenewCard = () => (
			...
			footer={
				<button
					...
					onClick={() =>
						doAction(
							"renewCardModal",
							"Card renewal request submitted!",
							"RNW-" + Math.random().toString(36).slice(2, 8).toUpperCase(),
						)
					}
				>
					Submit Request
		...
		>
			<div className="mb-3">
				<label className={styles.formLabel}>Select Card to Renew</label>
				<select className={styles.formControl}>
					<option>Visa Debit ****4521 (expires 07/25)</option>
					<option>MC Debit ****3392 (expires 11/26)</option>
				</select>
			</div>
			<div className="mb-3">
				...
				<select className={styles.formControl}>
					...
					<option>Express Courier (4 hours)</option>
	...
	const renderEmergency = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-airplane text-warning me-2" />
			...
			footer={
				<button
					className={`${styles.btnPm} ${styles.btnPmP}`}
					onClick={() =>
						doAction("emergencyModal", "Emergency assistance request sent!")
					}
				>
					Request Assistance
				</button>
		...
		>
			...
			>
				...
				<div style={{ fontSize: 12, color: "var(--pm-ink-soft)" }}>
					Get cash advances, emergency card replacement, and concierge services
					worldwide.
				</div>
			</div>
			<div className="mb-3">
			...
			<div className="mb-3">
				<label className={styles.formLabel}>Assistance Type</label>
				<select className={styles.formControl}>
					<option>Cash Advance</option>
					<option>Emergency Replacement</option>
					<option>Card Block (Temporary)</option>
		...
		>
			...
			<div className={styles.ub}>
				...
				<div className={styles.sr}>
					...
					<span style={{ fontWeight: 700 }}>KES 0</span>
				</div>
			</div>
		</MBox>
	);
				...
				<>
					...
					<button
						...
						onClick={() => {
							downloadFile(
								"open-cases.csv",
								"Case ID,Type,Card,Status,Next Step\nCDP-44892,Chargeback,Visa ****4521,Awaiting evidence,Upload merchant receipt\nPR-11228,PIN Reset,MC ****3392,Processing,OTP verification pending",
								"text/csv",
							);
