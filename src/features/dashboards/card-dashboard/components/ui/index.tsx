...
export function SectionHead({
  ...
  return (
    <div id={id} className="mt-20 pt-6 mb-4 flex scroll-mt-24 flex-wrap items-center gap-3 first:mt-0">
      <span className="grid h-[30px] w-[30px] flex-none place-items-center rounded-[9px] font-display text-[12px] font-bold text-white">
        {/* {no} */}
      </span>
