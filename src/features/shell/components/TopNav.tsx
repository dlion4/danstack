          ...
          {isDropdownOpen('notifications') && (
            <div className={cx(s.dropdownPanel, s.show)} role="menu">
              ...
              <div className={cx(s.panelFooter, 'text-center')}>
                <Link to="/app/support" className={cx(s.btnLink, s.btnLinkPrimary)}>
            ...
            <div className={cx(s.dropdownPanel, s.show)} role="menu" style={{ width: 280 }}>
              ...
              <div className={s.panelBody}>
                <div className="d-flex flex-column">
                  <Link to="/app/settings" className={s.menuItem} onClick={() => onToggleDropdown('user')}>
                    <i className="bi bi-person" /> Profile
                  </Link>
                  <Link to="/app/settings" className={s.menuItem} onClick={() => onToggleDropdown('user')}>
                    <i className="bi bi-gear" /> Settings
                  </Link>
                  <Link to="/app/support" className={s.menuItem} onClick={() => onToggleDropdown('user')}>
