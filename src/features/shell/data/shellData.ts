...
export const initialMockData: ShellContent = {
  ...
  navGroups: [
  {
    title: 'Dashboard',
    items: [
      { key: 'transfer-overview', label: 'Transfer Overview', icon: 'bi-speedometer2' },
      { key: 'analytics', label: 'Transaction Analytics', icon: 'bi-graph-up-arrow' },
    ],
  },
  {
    title: 'Cash Flow',
    items: [
      { key: 'initiate-transfer', label: 'Initiate Transfer', icon: 'bi-send' },
      { key: 'transfers', label: 'Transfers Record', icon: 'bi-arrow-left-right' },
      { key: 'transfer-management', label: 'Transfer Management', icon: 'bi-list-task' },
      { key: 'payment-rails', label: 'Payment Rails & Routing', icon: 'bi-signpost-split' },
    ],
  },
  {
    ...
    items: [
      ...
      { key: 'reconciliation', label: 'Reconciliation Center', icon: 'bi-clipboard-check' },
      { key: 'settlement', label: 'Settlement & Clearing', icon: 'bi-bank' },
      { key: 'fx', label: 'Multi-Currency & FX', icon: 'bi-currency-exchange' },
  ...
  },
  {
    title: 'Compliance',
    items: [
      { key: 'compliance', label: 'Compliance & AML', icon: 'bi-shield-check' },
      { key: 'disputes', label: 'Disputes & Chargebacks', icon: 'bi-exclamation-triangle' },
      { key: 'kra-government', label: 'KRA & Government', icon: 'bi-building-check' },
    ],
  },
  {
