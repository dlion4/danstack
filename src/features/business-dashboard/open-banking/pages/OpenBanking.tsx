				...
				<div className="row g-3">
					<div className="col-lg-4">
						...
						>
							...
							>
								Equity, KCB, Co-op, Stanbic, Family, NCBA, I&M — consolidated
								view across all business and personal accounts.
							</p>
							<div className="d-flex flex-wrap mt-3" style={{ gap: 8 }}>
								...
								<button
									...
									onClick={() => setActiveModal("reconcileModal")}
								>
									Reconcile
								</button>
							</div>
					...
					<div className="col-lg-2 col-md-4 col-6">
						<div className={s.card} style={{ minHeight: 170 }}>
							...
							<span className={cx(s.badge, s.badgeS)}>
								<i className="bi bi-graph-up" /> +12.4% MoM
							</span>
							<div
								className="mt-2"
					...
					<div className="col-lg-3 col-md-4 col-6">
						<div className={s.card} style={{ minHeight: 170 }}>
							...
							<span className={cx(s.badge, s.badgeI)}>
								<i className="bi bi-lightning-charge" /> 186 transfers
							</span>
							<div
								className="mt-2"
								style={{ fontSize: 12, color: "var(--pm-ink-soft)" }}
					...
					<div className="col-lg-3 col-md-4">
						...
						>
							...
							<span className={cx(s.badge, s.badgeW)}>
								<i className="bi bi-exclamation-triangle" /> 14 exceptions
							</span>
							<div
								className="mt-2"
								style={{ fontSize: 12, color: "var(--pm-ink-soft)" }}
					...
					>
						<div>
							<h3 className={s.st}>
								...
								/>{" "}
								3.10.1 — Linked Bank Accounts & Consolidated Cash View
							</h3>
							<p className={s.ss}>
								View all connected bank accounts, balances, consent status, and
								sync health in one unified dashboard.
							</p>
						</div>
						<div className="d-flex" style={{ gap: 8 }}>
							<button
								className={cx(s.btnPm, s.btnSm)}
								onClick={() => setActiveModal("manageLinksModal")}
							>
							...
							<button
								...
								onClick={() => setActiveModal("connectBankModal")}
							>
								<i className="bi bi-plus-lg" /> Connect
							</button>
						</div>
					</div>
					<div className="row g-3">
												...
												<tr key={ba.account}>
													...
													<td>
														<span
															className={cx(
																s.badge,
																ba.sync === "Live" ? s.badgeS : s.badgeW,
															)}
														>
															{ba.sync}
														</span>
													...
													<td>
														<div className="d-flex" style={{ gap: 4 }}>
															...
															<button
																className={cx(s.btnPm, s.btnSm)}
																onClick={() =>
																	setActiveModal("accountDetailModal")
																}
															>
																View
															</button>
					...
					>
						<div>
							<h3 className={s.st}>
								...
								/>{" "}
								3.10.2 — Instant Transfers, Standing Orders & Scheduled Payments
							</h3>
							<p className={s.ss}>
							...
							<div className={s.utilityBlock}>
								...
								{config.standingOrders.map((so) => (
									<div key={so.label} className={s.statusRow}>
										...
										<button
											className={cx(s.btnPm, s.btnSm)}
											onClick={() => setActiveModal(so.modal)}
										>
											Edit
										</button>
									</div>
					...
					>
						<div>
							<h3 className={s.st}>
								...
								/>{" "}
								3.10.3 — Multi-Bank Reconciliation & Matching
							</h3>
							<p className={s.ss}>
								Auto-match transactions across banks, review exceptions, and
						...
						<div className="d-flex" style={{ gap: 8 }}>
							<button
								...
								onClick={() => setActiveModal("reconcileModal")}
							>
								<i className="bi bi-play" /> Run Now
							</button>
							<button
								className={cx(s.btnPm, s.btnSm)}
								onClick={() => setActiveModal("exportStatementModal")}
							>
					...
					<div className="row g-3">
						...
						<div className="col-lg-4">
							<div className={s.utilityBlock}>
								...
								>
									<div
										style={{ fontSize: 11, color: "#991B1B", fontWeight: 700 }}
									>
										EXCEPTIONS
									</div>
									<div
					...
					>
						<div>
							<h3 className={s.st}>
								...
								/>{" "}
								3.10.4 — Analytics, Preferences & API Management
							</h3>
							<p className={s.ss}>
								Track multi-bank performance, configure open banking
								preferences, and manage API integrations.
							</p>
						</div>
						<div className="d-flex" style={{ gap: 8 }}>
							<button
								className={cx(s.btnPm, s.btnSm)}
								onClick={() => setActiveModal("bankBenchmarkModal")}
							>
								<i className="bi bi-bar-chart" /> Benchmark
							</button>
							<button
								className={cx(s.btnPm, s.btnSm)}
								onClick={() => setActiveModal("obSettingsModal")}
							>
						...
						<div className="col-lg-4">
							<div className={s.utilityBlock}>
								...
								<div className={s.statusRow}>
									...
									<span className={cx(s.badge, s.badgeS)}>98</span>
								</div>
								<div className={s.statusRow}>
									<div>
										<strong>KCB</strong>
									...
									<span className={cx(s.badge, s.badgeS)}>96</span>
								</div>
								<div className={s.statusRow}>
									<div>
										<strong>Co-op</strong>
									...
									<span className={cx(s.badge, s.badgeS)}>94</span>
								</div>
								<div className={s.statusRow}>
									<div>
									...
									<span className={cx(s.badge, s.badgeW)}>71</span>
								</div>
							</div>
						</div>
						<div className="col-lg-4">
							<div className={s.utilityBlock}>
								...
								<div className={s.statusRow}>
									<div>
										<strong>Equity Eazzy Banking</strong>
										<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
											Balance & statements
										</div>
									</div>
