		...
		<MBox
			...
			footer={
				<button
					className={cx(s.btnPm, s.btnSm)}
					onClick={() =>
						doAction("sendInvoiceModal", "Invoice sent successfully!")
					}
				>
					Send Invoice
				</button>
		...
		>
			<div className="row g-3">
				<div className="col-md-4">
					<div className={cx(s.card, s.cardAccent)}>
						<div className={s.sl} style={{ color: "rgba(255,255,255,.7)" }}>
							TOTAL LINKS
						</div>
						<div className={s.sv}>12</div>
					</div>
				</div>
				<div className="col-md-4">
					<div className={s.card}>
						<div className={s.sl}>CONVERSION RATE</div>
						<div className={s.sv}>41.7%</div>
					</div>
				</div>
				<div className="col-md-4">
					<div className={s.card}>
						<div className={s.sl}>REVENUE VIA LINKS</div>
						<div className={s.sv}>KES 340K</div>
					</div>
				</div>
			</div>
		</MBox>
		...
		>
			{renderActionBody(
				...
				<>
					...
					<div className="mb-3">
						<label className={s.formLabel}>
							Second Reminder (days after due)
						</label>
						<input type="number" className={s.formControl} defaultValue="7" />
					</div>
					<div className="mb-3">
						<label className={s.formLabel}>Third Reminder (escalation)</label>
					...
					<div className="form-check mb-2">
						<input
							...
							defaultChecked
						/>
						<label className="form-check-label">Auto-send via Email</label>
					</div>
					<div className="form-check mb-2">
						<input className="form-check-input" type="checkbox" />
						<label className="form-check-label">Auto-send via WhatsApp</label>
					</div>
