		...
		>
			{renderActionBody(
				...
				<>
					...
					<div className="mb-3">
						<label className={s.formLabel}>Bank Account</label>
						<input
							type="text"
							className={s.formControl}
							defaultValue="KCB - 0123456789"
						/>
					</div>
					<div className="mb-3">
						<label className={s.formLabel}>Gross Salary</label>
						<input
							type="number"
							className={s.formControl}
							defaultValue="68000"
		...
		>
			{renderActionBody(
				...
				<>
					...
					<button className={cx(s.btnPm, s.btnSm, "w-100")}>
						<i className="bi bi-plus" /> Add Component
					</button>
				</>,
			)}
		</MBox>
	...
	const renderTaxConfig = () => (
		...
		>
			{renderActionBody(
				...
				<>
					<div className="mb-3">
						<label className={s.formLabel}>PAYE Rates</label>
						<div
							className={s.formControl}
							style={{ background: "var(--pm-surface-2)" }}
						>
							KRA 2025 bands configured
						</div>
					</div>
					<div className="mb-3">
					...
					<div className="mb-3">
						...
						<input type="number" className={s.formControl} defaultValue="6" />
					</div>
					<div className="mb-3">
						<label className={s.formLabel}>Housing Levy</label>
						<input type="number" className={s.formControl} defaultValue="1.5" />
					</div>
				</>,
			)}
		</MBox>
