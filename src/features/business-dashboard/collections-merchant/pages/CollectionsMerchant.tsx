			...
			<div className={s.content}>
				...
				<div className="row g-3">
					...
					<div className={config.heroStats[1].col}>
						<div className={s.card} style={{ minHeight: 170 }}>
							<p
								className={s.sl}
								style={{ color: config.heroStats[1].labelColor }}
							>
								{config.heroStats[1].label}
							</p>
							<div className={s.sv} style={{ margin: "6px 0" }}>
								{config.heroStats[1].value}
							</div>
							{config.heroStats[1].badge && (
								<span
									className={cx(s.badge, s[config.heroStats[1].badge.tone])}
								>
									<i className={`bi ${config.heroStats[1].badge.icon}`} />{" "}
									{config.heroStats[1].badge.text}
								</span>
							)}
					...
					<div className={config.heroStats[2].col}>
						<div className={s.card} style={{ minHeight: 170 }}>
							<p
								className={s.sl}
								style={{ color: config.heroStats[2].labelColor }}
							>
								{config.heroStats[2].label}
							</p>
							<div className={s.sv} style={{ margin: "6px 0" }}>
								{config.heroStats[2].value}
							</div>
							{config.heroStats[2].badge && (
								<span
									className={cx(s.badge, s[config.heroStats[2].badge.tone])}
								>
									<i className={`bi ${config.heroStats[2].badge.icon}`} />{" "}
									{config.heroStats[2].badge.text}
								</span>
							)}
								...
								<div className="mt-2">
									...
									<div className={s.progress} style={{ marginTop: 4 }}>
										<div
											...
											style={{
												width: `${config.heroStats[2].progress.percent}%`,
												background: config.heroStats[2].progress.color,
											}}
										/>
									</div>
								</div>
					...
					<div className={config.heroStats[3].col}>
						...
						>
							<p
								className={s.sl}
								style={{ color: config.heroStats[3].labelColor }}
							>
								{config.heroStats[3].label}
							</p>
							<div className={s.sv} style={{ margin: "6px 0" }}>
								{config.heroStats[3].value}
							</div>
							{config.heroStats[3].badge && (
								<span
									className={cx(s.badge, s[config.heroStats[3].badge.tone])}
								>
									<i className={`bi ${config.heroStats[3].badge.icon}`} />{" "}
									{config.heroStats[3].badge.text}
								</span>
							)}
					...
					<div className="col-lg-4">
						<div className={s.card}>
							<div className="d-flex justify-content-between align-items-center mb-3">
								...
								<button
									className={cx(s.btnPm, s.btnSm)}
									onClick={() => setActiveModal("attentionDetailModal")}
								>
									View all
								</button>
							</div>
				...
				<div className={s.card}>
					...
					>
						<div>
							...
							<p className={s.ss}>
								Manage your active payment rails, integrations, and POS
								channels.
							</p>
						</div>
						<div className="d-flex" style={{ gap: 8 }}>
							<button
								className={cx(s.btnPm, s.btnSm)}
								onClick={() => setActiveModal("apiConfigModal")}
							>
								<i className="bi bi-code" /> API
							</button>
							<button
						...
						{config.methods.map((m) => (
							<div key={m.key} className="col-md-3">
								<div
									...
									onClick={() => setActiveModal(m.modal)}
								>
									<div className="d-flex justify-content-between mb-3">
										...
										<span className={cx(s.badge, s[m.badge.tone])}>
											{m.badge.text}
										</span>
									</div>
									<h4
				...
				<div className={s.card}>
					...
					>
						...
						<button
							className={cx(s.btnPm, s.btnSm)}
							onClick={() => setActiveModal("analyticsModal")}
						>
							<i className="bi bi-graph-up" /> Deep Analytics
						</button>
					</div>
					<div className="row g-3">
								...
								<div className={s.chartBars}>
									{config.chartBars.map((cb) => (
										<div
											...
											style={{ height: cb.height, background: cb.color }}
										>
				...
				<div className={s.card}>
					...
					>
						...
						<div className="d-flex" style={{ gap: 8 }}>
							<button
								className={cx(s.btnPm, s.btnSm)}
								onClick={() => setActiveModal("sendReminderModal")}
							>
								<i className="bi bi-chat-dots" /> Message
							</button>
							<button
								className={cx(s.btnPm, s.btnSm, s.btnPmP)}
								onClick={() => setActiveModal("addCustomerModal")}
							>
						...
						<div className="col-lg-3">
							<div className={cx(s.utilityBlock, "text-center")}>
								...
								<button
									...
									onClick={() => setActiveModal("customerSegmentModal")}
								>
									Manage Segments
								</button>
							</div>
				...
				<div className={s.card}>
					...
					>
						...
						<button
							...
							onClick={() => setActiveModal("refundModal")}
						>
							<i className="bi bi-arrow-return-left" /> Process Refund
						</button>
					</div>
					<div className="row g-3">
							...
							<div className={s.utilityBlock}>
								...
								{config.disputes.map((d) => (
									<div
										...
										style={{
											background: "#fff",
											borderLeft: `3px solid ${d.border} !important`,
									...
									>
										<div className="d-flex justify-content-between align-items-center">
											...
											<div>
												...
												<span className={cx(s.badge, s[d.badge.tone])}>
													{d.badge.text}
												</span>
											</div>
										</div>
							...
							<div className={s.utilityBlock}>
								...
								{config.refunds.map((r) => (
									<div
										key={r.title}
										className="p-3 border rounded mb-2"
										style={{ background: "#fff", borderLeftColor: r.border }}
									>
										<div className="d-flex justify-content-between align-items-center">
											<div>
											...
											<div>
												...
												<span className={cx(s.badge, s[r.badge.tone])}>
													{r.badge.text}
												</span>
											</div>
										</div>
