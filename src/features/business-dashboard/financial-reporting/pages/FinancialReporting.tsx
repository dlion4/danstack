		...
		<div className={s.bizPage}>
			<div className={s.content}>
						...
						<div key={hs.key} className={hs.col}>
							...
							>
								...
								{hs.accentButtons && (
									<div className="d-flex flex-wrap mt-3" style={{ gap: 8 }}>
										{hs.accentButtons.map((ab) => (
											...
											>
												<i className={`bi ${ab.icon}`} /> {ab.label}
											</button>
										))}
									</div>
								)}
								{hs.key === "liquidity" && (
									...
									>
										Consolidated across PayMo Wallet, PesaLink buffers, and
										M-Pesa Tills.
									</p>
								)}
							</div>
						...
						<div className={s.card}>
							<div className="d-flex justify-content-between align-items-center mb-3">
								...
								<button
									className={cx(s.btnPm, s.btnSm)}
									onClick={() =>
										setActiveModal("reconciliationExceptionsModal")
									}
								>
									View all
								</button>
						...
						<div className={s.card}>
							...
							{config.insightItems.map((ii) => (
								<div key={ii.title} className={s.feedItem}>
									...
									<button
										className={cx(s.btnPm, s.btnSm)}
										onClick={() => setActiveModal(ii.modal)}
									>
										{ii.btnLabel}
									</button>
								</div>
				...
				<div className={s.card}>
					...
					>
						<div>
							<h3 className={cx(s.st, "text-accent")}>
								<i
						...
						<div className="d-flex" style={{ gap: 8 }}>
							...
							>
								<i className="bi bi-graph-up" /> Full Forecast
							</button>
							<button
								className={cx(s.btnPm, s.btnSm, s.btnPmP)}
								onClick={() => setActiveModal("plSnapshotModal")}
							>
								<i className="bi bi-file-bar-graph" /> P&L View
							</button>
						</div>
					</div>
					<div className="row g-3">
							...
							>
								...
								<div className="d-flex align-items-center mb-3">
									...
									<div style={{ flex: 1 }}>
										...
										>
											<span>
												<span style={{ color: "var(--pm-primary)" }}>●</span>{" "}
												PayMo Wallet
											</span>
										...
										>
											<span>
												<span style={{ color: "var(--pm-info)" }}>●</span>{" "}
												Equity Bank
											</span>
				...
				<div className={s.card}>
					...
					>
						...
						<div className="d-flex" style={{ gap: 8 }}>
							...
							>
								<i className="bi bi-clock" /> Scheduled
							</button>
							<button
								className={cx(s.btnPm, s.btnSm, s.btnPmP)}
								onClick={() => setActiveModal("generateCustomReportModal")}
								...
								<table className={s.tbl}>
									...
									<tbody>
										{config.reports.map((r) => (
											<tr key={r.name}>
												<td data-label="Report Name">{r.name}</td>
												<td data-label="Type">{r.type}</td>
												<td data-label="Generated By">{r.generatedBy}</td>
												...
												<td data-label="Action">
													...
													>
														{r.modal === "exportTrialBalanceModal"
															? "View"
															: "Download"}
													</button>
												</td>
				...
				<div className={s.card}>
					...
					>
						...
						<div className="d-flex" style={{ gap: 8 }}>
							<button
								className={cx(s.btnPm, s.btnSm)}
								onClick={() => setActiveModal("eTimsReconciliationModal")}
							>
								<i className="bi bi-receipt" /> e-TIMS Check
							</button>
							<button
								className={cx(s.btnPm, s.btnSm)}
								style={{
								...
								onClick={() => setActiveModal("exportKRAVATModal")}
							>
								<i className="bi bi-download" /> KRA Extract
							</button>
						</div>
					</div>
					<div className="row g-3">
							...
							>
								<div className="d-flex justify-content-between align-items-start mb-2">
									...
									<i
										...
										style={{ fontSize: 20, color: "var(--pm-warning)" }}
									/>
								</div>
								<div
									style={{
								...
								<button
									className={cx(s.btnPm, s.btnSm, "w-100 mt-3")}
									onClick={() => setActiveModal("statutoryDeductionsModal")}
								>
						...
						<div className="col-lg-4">
							...
							>
								...
								>
									...
									<span style={{ color: "var(--pm-accent)", fontWeight: 700 }}>
										100% Matched
									</span>
								</div>
								<div
								...
								>
									...
									<span style={{ color: "var(--pm-warning)", fontWeight: 700 }}>
										Due in 45 days
									</span>
								</div>
								<div
								...
								<button
									...
									onClick={() => setActiveModal("taxReadinessModal")}
								>
									Full Health Check
								</button>
							</div>
				...
				<div className={s.card}>
					...
					>
						<div>
							<h3 className={cx(s.st, "text-purple")}>
								<i
						...
						<div className="d-flex" style={{ gap: 8 }}>
							<button
								...
								onClick={() => setActiveModal("inviteAuditorModal")}
							>
								<i className="bi bi-person-plus" /> Invite Auditor
							</button>
							<button
								className={cx(s.btnPm, s.btnSm, s.btnPmP)}
								onClick={() => setActiveModal("viewAuditLogModal")}
							>
								...
								<table className={s.tbl}>
									...
									<tbody>
										{config.auditLogs.map((al) => (
											<tr key={al.timestamp}>
												<td data-label="Timestamp (EAT)">{al.timestamp}</td>
												<td data-label="User / System">{al.user}</td>
												<td data-label="Action">{al.action}</td>
												<td data-label="IP Address">{al.ip}</td>
												<td data-label="Status">
													<span className={cx(s.badge, s[al.statusTone])}>
														{al.status}
													</span>
												</td>
												<td data-label="View">
													<button
														className={cx(s.btnPm, s.btnSm)}
														onClick={() => setActiveModal(al.modal)}
													>
						...
						<div className="col-lg-4">
							...
							>
								...
								<button
									...
									onClick={() => setActiveModal("inviteAuditorModal")}
								>
									<i className="bi bi-plus" /> Grant New Access
								</button>
							</div>
						</div>
					</div>
				...
				<div className={s.card}>
					...
					>
						...
						<div className="d-flex" style={{ gap: 8 }}>
							<button
								className={cx(s.btnPm, s.btnSm)}
								onClick={() => setActiveModal("branchPerformanceModal")}
							>
								<i className="bi bi-shop" /> Branches
							</button>
							<button
								className={cx(s.btnPm, s.btnSm, s.btnPmP)}
								onClick={() => setActiveModal("financialHealthScoreModal")}
							>
								<i className="bi bi-heart-pulse" /> Health Score
							</button>
						</div>
					</div>
					<div className="row g-3">
							...
							>
								<div className="d-flex justify-content-between align-items-center mb-3">
									...
									<button
										className={cx(s.btnPm, s.btnSm)}
										onClick={() =>
											setActiveModal("customerSpendAnalyticsModal")
										}
									>
										Analyze
									</button>
							...
							>
								<div className="d-flex justify-content-between align-items-center mb-3">
									...
									<button
										className={cx(s.btnPm, s.btnSm)}
										onClick={() =>
											setActiveModal("vendorExpenseAnalyticsModal")
										}
									>
										Analyze
									</button>
								...
								{[
									...
									{
										name: "Software & IT Subscriptions",
										amount: "KES 1.8M",
										pct: 10,
										color: "var(--pm-warning)",
									},
