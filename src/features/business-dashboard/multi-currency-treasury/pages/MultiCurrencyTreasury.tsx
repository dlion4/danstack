				...
				<div className="row g-3">
						...
						>
							...
							<div className="d-flex flex-wrap mt-3" style={{ gap: 8 }}>
								...
								<button
									...
									onClick={() => setActiveModal("hedgeModal")}
								>
									Hedge
								</button>
								<button
					...
					<div className="col-lg-2 col-md-4 col-6">
						<div className={s.card} style={{ minHeight: 170 }}>
							...
							<span className={cx(s.badge, s.badgeS)}>
								<i className="bi bi-shield-check" /> 68% hedged
							</span>
							<div
								className="mt-2"
					...
					<div className="col-lg-3 col-md-4 col-6">
						<div className={s.card} style={{ minHeight: 170 }}>
							...
							<span className={cx(s.badge, s.badgeS)}>
								<i className="bi bi-graph-up-arrow" /> +1.8% vs yesterday
							</span>
							<div
								className="mt-2"
								style={{ fontSize: 12, color: "var(--pm-ink-soft)" }}
					...
					<div className="col-lg-3 col-md-4">
						...
						>
							...
							<span className={cx(s.badge, s.badgeW)}>
								<i className="bi bi-exclamation-triangle" /> 1 STR pending
							</span>
							<div
								className="mt-2"
								style={{ fontSize: 12, color: "var(--pm-ink-soft)" }}
					...
					>
						<div>
							<h3 className={s.st}>
								...
								/>{" "}
								3.11.1 — Multi-Currency Accounts & Positions
							</h3>
							<p className={s.ss}>
								View all currency balances, exposure, hedging status, and
								pending settlements.
							</p>
						</div>
						<div className="d-flex" style={{ gap: 8 }}>
							<button
								className={cx(s.btnPm, s.btnSm)}
								onClick={() => setActiveModal("accountModal")}
							>
							...
							<div className={s.utilityBlock}>
								...
								{config.settlements.map((st) => (
									<div key={st.label} className={s.statusRow}>
										...
										<span className={cx(s.badge, s[st.statusTone])}>
											{st.status}
										</span>
									</div>
								))}
					...
					>
						<div>
							<h3 className={s.st}>
								...
								/>{" "}
								3.11.2 — Live FX Rates & Market Intelligence
							</h3>
							<p className={s.ss}>
								Real-time interbank rates, spreads, historical trends,
								volatility alerts and market commentary.
							</p>
						</div>
						<div className="d-flex" style={{ gap: 8 }}>
							<button
								className={cx(s.btnPm, s.btnSm)}
								onClick={() => setActiveModal("rateAlertModal")}
							>
								<i className="bi bi-bell" /> Alerts
							</button>
							<button
								className={cx(s.btnPm, s.btnSm)}
								onClick={() => setActiveModal("marketModal")}
							>
								<i className="bi bi-newspaper" /> Market
							</button>
						</div>
					</div>
					...
					>
						<div>
							<h3 className={s.st}>
								...
								/>{" "}
								3.11.3 — FX Contracts & Hedging
							</h3>
							<p className={s.ss}>
								Manage forward contracts, set hedging strategies, track P&L, and
						...
						<div className="d-flex" style={{ gap: 8 }}>
							<button
								className={cx(s.btnPm, s.btnSm)}
								onClick={() => setActiveModal("rollContractModal")}
							>
								<i className="bi bi-arrow-repeat" /> Roll
							</button>
							<button
								className={cx(s.btnPm, s.btnSm, s.btnPmP)}
								onClick={() => setActiveModal("hedgeModal")}
							>
								<i className="bi bi-shield" /> New Hedge
							</button>
						</div>
					</div>
					<div className="table-responsive">
									...
									<tr key={c.id}>
										...
										<td data-label="Actions">
											<div className="d-flex" style={{ gap: 4 }}>
												<button
													className={cx(s.btnPm, s.btnSm)}
													onClick={() => setActiveModal("fxContractModal")}
												>
													View
												</button>
												<button
					...
					>
						<div>
							<h3 className={s.st}>
								...
								/>{" "}
								3.11.4 — Cross-Border Transfers & Compliance
							</h3>
							<p className={s.ss}>
								Execute multi-currency transfers, track SWIFT payments, and
						...
						<div className="d-flex" style={{ gap: 8 }}>
							...
							>
								<i className="bi bi-file-earmark-text" /> Compliance
							</button>
							<button
								className={cx(s.btnPm, s.btnSm, s.btnPmP)}
								onClick={() => setActiveModal("transferModal")}
							>
								<i className="bi bi-send" /> Transfer
							</button>
						</div>
					</div>
					<div className="row g-3">
