				...
				<div className="row g-3">
					{config.heroStats.map((hs) => (
						<div key={hs.key} className={hs.col}>
							<div
								className={cx(s.card, hs.key === "cash" ? s.cardAccent : "")}
						...
						<div>
							<h3 className={cx(s.st, "text-primary")}>
								<i
									...
									style={{ color: "var(--pm-primary)" }}
								/>{" "}
								3.7.1 — Cash Position & Account Management
							</h3>
							<p className={s.ss}>
								Manage multi-bank positions, balances, and account health.
							</p>
						</div>
						<button
							className={cx(s.btnPm, s.btnSm)}
							onClick={() => setActiveModal("addAccountModal")}
						>
					...
					<div className="d-flex justify-content-between align-items-center mb-3">
						<div>
							<h3 className={cx(s.st, "text-accent")}>
								...
								/>{" "}
								3.7.2 — Fund Transfers & Inter-Account
							</h3>
							<p className={s.ss}>
								Move funds across accounts with maker-checker approval.
							</p>
						</div>
						<button
				...
				<div className={s.card}>
					<div className="d-flex justify-content-between align-items-center mb-3">
						<div>
							...
							<p className={s.ss}>
								Monitor FX positions, book trades, manage cross-border payments.
							</p>
						</div>
						<button
							className={cx(s.btnPm, s.btnSm)}
						...
						>
							<i className="bi bi-currency-exchange" /> Book FX
						</button>
					</div>
					<div className="table-responsive">
						<table className={s.tbl}>
					...
					<div className="d-flex justify-content-between align-items-center mb-3">
						<div>
							<h3 className={cx(s.st, "text-purple")}>
								...
								/>{" "}
								3.7.4 — Investment & MMF Portfolio
							</h3>
							<p className={s.ss}>
						...
						<button
							className={cx(s.btnPm, s.btnSm)}
							onClick={() => setActiveModal("investCashModal")}
						>
							<i className="bi bi-graph-up-arrow" /> Invest
						</button>
					</div>
					<div className="table-responsive">
						<table className={s.tbl}>
