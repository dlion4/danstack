				...
				<div className={s.card}>
					<div className="d-flex justify-content-between align-items-center mb-3">
						<div>
							...
							<p className={s.ss}>
								Manage supplier profiles, categories, and onboarding.
							</p>
						</div>
						<button
							...
							onClick={() => setActiveModal("addSupplierModal")}
						>
							<i className="bi bi-person-plus" /> Add Supplier
						</button>
					</div>
				...
				<div className={s.card}>
					<div className="d-flex justify-content-between align-items-center mb-3">
						<div>
							...
							<p className={s.ss}>
								Upload, review, approve, and schedule supplier invoices.
							</p>
						</div>
						<button
							className={cx(s.btnPm, s.btnSm)}
							onClick={() => setActiveModal("processInvoiceModal")}
						>
							<i className="bi bi-file-earmark-plus" /> Process
						</button>
					</div>
					<div className="table-responsive">
						<table className={s.tbl}>
				...
				<div className={s.card}>
					<div className="d-flex justify-content-between align-items-center mb-3">
						<div>
							...
							<p className={s.ss}>
								Execute approved payments via PesaLink, M-Pesa B2C, or bank
								transfer.
							</p>
						</div>
						<button
							...
							onClick={() => setActiveModal("bulkPaySuppliersModal")}
						>
							<i className="bi bi-people" /> Bulk Pay
						</button>
					</div>
					<div
					...
					>
						<div className="d-flex justify-content-between">
							...
							<strong>3 invoices · KES 165,500</strong>
						</div>
						<div className="d-flex justify-content-between">
							<span>Payment Methods</span>
							<strong>PesaLink, M-Pesa B2C, Bank Transfer</strong>
						</div>
						<div className="d-flex justify-content-between">
							<span>Last Batch Executed</span>
							<strong>22 Jun 2025 · KES 98,000</strong>
						</div>
					</div>
					<div className="d-flex gap-2">
						<button
							...
							onClick={() => setActiveModal("bulkPaySuppliersModal")}
						>
							<i className="bi bi-people" /> Execute Batch
						</button>
						<button
							className={cx(s.btnPm, s.btnSm)}
				...
				<div className={s.card}>
					<div className="d-flex justify-content-between align-items-center mb-3">
						<div>
							...
							<p className={s.ss}>
								Capture early-payment discounts and track supplier terms.
							</p>
						</div>
						<button
							className={cx(s.btnPm, s.btnSm)}
							onClick={() => setActiveModal("discountTrackingModal")}
						>
							<i className="bi bi-percent" /> View All
						</button>
					</div>
					<div className="table-responsive">
						<table className={s.tbl}>
