						...
						>
							...
							<div className="d-flex flex-wrap mt-3" style={{ gap: 8 }}>
								...
								<button
									...
									onClick={() => setActiveModal("bulkFundModal")}
								>
									Bulk Fund
								</button>
							</div>
					...
					<div className="col-lg-3 col-md-4 col-6">
						<div className={s.card} style={{ minHeight: 170 }}>
							...
							<span className={cx(s.badge, s.badgeI)}>
								<i className="bi bi-arrow-left-right" /> 4,812 txns
							</span>
							<div
								className="mt-2"
								style={{ fontSize: 12, color: "var(--pm-ink-soft)" }}
					...
					<div className="col-lg-3 col-md-4">
						...
						>
							...
							<span className={cx(s.badge, s.badgeW)}>
								<i className="bi bi-exclamation-triangle" /> Review needed
							</span>
							<div
								className="mt-2"
								style={{ fontSize: 12, color: "var(--pm-ink-soft)" }}
					...
					>
						<div>
							<h3 className={s.st}>
								...
								/>{" "}
								3.9.1 — Virtual Account Registry
							</h3>
							<p className={s.ss}>
								Manage business virtual accounts, sub-account hierarchy, and
								funding.
							</p>
						</div>
						<div className="d-flex" style={{ gap: 8 }}>
							...
							<button
								...
								onClick={() => setActiveModal("createVA")}
							>
								<i className="bi bi-plus-lg" /> New VA
							</button>
						</div>
					</div>
					<div className="row g-3">
													...
													<td data-label="Actions">
														<div className="d-flex" style={{ gap: 4 }}>
															...
															<button
																className={cx(s.btnPm, s.btnSm)}
																onClick={() =>
																	setActiveModal("healthCheckModal")
																}
															>
										...
										.map((sub) => (
											<div key={sub.id} className={s.hierarchyChild}>
												...
												<span
													className={cx(
														s.badge,
														sub.status === "active" ? s.badgeS : s.badgeW,
													)}
												>
													KES {sub.balance}
													{sub.status === "warning" ? " (over)" : ""}
												</span>
											</div>
										))}
								</div>
					...
					>
						<div>
							<h3 className={s.st}>
								...
								/>{" "}
								3.9.2 — Sub-Account Management
							</h3>
							<p className={s.ss}>
								Create sub-accounts under parent VAs, set spending limits, and
								track budgets.
							</p>
						</div>
						<div className="d-flex" style={{ gap: 8 }}>
							<button
								className={cx(s.btnPm, s.btnSm)}
								onClick={() => setActiveModal("subLimitModal")}
							>
							...
							<button
								...
								onClick={() => setActiveModal("createSub")}
							>
								<i className="bi bi-plus-lg" /> New Sub
							</button>
						</div>
					</div>
					<div className="table-responsive">
					...
					>
						<div>
							<h3 className={s.st}>
								...
								/>{" "}
								3.9.3 — Funding & Internal Transfers
							</h3>
							<p className={s.ss}>
								Fund virtual accounts via M-Pesa, bank transfer, or PayMo
								wallet. Bulk fund via CSV upload.
							</p>
						</div>
						<div className="d-flex" style={{ gap: 8 }}>
							<button
								...
								onClick={() => setActiveModal("fundVA")}
							>
								<i className="bi bi-cash" /> Fund
							</button>
							<button
								className={cx(s.btnPm, s.btnSm, s.btnPmP)}
								onClick={() => setActiveModal("bulkFundModal")}
							>
								<i className="bi bi-upload" /> Bulk Fund
							</button>
						</div>
					</div>
					<div className="row g-3">
					...
					>
						<div>
							<h3 className={s.st}>
								...
								/>{" "}
								3.9.4 — Virtual Account Controls & Limits
							</h3>
							<p className={s.ss}>
						...
						<div className="d-flex" style={{ gap: 8 }}>
							<button
								className={cx(s.btnPm, s.btnSm)}
								onClick={() => setActiveModal("approvalRulesModal")}
							>
								Approval Rules
							</button>
							<button
								className={cx(s.btnPm, s.btnSm)}
								onClick={() => setActiveModal("velocityModal")}
							>
								Velocity Controls
							</button>
						</div>
						...
						<div>
							<h3 className={s.st}>
								<i
									...
									style={{ color: "var(--pm-warning)" }}
								/>{" "}
								3.9.5 — Reconciliation & Reporting
							</h3>
							<p className={s.ss}>
												...
												<tr key={r.va}>
													...
													<td data-label="Action">
														{r.action ? (
															<button
																className={cx(s.btnPm, s.btnSm)}
																onClick={() => setActiveModal("bankErrorModal")}
															>
																{r.action}
															</button>
														) : (
					...
					>
						<div>
							<h3 className={s.st}>
								...
								/>{" "}
								3.9.6 — Virtual Account Settings & Automation
							</h3>
							<p className={s.ss}>
						...
						<div className="d-flex" style={{ gap: 8 }}>
							<button
								className={cx(s.btnPm, s.btnSm)}
								onClick={() => setActiveModal("autoSweepModal")}
							>
								Auto-Sweep
							</button>
							<button
