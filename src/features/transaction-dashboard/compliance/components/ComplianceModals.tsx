				...
				>
					...
					>
						<h5
							...
							style={dangerHeader ? { color: "#fff" } : undefined}
						>
							{title}
						</h5>
						<button
...
const REPORT_SUBJECTS = [
	"AML-44892 — John Kamau Structuring",
	"AML-44885 — Global Trade Ltd",
	"AML-44871 — Hon. Peter Ochieng",
];
const BLOCK_TYPES = [
	"Single Transaction",
	"All Transactions from Originator",
	"All Transactions to Beneficiary",
	"Entire Account / Entity",
];
const TEST_RULES = ["Structuring v4.2", "Velocity-INTL v3.1", "RoundTrip v2.8"];
const TEST_DATASETS = [
	"Last 30 days (47,291 txns)",
	"Last 7 days (12,844 txns)",
	"Custom range",
];
const EXPORT_TYPES = [
	"All active cases",
	"Closed cases (last 90 days)",
	"Full audit log",
];
...
export default function ComplianceModals({
	active,
	onClose,
	onOpen,
}: ModalsProps) {
		...
		<>
				...
				{showFlow("case") && flows.case === 1 && (
					<div className={styles.fstepActive}>
						...
						<div className="mb-3 mt-3">
							...
							<input
								className={styles.fc}
								defaultValue="TXN-992184, TXN-992185, TXN-992186"
							/>
						</div>
					</div>
				)}
				{showFlow("case") && flows.case === 2 && (
					<div className={styles.fstepActive}>
						...
						<div className="mb-3">
							...
							<input
								className={styles.fc}
								defaultValue="John Kamau (ID: 28471920)"
							/>
						</div>
						<div className="mb-3">
							...
							<textarea
								className={styles.fc}
								rows={2}
								defaultValue="Mary Wanjiku (Spouse), TechFlow Solutions Ltd, Global Trade EA"
							/>
						</div>
						<div className="mb-3">
					...
					<div className={styles.fstepActive}>
						...
						<div className="form-check mb-2">
							<input
								...
								id="cAct1"
							/>
							<label className="form-check-label" htmlFor="cAct1">
						...
						<div className="form-check mb-2">
							<input
								...
								id="cAct2"
							/>
							<label className="form-check-label" htmlFor="cAct2">
								Request bank statements (last 90 days)
							</label>
						</div>
						<div className="form-check mb-2">
							<input className="form-check-input" type="checkbox" id="cAct3" />
							<label className="form-check-label" htmlFor="cAct3">
								Submit SAR to CBK within 24h
							</label>
						</div>
						<div className="form-check">
							<input
								...
								id="cAct4"
							/>
							<label className="form-check-label" htmlFor="cAct4">
					...
					<div className={styles.fstepActive}>
						<div className={styles.receipt}>
							...
							<p className={styles.receiptSub}>
								Case AML-44901 has been created and assigned to Sarah M. (Lead
								Investigator).
							</p>
							<div
			...
			<MBox
				...
				footer={actionFooter(
					...
					"Save Changes",
					"btnPmP",
					"Case updated and saved. All changes logged to audit trail.",
					undefined,
					"Close",
				)}
			>
							...
							<div className="row g-3">
								...
								<div className="col-md-6">
									<div className={styles.summaryBoxDanger}>
										...
										>
											John Kamau + 7 linked entities
										</div>
										<div style={{ fontSize: 12, color: "var(--pm-ink-soft)" }}>
											3 accounts frozen • KES 4.2M under review
										</div>
									</div>
								</div>
							</div>
						...
						{tabs.caseD === "timeline" && (
							<>
								{[
									[
										"24 Jun 09:12",
										"Case created by system (Structuring rule triggered)",
									],
									["24 Jun 10:45", "Sarah M. assigned as lead investigator"],
									["24 Jun 14:30", "Account freeze executed on 3 accounts"],
									[
										"25 Jun 11:20",
										"Bank statements received (Equity, KCB, NCBA)",
									],
									[
										"26 Jun 16:05",
										"Evidence uploaded: 47 transaction screenshots",
									],
						...
						{tabs.caseD === "network" && (
							<div className={styles.summaryBox} style={{ fontSize: 13 }}>
								...
								<ul className="mt-2 mb-0">
									<li>
										John Kamau (Primary) → Mary Wanjiku (Spouse) → TechFlow Ltd
										→ Global Trade EA → 4 shell entities
									</li>
								</ul>
							</div>
						)}
							...
							<>
								...
								<div className="form-check mb-2">
									<input
										...
										id="cRep1"
									/>
									<label className="form-check-label" htmlFor="cRep1">
								...
								<div className="form-check mb-2">
									<input
										...
										id="cRep2"
									/>
									<label className="form-check-label" htmlFor="cRep2">
										Attach evidence pack (47 files)
									</label>
								</div>
								<div className="form-check">
									<input
										...
										id="cRep3"
									/>
									<label className="form-check-label" htmlFor="cRep3">
										Request asset freeze order
									</label>
								</div>
							</>
						)}
			...
			<MBox
				...
				footer={actionFooter(
					...
					"Screen Again",
					"btnPmP",
					"Screening completed. 3 matches flagged for review.",
					undefined,
					"Close",
				)}
			>
					...
					<>
						<div className="mb-3">
							...
							<input
								...
								placeholder="Name, ID, Company, Passport"
							/>
						</div>
						<div className="row g-3">
							<div className="col-md-6">
								...
								{[
									...
									<div className={`form-check ${i < 4 ? "mb-1" : ""}`} key={l}>
										<input
											...
											id={`sl${i}`}
										/>
										<label className="form-check-label" htmlFor={`sl${i}`}>
											{l}
										</label>
									</div>
								))}
							...
							<div className="col-md-6">
								...
								<select
									className={styles.fc}
									defaultValue={MATCH_THRESHOLDS[0]}
								>
							...
							{(
								[
									[
										...
										"UN Consolidated List — 98% match",
										"High Risk",
										styles.badgeD,
									],
									[
										"John Kamau (Director, Global Trade Ltd)",
										"OFAC SDN — 94% match",
										"High Risk",
										styles.badgeD,
									],
									[
										"John Kamau (Spouse of PEP)",
										"Local PEP DB — 72% match",
										"Medium Risk",
										styles.badgeW,
									],
								] as const
			...
			<MBox
				...
				footer={actionFooter(
					...
					"Save & Deploy",
					"btnPmP",
					"Rule changes saved and deployed to production.",
					undefined,
					"Close",
				)}
			>
					...
					<>
						<div className={`${styles.pills} mb-3`}>
							{(
								...
								<button
									key={key}
									className={`${styles.pill} ${tabs.rule === key ? styles.pillActive : ""}`}
									onClick={() => sw("rule", key)}
								>
									{label}
								</button>
						...
						{tabs.rule === "create" && (
							<div className="row g-3">
								<div className="col-md-6">
									...
									<input
										className={styles.fc}
										defaultValue="Crypto Exchange Velocity"
									/>
								</div>
								<div className="col-md-6">
									...
									<select
										className={styles.fc}
										defaultValue={RULE_CATEGORIES[0]}
									>
						...
						{tabs.rule === "test" && (
							<div className={styles.summaryBoxInfo} style={{ fontSize: 13 }}>
								...
								<div className="mt-2">
									Rule v4.2 vs v4.3: Precision improved from 21.6% → 28.4%.
			...
			<MBox
				...
				footer={actionFooter(
					...
					"Apply Changes",
					"btnPmP",
					"Risk model weights updated. New scores will apply to future transactions.",
					undefined,
					"Close",
				)}
			>
					...
					<>
						<div className={`${styles.pills} mb-3`}>
							{(
								...
								<button
									key={key}
									className={`${styles.pill} ${tabs.risk === key ? styles.pillActive : ""}`}
									onClick={() => sw("risk", key)}
								>
									{label}
								</button>
						...
						{tabs.risk === "factors" && (
							<div className="mb-3">
								...
								{[
									"High-risk jurisdiction (weight 25)",
									"PEP relationship (weight 20)",
									"Crypto exposure (weight 15)",
									"Adverse media (weight 10)",
								].map((f, i) => (
									<div className={`form-check ${i < 3 ? "mb-1" : ""}`} key={f}>
										<input
											...
											id={`rf${i}`}
										/>
										<label className="form-check-label" htmlFor={`rf${i}`}>
											{f}
										</label>
									</div>
								))}
						...
						{tabs.risk === "model" && (
							<div className={styles.summaryBox}>
								<div style={{ fontSize: 13, fontWeight: 700 }}>
									Explainable AI Model v3.4
								</div>
								<div className={styles.mutedSmall}>
									Last trained: 20 Jun 2025 • Accuracy: 94.2% • Features: 47
								</div>
							</div>
						)}
					</>,
			...
			<MBox
				...
				footer={actionFooter(
					...
					"Submit Report",
					"btnPmP",
					"Report filed successfully. Confirmation received from CBK (Ref: CBK-STR-2025-0612).",
					"CBK-STR-2025-0612",
				)}
			>
				{actionBody(
					...
					<>
						...
						<div className="form-check mb-2">
							<input
								...
								id="rr1"
							/>
							<label className="form-check-label" htmlFor="rr1">
								Include transaction timeline
							</label>
						</div>
						<div className="form-check mb-2">
							<input
								...
								id="rr2"
							/>
							<label className="form-check-label" htmlFor="rr2">
								Attach evidence pack
							</label>
						</div>
						<div className="form-check">
							<input className="form-check-input" type="checkbox" id="rr3" />
							<label className="form-check-label" htmlFor="rr3">
			...
			<MBox
				...
				footer={actionFooter(
					...
					"Upload",
					"btnPmP",
					"Evidence uploaded and hashed. Chain of custody recorded.",
					undefined,
					"Close",
				)}
			>
			...
			<MBox
				...
				footer={actionFooter(
					...
					"Export PDF",
					"btnPmP",
					"Audit trail exported to PDF with digital signature.",
					undefined,
					"Close",
				)}
			>
			...
			>
				...
				<div className="mt-3">
					...
					<textarea
						...
						rows={3}
						defaultValue={
							'Subject appears on UN sanctions list under alias "J. Kamau". Multiple accounts show structuring pattern. Spouse (Mary Wanjiku) also flagged.'
						}
					/>
				</div>
			</MBox>
						...
						>
							<div>
								...
								<div style={{ fontSize: 11, color: "var(--pm-ink-soft)" }}>
									TXN-992184, 992185, 992186 — KES 2.45M in 48h
								</div>
							</div>
							<button
					...
					<div className={`${styles.summaryBoxWarn} mb-2`}>
						...
						>
							<div>
								...
								<div style={{ fontSize: 11, color: "var(--pm-ink-soft)" }}>
									Hon. Peter Ochieng — 340% above average
								</div>
							</div>
							<button
								className={`${styles.btnPm} ${styles.btnSm}`}
								onClick={() => onOpen("pepDetailModal")}
							>
								Review
							</button>
						</div>
					...
					<div className={styles.summaryBoxInfo}>
						...
						>
							<div>
								...
								<div style={{ fontSize: 11, color: "var(--pm-ink-soft)" }}>
									Global Trade Ltd — OFAC SDN hit
								</div>
							</div>
							<button
								className={`${styles.btnPm} ${styles.btnSm}`}
								onClick={() => onOpen("sanctionsSearchModal")}
							>
								Screen
							</button>
						</div>
			...
			<MBox
				...
				footer={actionFooter(
					...
					"Start Screening",
					"btnPmP",
					"Bulk screening started. You will be notified when complete. 47,291 records queued.",
					"BULK-20250627-001",
				)}
			>
				{actionBody(
						...
						<div className="mb-3">
							...
							<div className="form-check mb-1">
								<input
									...
									id="bs1"
								/>
								<label className="form-check-label" htmlFor="bs1">
									UN + OFAC + EU + UK
								</label>
							</div>
							<div className="form-check">
								<input
									...
									id="bs2"
								/>
								<label className="form-check-label" htmlFor="bs2">
									Local PEP Database
								</label>
							</div>
						</div>
						<div className={styles.summaryBoxInfo} style={{ fontSize: 12 }}>
							<i className="bi bi-info-circle me-1" /> Estimated screening time:{" "}
							<strong>12–18 minutes</strong> for 50,000 records.
						</div>
					</>,
				)}
			</MBox>
			...
			<MBox
				...
				footer={actionFooter(
					...
					"Execute Block",
					"btnPmD",
					"Emergency block executed. 14 transactions frozen across 3 accounts. CBK notified.",
					"EMB-20250627-0001",
				)}
			>
				{actionBody(
					...
					<>
						...
						<div className="mb-3">
							...
							<input
								className={styles.fc}
								defaultValue="TXN-992184 or John Kamau (28471920)"
							/>
						</div>
						<div className="mb-3">
							...
							<textarea
								className={styles.fc}
								rows={2}
								defaultValue="Active sanctions hit — immediate block required per CBK directive."
							/>
						</div>
						<div className={styles.summaryBoxDanger} style={{ fontSize: 12 }}>
							<i className="bi bi-shield-x me-1" /> <strong>Warning:</strong>{" "}
							This action is irreversible and will be logged to the audit trail
			...
			<MBox
				...
				footer={actionFooter(
					...
					"Run Test",
					"btnPmP",
					"Rule test completed. Precision: 28.4% (+6.8%). False positives reduced by 31%.",
				)}
			>
				{actionBody(
					"ruleTestModal",
					<>
						...
						<div className={styles.summaryBoxInfo} style={{ fontSize: 12 }}>
							<i className="bi bi-info-circle me-1" /> Estimated runtime:{" "}
							<strong>45 seconds</strong>. Results will show precision, recall,
			...
			<MBox
				...
				footer={actionFooter(
					...
					"Download PDF",
					"btnPmP",
					"Report downloaded with digital signature and chain of custody certificate.",
					undefined,
					"Close",
				)}
			>
				{actionBody(
					...
					<>
						...
						<div className="mb-3">
							...
							<div className={styles.summaryBox} style={{ fontSize: 13 }}>
								Between 12–14 June 2025, John Kamau and linked entities
								conducted 14 transactions totaling KES 2.84M, all structured
								just below the KES 1M reporting threshold. Pattern consistent
								with structuring to evade CTR requirements.
							</div>
						</div>
					</>,
				)}
			...
			>
				{(
					[
						[
							"28 Jun 2025",
							"STR Draft #AML-44892 (Due in 18h)",
							"Critical",
							styles.badgeD,
						],
			...
			<MBox
				...
				footer={actionFooter(
					...
					"Save Settings",
					"btnPmP",
					"Monitoring settings saved. Changes effective immediately.",
				)}
			>
				{actionBody(
					"monitorSettingsModal",
					<>
						<div className="form-check form-switch mb-3">
							<input
								...
								id="ms1"
							/>
							<label className="form-check-label" htmlFor="ms1">
						...
						<div className="form-check form-switch mb-2">
							<input
								...
								id="ms2"
							/>
							<label className="form-check-label" htmlFor="ms2">
								Auto-notify CBK on critical alerts
							</label>
						</div>
						<div className="form-check form-switch">
							<input className="form-check-input" type="checkbox" id="ms3" />
							<label className="form-check-label" htmlFor="ms3">
								Enable AI-assisted triage
							</label>
						</div>
					</>,
				)}
			...
			>
				{(
					[
						[
							"Structuring — John Kamau network",
							"AML-44892 • Due in 18h",
							"Open",
							"caseDetailModal",
							true,
						],
						[
							"Sanctions match — Global Trade Ltd",
							"AML-44885 • Escalated",
							"Open",
							"caseDetailModal",
							false,
			...
			>
				...
				<div className={styles.summaryBox} style={{ fontSize: 13 }}>
					<strong>System Status:</strong> All 12 payment rails connected.
					Sanctions lists last updated 27 Jun 06:00. AI model v3.4 running
					normally.
				</div>
			</MBox>
			...
			<MBox
				...
				footer={actionFooter(
					...
					"Export",
					"btnPmP",
					"Export generated and downloading...",
				)}
			>
				{actionBody(
					"caseExportModal",
			...
			>
				<div className={styles.summaryBoxAccent}>
					<div
						style={{ fontSize: 13, fontWeight: 700, color: "var(--pm-accent)" }}
					>
						Structuring v4.2 Test Complete
					</div>
					<div className="mt-2">
						Precision: <strong>28.4%</strong> (+6.8%)
						<br />
