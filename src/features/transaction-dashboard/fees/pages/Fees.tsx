...
const initialMockData: FeesConfig = {
	nav: [
		...
		{ icon: "bi-bank", to: "/banking", label: "Banking" },
		{
			icon: "bi-percent",
			to: "/fees",
			label: "Fee & Commission Management",
			active: true,
			dot: true,
		},
	...
	headerSub:
		"Fee structures, commission tiers, waivers, settlement reconciliation and compliance",
	searchPlaceholder:
		"Search fee rules, commission tiers, transactions, waivers...",
	user: {
		initials: "JK",
		name: "James K.",
	...
	hero: {
		...
		detail:
			"This month across 142,890 transactions. 47 active fee rules, 12 commission tiers, 8 active waivers.",
		actions: [
	...
	topAgents: [
		{
			name: "Agent #AG-8821",
			sub: "KES 48.2M volume",
			badge: "Elite",
			tone: "badgeS",
		},
		{
			name: "Agent #AG-7744",
			sub: "KES 39.8M volume",
			badge: "Elite",
			tone: "badgeS",
		},
		{
			name: "Agent #AG-9910",
			sub: "KES 31.4M volume",
			badge: "Pro",
			tone: "badgeP",
		},
		{
			name: "Agent #AG-3342",
			sub: "KES 27.9M volume",
			badge: "Pro",
			tone: "badgeP",
		},
	],
	...
	waiverBudget: [
		{
			label: "SME First Transfer",
			pct: "78%",
			width: "78%",
			color: "var(--pm-accent)",
		},
		{
			label: "Hardship Relief",
			pct: "54%",
			width: "54%",
			color: "var(--pm-warning)",
		},
	...
	auditLogs: [
		{
			date: "26 Jun",
			action: "Fee rule updated",
			user: "James K.",
			details: "FR-415 rate changed to 0.5%",
			result: "Approved",
			tone: "badgeS",
		},
		{
			...
			user: "Grace M.",
			details: "WV-115 — Flood Relief 100%",
			result: "Approved",
			tone: "badgeS",
		},
		{
			date: "24 Jun",
			action: "Commission tier edited",
			user: "James K.",
			details: "T3 threshold updated",
			result: "Approved",
			tone: "badgeS",
		},
		{
		...
		<div className={styles.feesPage}>
			...
			{error && !errorDismissed && (
				<div
					...
					role="alert"
				>
					<strong>Could not load fee data.</strong> Showing the built-in
					defaults.{" "}
			...
			<div className={styles.main}>
				...
				<div className={styles.pageBar}>
					...
					<div className="d-flex flex-wrap" style={{ gap: 8 }}>
						...
						<button
							className={styles.btnPm}
							onClick={() => openM("feeCalculatorModal")}
						>
							...
							<div className={`${styles.card} h-100`}>
								<div className="mb-3">
									...
									<p className={styles.ss}>
										Frequent fee &amp; commission workflows
									</p>
								</div>
					...
					<div className={styles.card}>
						...
						>
							<div>
								...
								<p className={styles.ss}>
									Overview of all active fee rules, revenue collected, and
					...
					<div className={styles.card}>
						...
						>
							<div>
								...
								<p className={styles.ss}>
									Tiered commission structures for agents, partners and
									merchants with performance tracking.
								</p>
							</div>
							<div className="d-flex" style={{ gap: 8 }}>
								<button
												...
												{config.tiers.map((t) => (
													<tr key={t.tier}>
														...
														<td>
															<button
																className={`${styles.btnPm} ${styles.btnSm}`}
																onClick={() => openM("editCommissionModal")}
															>
																Edit
															</button>
														</td>
					...
					<div className={styles.card}>
						...
						>
							<div>
								...
								<p className={styles.ss}>
									Interactive fee calculator with live preview for different
											...
											<tbody>
												{config.feeCompare.map((p) => (
													<tr key={p.provider}>
														...
														<td>
															{p.strong ? <strong>{p.fee}</strong> : p.fee}
														</td>
														<td>{p.time}</td>
														<td>
															<span
																className={`${styles.badge} ${styles[p.tone]}`}
															>
																{p.rating}
															</span>
														</td>
							...
							<div>
								<h3 className={styles.st}>
									<i
										...
										style={{ color: "var(--pm-accent)" }}
									/>{" "}
									1.15.4 — Transaction Fee Reports &amp; Analytics
								</h3>
								<p className={styles.ss}>
									Detailed fee revenue analytics, trends, and performance by
									channel, product and partner.
								</p>
							</div>
							<div className="d-flex" style={{ gap: 8 }}>
								<button
						...
						>
							<div>
								<h3 className={styles.st}>
									...
									/>{" "}
									1.15.5 — Fee Exemptions, Waivers &amp; Promotions
								</h3>
								<p className={styles.ss}>
									Manage promotional waivers, hardship cases, regulatory
									exemptions and partner discounts.
								</p>
							</div>
							<div className="d-flex" style={{ gap: 8 }}>
								<button
					...
					<div className={styles.card}>
						...
						>
							<div>
								...
								<p className={styles.ss}>
									Run fee settlements, reconcile partner payouts and manage
											...
											<tbody>
												{config.recentSettlements.map((s) => (
													<tr key={`${s.date}-${s.type}`}>
														...
														<td>
															<span
																className={`${styles.badge} ${styles[s.tone]}`}
															>
																{s.status}
															</span>
														</td>
					...
					<div className={styles.card}>
						...
						>
							<div>
								...
								<p className={styles.ss}>
									Regulatory compliance checks, audit trails, fee configuration
											...
											<tbody>
												{config.auditLogs.map((a) => (
													<tr key={`${a.date}-${a.action}`}>
														...
														<td>
															<span
																className={`${styles.badge} ${styles[a.tone]}`}
															>
																{a.result}
															</span>
														</td>
