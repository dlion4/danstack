							...
							<div className={cx("col-lg-6", s.reveal)}>
								...
								<div className={s.orbitShell}>
									...
									<div className={s.orbitCenter}>
										...
										<p className={cx(s.textMutedPaymo, "mb-0 px-4 small")}>
											Every use case orbiting one financial core.
										</p>
									</div>
						...
						<div className="col-lg-5">
							<div className="d-flex align-items-center gap-3 mb-2">
								...
								<div>
									...
									<div className={cx(s.brandSub, "small text-uppercase")}>
										BAAS Rails
									</div>
								</div>
							</div>
							<div className={cx(s.textMutedPaymo, "small")}>
								© {new Date().getFullYear()} Paymo BAAS. Engineered with an
								emerald glass design system.
							</div>
						</div>
						<div className="col-lg-7">
