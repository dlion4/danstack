...
export default function AccountSettingsModals({
	active,
	onClose,
	onOpen,
	config,
	...
	const renderCardNaming = () => (
		...
		>
			<p
				style={{ fontSize: 13, color: "var(--pm-ink-soft)", marginBottom: 16 }}
			>
				Rename cards, assign colour codes, and reorder quick-access items.
			</p>
			{config.sections.preferences.cards.map((c) => (
			...
			<div className="row g-3">
				...
				<div className="col-md-6">
					<div className={styles.ub}>
						...
						<h5 style={{ fontSize: 13, fontWeight: 700, margin: "0 0 8px" }}>
							Delivery Channels
						</h5>
		...
		>
			...
			>
				...
				<div className={styles.cwRow}>
					<div>
						<div className={styles.cwLabel}>Cardholder</div>AMINA KAMAU
					</div>
					<div>
	...
	const modalTitles: Record<string, string> = {
		...
		defaultCardsModal: "Default Card Assignments",
		cardNamingModal: "Organise Card Portfolio",
		notifSettingsModal: "Notification Settings",
		revealPanModal: "Reveal Card Details",
		cardControlsModal: "Card Controls",
	};
