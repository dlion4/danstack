...
async function fetchVirtualCreditCards(): Promise<VirtualCreditCardsConfig> {
	...
	try {
		const res = await fetch("/api/virtual-credit-cards", {
				...
				<div className={styles.pageBar}>
					<div>
						<div className={styles.breadcrumb}>
							<Link to="/">Home</Link> / <Link to="/cards">Card Center</Link> /{" "}
							<Link to="/cards/virtual">Virtual Cards</Link> /{" "}
						...
						<p className={styles.pageSub}>
							Create instant virtual cards for secure online purchases. Allocate
							credit limits, set expiry rules, and isolate subscription billing.
						</p>
					</div>
					<div className="d-flex flex-wrap" style={{ gap: 8 }}>
						...
						>
							<i className="bi bi-shield-lock" /> Security Check
						</button>
						<button
							className={styles.btnPm}
							onClick={() => setActiveModal("payCreditBillModal")}
						>
							<i className="bi bi-cash-stack" /> Pay Balance
						</button>
						<button
					...
					<div className="row g-3">
						<div className="col-lg-4">
							...
							>
								...
								>
									Total credit limit shared across your active virtual cards.
								</p>
								<div className="d-flex flex-wrap mt-3" style={{ gap: 8 }}>
									<button
										...
										onClick={() => setActiveModal("limitAllocationModal")}
									>
										Allocate Limit
									</button>
									<button
									...
									<button
										...
										onClick={() => setActiveModal("limitIncreaseModal")}
									>
										Request Increase
									</button>
								</div>
						...
						<div className="col-lg-2 col-md-4 col-6">
							<div className={styles.card} style={{ minHeight: 170 }}>
								...
								<span className={`${styles.badge} ${styles.badgeW}`}>
									<i className="bi bi-calendar" /> Due in 12 days
								</span>
						...
						<div className="col-lg-3 col-md-4 col-6">
							<div className={styles.card} style={{ minHeight: 170 }}>
								...
								<span className={`${styles.badge} ${styles.badgeS}`}>
									<i className="bi bi-shield-check" /> 100% Tokenized
								</span>
								<div className="mt-2">
									<div
									...
									<div className={styles.progress} mt-1>
										<div
											...
											style={{ width: "28%", background: "var(--pm-info)" }}
										/>
									</div>
								</div>
							</div>
						...
						<div className="col-lg-3 col-md-4">
							...
							>
								...
								<span className={`${styles.badge} ${styles.badgeS}`}>
									<i className="bi bi-arrow-repeat" /> 7 active merchants
								</span>
								<div
									className="mt-2"
								...
								>
									<div>
										Highest: <strong>AWS Cloud (KES 2,400)</strong>
									</div>
									<div>
										Upcoming: <strong>Netflix (KES 1,200)</strong>
									</div>
								</div>
							</div>
						</div>
						...
						<div className="col-lg-4">
							<div className={styles.card}>
								...
								<div className={styles.feedItem}>
									...
									<div style={{ flex: 1 }}>
										<div style={{ fontWeight: 600, fontSize: 13 }}>
											Single-use card compromised
										</div>
										<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
											Blocked attempt at unauthorized merchant
										</div>
									</div>
									<button
										className={`${styles.btnPm} ${styles.btnSm} ${styles.btnPmD}`}
										onClick={() => setActiveModal("fraudAlertModal")}
									>
										Review
									</button>
								</div>
								...
								<div className={styles.feedItem}>
									...
									<div style={{ flex: 1 }}>
										<div style={{ fontWeight: 600, fontSize: 13 }}>
											Virtual card expiring soon
										</div>
										<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
											&apos;AWS Hosting&apos; card expires in 5 days
										</div>
									</div>
									<button
										className={`${styles.btnPm} ${styles.btnSm}`}
										onClick={() => setActiveModal("cardExpiryModal")}
									>
										Renew
									</button>
								</div>
						...
						<div className="col-lg-4">
							<div className={styles.card}>
								...
								<div className={styles.feedItem}>
									...
									<div style={{ flex: 1 }}>
										<div style={{ fontWeight: 600, fontSize: 13 }}>
											Set up auto-pay for credit balance
										</div>
										<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
											Avoid late fees of KES 500
										</div>
									</div>
									<button
										className={`${styles.btnPm} ${styles.btnSm}`}
										onClick={() => setActiveModal("autoPayModal")}
									>
										Setup
									</button>
								</div>
								<div className={styles.feedItem}>
									...
									<div style={{ flex: 1 }}>
										<div style={{ fontWeight: 600, fontSize: 13 }}>
											Isolate online subscriptions
										</div>
										<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
											Move Netflix & Spotify to a dedicated card
										</div>
									</div>
									<button
										className={`${styles.btnPm} ${styles.btnSm}`}
								...
								<div className={styles.feedItem}>
									...
									<div style={{ flex: 1 }}>
										...
										<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
											&apos;Adobe CC&apos; hasn&apos;t been accessed in 3 months
										</div>
									</div>
									<button
										className={`${styles.btnPm} ${styles.btnSm}`}
										onClick={() => setActiveModal("subscriptionManageModal")}
									>
										Review
									</button>
								</div>
							...
							<div className={styles.card}>
								<div className="mb-3">
									...
									<p className={styles.sectionSub}>
										Frequent card and credit operations
									</p>
								</div>
								<div className={styles.quickGrid}>
									<button
										...
										onClick={() => setActiveModal("createCardModal")}
									>
										<i className="bi bi-plus-circle text-primary me-1" /> New
										V-Card
									</button>
									<button
										className={styles.quickBtn}
										onClick={() => setActiveModal("payCreditBillModal")}
									>
										<i className="bi bi-cash-stack text-success me-1" /> Pay
										Balance
									</button>
									<button
										className={styles.quickBtn}
										onClick={() => setActiveModal("limitAllocationModal")}
									>
										<i className="bi bi-sliders text-warning me-1" /> Adjust
										Limits
									</button>
									<button
										className={styles.quickBtn}
									...
									<button
										className={styles.quickBtn}
										onClick={() => setActiveModal("generateCVVModal")}
									>
										<i className="bi bi-arrow-clockwise text-danger me-1" />{" "}
										Rotate CVV
									</button>
									<button
										className={styles.quickBtn}
										onClick={() => setActiveModal("transactionHistoryModal")}
									>
										<i
											className="bi bi-list-columns me-1"
									...
									<button
										className={styles.quickBtn}
										onClick={() => setActiveModal("disputeTransactionModal")}
									>
										<i
							...
							<div>
								<h3 className={styles.sectionTitle}>
									<i
										...
										style={{ color: "var(--pm-primary)" }}
									/>{" "}
									5.4.1 — Virtual Card Issuance & Lifecycle
								</h3>
								<p className={styles.sectionSub}>
									Manage your active virtual cards, reveal details, rotate CVVs,
									or generate single-use cards for secure checkouts.
								</p>
							</div>
							<div className="d-flex" style={{ gap: 8 }}>
								<button
									className={`${styles.btnPm} ${styles.btnSm}`}
									onClick={() => setActiveModal("deletedCardsModal")}
								>
								...
								<button
									...
									onClick={() => setActiveModal("createCardModal")}
								>
									<i className="bi bi-plus-lg" /> Create Card
								</button>
							</div>
						</div>
						<div className={styles.vcardGrid}>
							{config.activeCards.map((card) => (
								<div key={card.alias} className={styles.vcardWrapper}>
									<div className="d-flex justify-content-between align-items-center mb-3">
										<div className={styles.vcardBrand}>
											{card.alias}
											<span
												className={`${styles.badge} ${styles.badgeS} ms-2`}
												style={{ fontSize: 11 }}
											>
												{card.type}
											</span>
										...
										<button
											className={`${styles.btnPm} ${styles.btnSm}`}
											onClick={() => setActiveModal("manageCardModal")}
										>
									...
									>
										<span>Spend</span>
										<span>Limit: KES {card.limit}</span>
									</div>
									<div className={styles.progress}>
										<div
											className={styles.progressBarFill}
											style={{
												width: `${getUtilization(card.spent, card.limit)}%`,
									...
									<div>
										<h3 className={styles.sectionTitle}>
											<i
												...
												style={{ color: "var(--pm-accent)" }}
											/>{" "}
											5.4.2 — Credit Limit & Repayment Desk
										</h3>
										<p className={styles.sectionSub}>
											Monitor your credit line utilization, distribute limits
											among cards, and execute repayments.
										</p>
									</div>
									<div className="d-flex" style={{ gap: 8 }}>
										<button
											...
											onClick={() => setActiveModal("autoPayModal")}
										>
											<i className="bi bi-arrow-repeat" /> Auto-Pay
										</button>
										<button
											className={`${styles.btnPm} ${styles.btnSm} ${styles.btnPmP}`}
											onClick={() => setActiveModal("payCreditBillModal")}
										>
											<i className="bi bi-cash-stack" /> Repay Balance
										</button>
									</div>
								</div>
								<div className="row g-3">
									<div className="col-lg-8">
										<div className={styles.ub}>
											...
											>
												Total allocated cannot exceed KES 150,000. Changes apply
												instantly.
											</p>
										</div>
									</div>
									<div className="col-lg-4">
										<div className={styles.ub} mb-3>
											...
											<div className={styles.statusRow}>
												<div>
													<strong>Purchases & Advances</strong>
												</div>
											...
											<div className="d-flex mt-3" style={{ gap: 8 }}>
												<button
													className={`${styles.btnPm} ${styles.btnSm} ${styles.btnPmP} w-100`}
													onClick={() => setActiveModal("payCreditBillModal")}
												>
													Pay Now
												</button>
										...
										<tbody>
											{config.transactions.map((tx, i) => (
												<tr key={i}>
													...
													<td>
														<span
															className={`${styles.badge} ${tx.status === "Success" ? styles.badgeS : tx.status === "Pending" ? styles.badgeW : styles.badgeD}`}
														>
															{tx.status}
														</span>
													</td>
							...
							<div>
								<h3 className={styles.sectionTitle}>
									<i
										...
										style={{ color: "var(--pm-purple)" }}
									/>{" "}
									5.4.3 — Subscription & Merchant Management
								</h3>
								<p className={styles.sectionSub}>
									Identify recurring charges, monitor merchant locks, and cancel
									unwanted subscriptions with one click.
								</p>
							</div>
							<div className="d-flex" style={{ gap: 8 }}>
								<button
									className={`${styles.btnPm} ${styles.btnSm}`}
									onClick={() => setActiveModal("merchantAnalyticsModal")}
								>
								...
								<button
									...
									onClick={() => setActiveModal("subscriptionManageModal")}
								>
									<i className="bi bi-list-check" /> Manage All
								</button>
							</div>
						</div>
						<div className="row g-3">
