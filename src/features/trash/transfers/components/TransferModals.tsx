...
function FlowModal({
	...
	return (
		<div className={s.modalOverlay} onClick={onClose}>
			<div
				className={cx(s.modalWrapper, "modal-lg")}
...
function SimpleModal({
	...
	return (
		<div className={s.modalOverlay} onClick={onClose}>
			<div
				className={cx(s.modalWrapper, sizeCls)}
				onClick={(e) => e.stopPropagation()}
			>
				<div className={cx(s.modalContent, s.modalAnimated)}>
					<div className={s.modalHeader}>
							...
							<>
								...
								{submitLabel && (
									<button
										...
										className={cx(
											s.btn,
											submitPrimary ? s.btnPrimary : s.btnSecondary,
										)}
		...
		<>
					...
					<>
						{step === 1 && (
							<>
								...
								<div>
									...
									<SegmentedTabs
										options={["M-Pesa", "Bank", "Internal", "International"]}
										defaultActive="M-Pesa"
									/>
								</div>
							</>
						)}
							...
							<>
								<div className="row g-3">
									<div className="col-md-6">
										...
										<input className={s.field} defaultValue="12500" />
									</div>
									<div className="col-md-6">
										<label className={s.fieldLabel}>Reference / Note</label>
										<input className={s.field} defaultValue="Rent June 2025" />
									</div>
								</div>
								<div className="mt-3">
						...
						{step === 3 && (
							<>
								...
								<label className={cx(s.fieldLabel, "mt-3 d-block")}>
									Enter PIN
								</label>
				...
				{(step) => (
					<>
						{step === 1 && (
							<>
								<div className="mb-3">
									<label className={s.fieldLabel}>Upload CSV</label>
									<input type="file" className={s.field} />
								</div>
								<div className={cx(s.hintBox, "mt-2")}>
							...
							<>
								...
								<div className="row g-3">
									<div className="col-md-6">
										...
										<input className={s.field} defaultValue="45000" />
									</div>
									<div className="col-md-6">
						...
						{step === 2 && (
							<>
								<div className="row g-3">
									...
									<div className="col-md-6">
										<label className={s.fieldLabel}>End Date (optional)</label>
										<input type="date" className={s.field} />
									</div>
								</div>
								<div className="mt-3">
									<label className={s.fieldLabel}>Funding Source</label>
							...
							<>
								<div className={s.rowItem}>
									...
									<button
										...
										onClick={() => openModal("editBeneficiary")}
									>
			...
			>
				<div className="mb-3">
					...
					<input className={s.field} defaultValue="Mary Wanjiku" />
				</div>
				<div className="mb-3">
					<label className={s.fieldLabel}>Phone / Account</label>
					<input className={s.field} defaultValue="0733 222 111" />
				</div>
				<div className="mb-3">
			...
			>
				...
				<div className="d-flex justify-content-center" style={{ gap: 8 }}>
					<button className={cx(s.btn, s.btnSm)}>
			...
			>
				...
				<div className="form-check form-switch mb-2">
					<input
						...
						id="schedActive"
					/>
					<label className="form-check-label" htmlFor="schedActive">
						Active
					</label>
				</div>
				<div className="form-check form-switch">
					<input
						...
						id="schedNotify"
					/>
					<label className="form-check-label" htmlFor="schedNotify">
					...
					<>
						{step === 1 && (
							<>
								...
								<div className="mb-3">
									<label className={s.fieldLabel}>Recipient Name</label>
									<input className={s.field} defaultValue="John Smith" />
								</div>
								<div className="mb-3">
									<label className={s.fieldLabel}>Account / IBAN</label>
									<input
										className={s.field}
						...
						{step === 2 && (
							<>
								<div className="row g-3">
									<div className="col-md-6">
										<label className={s.fieldLabel}>Amount (KES)</label>
										<input className={s.field} defaultValue="150000" />
									</div>
									<div className="col-md-6">
								...
								<div className={cx(s.hintBox, s.hintBoxWarn, "mt-3")}>
									<i className="bi bi-info-circle me-1" /> Estimated fee: KES
									2,850 | Exchange rate: 1 KES = 0.0058 GBP
								</div>
							</>
						)}
						{step === 3 && (
							<>
								<div className="mb-3">
									<label className={s.fieldLabel}>Purpose of Transfer</label>
									<select className={s.field}>
								...
								<div className="mb-3">
									<label className={s.fieldLabel}>Source of Funds</label>
									<select className={s.field}>
			...
			>
				<div className="text-center">
					...
					<div className="mb-3">
						...
						<input className={s.field} defaultValue="Lunch payment" />
					</div>
				</div>
			</SimpleModal>
			...
			>
				<div className="mb-3">
					<label className={s.fieldLabel}>Daily Limit</label>
					<input className={s.field} defaultValue="500000" />
				</div>
				<div className="mb-3">
					<label className={s.fieldLabel}>Per Transaction Limit</label>
					<input className={s.field} defaultValue="200000" />
				</div>
				<div className="mb-3">
					<label className={s.fieldLabel}>International Limit</label>
					<input className={s.field} defaultValue="100000" />
				</div>
				<div className="form-check form-switch mb-2">
					<input
						className="form-check-input"
						...
						id="pinReq"
					/>
					<label className="form-check-label" htmlFor="pinReq">
				...
				<div className="form-check form-switch">
					<input
						...
						id="twofaReq"
					/>
					<label className="form-check-label" htmlFor="twofaReq">
			...
			>
				...
				<div className="mb-3">
					<label className={s.fieldLabel}>New Funding Source</label>
					<select className={s.field}>
						<option>PayMo Wallet (KES 24,500)</option>
						<option>Equity Bank ****4521</option>
					</select>
							...
							<div className={s.chartBars} style={{ height: 120 }}>
								{[60, 75, 90, 82, 100, 95].map((h, i) => (
									<div
										...
										style={{
											height: `${h}%`,
											background: i === 4 ? "var(--pri)" : "var(--info)",
										}}
									>
			...
			>
				<div className="row g-3">
					<div className="col-md-4">
						...
						>
							<div
								style={{ fontSize: 28, fontWeight: 800, color: "var(--pri)" }}
							>
								96
							</div>
							<div
								style={{ fontSize: 10, fontWeight: 700, color: "var(--pri)" }}
							>
								SECURITY SCORE
							</div>
						</div>
					...
					<div className="col-md-4">
						...
						>
							<div
								style={{ fontSize: 24, fontWeight: 700, color: "var(--sec)" }}
							>
								2FA
							</div>
							<div
								style={{ fontSize: 10, fontWeight: 700, color: "var(--sec)" }}
							>
								ENABLED
							</div>
						</div>
					...
					<div className="row g-2 text-start mt-3" style={{ fontSize: 13 }}>
						...
						<div className="col-6">
							...
							>
								...
								<br />
								<strong style={{ color: "var(--pri)" }}>96/100</strong>
							</div>
						</div>
					</div>
				</div>
			...
			>
				<>
					...
					<div className={s.rowItem}>
						...
						<button
							className={cx(s.btn, s.btnSm)}
							onClick={() => openModal("manageBeneficiaries")}
						>
							Update
						</button>
					</div>
			...
			>
				<div className="mb-3">
					<label className={s.fieldLabel}>Issue Type</label>
					<select className={s.field}>
			...
			>
				<div className="mb-3">
					<label className={s.fieldLabel}>Name</label>
					<input className={s.field} defaultValue="Grace Kamau" />
				</div>
				<div className="mb-3">
					<label className={s.fieldLabel}>Phone / Account</label>
					<input className={s.field} defaultValue="0712 345 890" />
				</div>
				<div className="form-check">
					<input
						className="form-check-input"
			...
			>
				<div className="mb-3">
					<label className={s.fieldLabel}>Amount (KES)</label>
					<input className={s.field} defaultValue="50000" />
				</div>
				<div className="mb-3">
				...
				<div className="p-3 rounded" style={{ background: "var(--ink-100)" }}>
			...
			>
				<>
					<div className="d-flex gap-2 mb-3 flex-wrap">
						<select className={s.field} style={{ width: "auto" }}>
			...
			>
				<div className="mb-3">
					<label className={s.fieldLabel}>Amount (KES)</label>
					<input className={s.field} defaultValue="5000" />
				</div>
				<div className="mb-3">
					<label className={s.fieldLabel}>Note</label>
					<input className={s.field} defaultValue="Quick payment" />
				</div>
			</SimpleModal>
			...
			>
				<div className="mb-3">
					<label className={s.fieldLabel}>Nickname</label>
					<input className={s.field} defaultValue="My Landlord" />
				</div>
				<div className="form-check">
					<input
						className="form-check-input"
		...
		<div className={s.pills}>
			{options.map((opt) => (
				<button
					key={opt}
					type="button"
					className={cx(s.pill, active === opt && s.pillActive)}
