...
export type AsideKind = "autoPay" | "payBill" | "savedAccounts" | "securityTab" | "apiKeysTab";
        ...
        notifications: [
                {
                        ...
                        desc: "KPLC Token: 4729-8301-2284-1190",
                        time: "2m",
                        unread: true,
                },
                {
                        ...
                        desc: "NCWSC account overdue by 3 days.",
                        time: "1h",
                        unread: true,
                },
                {
                        ...
                        tone: "success",
                        title: "Auto-pay succeeded",
                        desc: "Safaricom Fiber — KES 5,999",
                        time: "5h",
                        unread: true,
                },
        ],
...
export async function fetchUtilityLayoutContent(): Promise<UtilityLayoutContent> {
        ...
        try {
                ...
                if (!response.ok)
                        throw new Error(`Utility layout API responded HTTP ${response.status}`);
