...
export default function UtilityAside({
	activePanel,
	savedAccounts,
	onClose,
	onToast,
			...
			>
				...
				<div
					className={cx(
						...
						activePanel === "autoPay" && s.active,
					)}
				>
					<div className={s["aside-header"]}>
						<span className={s["aside-title"]}>
							<i className="bi bi-calendar-check text-primary" /> Auto-Pay
							Manager
						</span>
						<button
							type="button"
							...
							<div className="d-flex justify-content-between align-items-center mb-2">
								...
								<div className="form-check form-switch m-0">
									<input
										...
										type="checkbox"
										defaultChecked
										aria-label="Toggle KPLC auto-pay"
									/>
								</div>
							</div>
							<div className="d-flex justify-content-between align-items-center mb-2">
								...
								<div className="form-check form-switch m-0">
									<input
										...
										type="checkbox"
										defaultChecked
										aria-label="Toggle Safaricom auto-pay"
									/>
								</div>
							</div>
							<div className="d-flex justify-content-between align-items-center">
								...
								<div className="form-check form-switch m-0">
									<input
										...
										type="checkbox"
										defaultChecked
										aria-label="Toggle DSTV auto-pay"
									/>
								</div>
							</div>
						</div>
						...
						<div className={s["aside-card"]}>
							...
							<div className="form-check mb-3">
								<input
									className="form-check-input"
									type="checkbox"
									id="utility-enable-autopay"
								/>
								<label
									className="form-check-label"
									style={{ fontSize: "0.82rem" }}
									htmlFor="utility-enable-autopay"
								>
				...
				<div
					className={cx(
						s["aside-panel-content"],
						activePanel === "savedAccounts" && s.active,
					)}
				>
					<div className={s["aside-header"]}>
						<span className={s["aside-title"]}>
					...
					<div className={s["aside-body"]}>
						{savedAccounts.map((acc) => (
							<div
								className={s["aside-card"]}
								key={`${acc.provider}-${acc.number}`}
							>
