/* ============================================================================
 * UtilityToasts.tsx — toast stack for the Paymo BAAS Utility Layout.
 * ----------------------------------------------------------------------------
...
interface UtilityToastsProps {
  toasts: UtilityToastRecord[];
  onDismiss: (id: number) => void;
}

export default function UtilityToasts({ toasts, onDismiss }: UtilityToastsProps) {
