/* ============================================================================
 * UtilityRightDrawer.tsx — right-side slide-in drawer for Developers & Security.
 * ---------------------------------------------------------------------------
...
interface UtilityRightDrawerProps {
...
export default function UtilityRightDrawer({
	activePanel,
	onClose,
	onToast,
}: UtilityRightDrawerProps) {
		...
		<>
			...
			>
				...
				<div className={s["right-drawer-tabs"]}>
					<button
						type="button"
						className={cx(s["right-drawer-tab"], activeTab === "security" && s["tab-active"])}
					...
					<button
						type="button"
						className={cx(s["right-drawer-tab"], activeTab === "apiKeys" && s["tab-active"])}
				...
				<div className={s["right-drawer-body"]}>
					{/* ============ SECURITY TAB ============ */}
					<div className={cx(s["right-drawer-panel"], activeTab === "security" && s["panel-visible"])}>
						{/* Session Info */}
					...
					{/* ============ API KEYS TAB ============ */}
					<div className={cx(s["right-drawer-panel"], activeTab === "apiKeys" && s["panel-visible"])}>
						<div className={s["right-drawer-card"]}>
