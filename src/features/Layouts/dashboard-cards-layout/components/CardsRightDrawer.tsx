/* ============================================================================
 * CardsRightDrawer.tsx — right-side slide-in drawer for Security & API Keys.
 * ---------------------------------------------------------------------------
...
interface CardsRightDrawerProps {
...
export default function CardsRightDrawer({
        activePanel,
        onClose,
        onToast,
}: CardsRightDrawerProps) {
        ...
        return (
                <>
                        {/* Backdrop */}
                        <div
                                className={cx(s.rightDrawerBackdrop, isOpen && s.show)}
                                aria-hidden="true"
                                onClick={onClose}
                        />
                        ...
                        <aside
                                className={cx(s.rightDrawer, isOpen && s.open)}
