		...
		>
			...
			<div className={cx(s.asidePanel, activePanel === "security" && s.active)}>
				<div className={s.asideHeader}>
					<span className={s.asideTitle}>
						<i
							className={cx("bi bi-shield-shaded", "me-1")}
						...
						<div className="d-flex justify-content-between align-items-center mb-2">
							...
							<div className="form-check form-switch m-0">
								<input
									...
									type="checkbox"
									defaultChecked
									aria-label="Toggle all transactions alerts"
								/>
							</div>
						</div>
						<div className="d-flex justify-content-between align-items-center mb-2">
							...
							<div className="form-check form-switch m-0">
								<input
									...
									type="checkbox"
									defaultChecked
									aria-label="Toggle international usage alerts"
								/>
							</div>
						</div>
						<div className="d-flex justify-content-between align-items-center">
							...
							<div className="form-check form-switch m-0">
								<input
									className="form-check-input"
									type="checkbox"
									aria-label="Toggle large threshold alerts"
								/>
							</div>
						</div>
					</div>
						...
						<div className="d-flex justify-content-between align-items-center">
							...
							<div className="form-check form-switch m-0">
								<input
									className="form-check-input"
									type="checkbox"
									aria-label="Toggle ATM withdrawals"
								/>
							</div>
						</div>
					</div>
			...
			<div className={cx(s.asidePanel, activePanel === "limits" && s.active)}>
				<div className={s.asideHeader}>
					<span className={s.asideTitle}>
						<i
							className={cx("bi bi-sliders", "me-1")}
							style={{ color: "var(--cl-primary)" }}
						/>{" "}
						Daily Limits
					</span>
					...
					<div className={s.asideCard}>
						...
						<div className="mb-3">
							...
							<input
								...
								defaultValue="$5,000"
								aria-label="Per transaction limit"
							/>
						</div>
						<div className="mb-3">
							<label
						...
						<div className="mb-3">
							...
							<input
								...
								aria-label="Monthly total limit"
							/>
						</div>
						<button
							type="button"
			...
			{/* ============ CARD PROGRAM ============ */}
			<div
				className={cx(s.asidePanel, activePanel === "cardProgram" && s.active)}
			>
				<div className={s.asideHeader}>
					<span className={s.asideTitle}>
						<i
							className={cx("bi bi-gear", "me-1")}
							style={{ color: "var(--cl-primary)" }}
						/>{" "}
						Card Program
					</span>
