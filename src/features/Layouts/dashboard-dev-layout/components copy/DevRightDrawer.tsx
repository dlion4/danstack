/* ============================================================================
 * DevRightDrawer.tsx — right slide-in drawer for Security & Environments.
 * ========================================================================== */
...
export default function DevRightDrawer({ open, activeTab, onClose, onToast }: DevRightDrawerProps) {
        ...
        return (
                <>
                        {/* Backdrop */}
                        <div
                                className={cx(s["rightDrawerBackdrop"], open && s.show)}
                                aria-hidden="true"
                                onClick={onClose}
                        />
                        {/* Drawer panel */}
                        <aside
                                className={cx(s["rightDrawer"], open && s.open)}
                                aria-label="Security & Environments (right drawer)"
                                aria-hidden={!open}
                        >
                                <div className={s["rightDrawerHeader"]}>
                                        <span className={s["rightDrawerTitle"]}>
                                ...
                                {/* Tabs */}
                                <div className={s["rightDrawerTabs"]}>
                                        <button
                                                type="button"
                                                className={cx(s["rightDrawerTab"], tab === "security" && s.tabActive)}
                                        ...
                                        <button
                                                type="button"
                                                className={cx(s["rightDrawerTab"], tab === "env" && s.tabActive)}
                                ...
                                <div className={s["rightDrawerBody"]}>
                                        {/* ============ SECURITY TAB ============ */}
                                        <div className={cx(s["rightDrawerPanel"], tab === "security" && s.panelVisible)}>
                                                {/* Session Info */}
                                                <div className={s["rightDrawerCard"]}>
                                        ...
                                        {/* ============ ENVIRONMENTS TAB ============ */}
                                        <div className={cx(s["rightDrawerPanel"], tab === "env" && s.panelVisible)}>
                                                {/* Environment Cards */}
                                                {[
                                                        {
                                                                key: "sandbox",
                                                        ...
                                                        <div className={s["rightDrawerCard"]} key={env.key}>
