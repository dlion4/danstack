...
import type {
        DevShellContextValue,
        ToastInput,
} from "../data/devLayoutContext";
...
import DevRightDrawer from "./DevRightDrawer";
...
export default function DevShell() {
        ...
        const [rightDrawerTab, setRightDrawerTab] = useState<"security" | "env">("security");
        ...
        const openAside = useCallback(
                (kind: AsideKind) => {
                        if (kind === "securityTab" || kind === "envTab") {
                                setRightDrawerTab(kind === "securityTab" ? "security" : "env");
        ...
        }, [closeAllDropdowns, closeAside, closeRightDrawer, showToast]);
        ...
        }, [closeAllDropdowns, closeAside, closeRightDrawer, closeMobile, isDesktop, toggleSidebar]);
        ...
        useEffect(() => {
                const lock = (!isDesktop && mobileOpen) || activePanel !== null || rightDrawerOpen;
                document.body.style.overflow = lock ? "hidden" : "";
                return () => {
                        document.body.style.overflow = "";
                };
        }, [isDesktop, mobileOpen, activePanel, rightDrawerOpen]);
        ...
        return (
                <DevShellContext.Provider value={ctxValue}>
                        <div className={s.devRoot}>
                                ...
                                {/* ============ RIGHT DRAWER (Security & Environments) ============ */}
                                <DevRightDrawer
