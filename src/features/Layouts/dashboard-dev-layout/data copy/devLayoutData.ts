	...
	modules: [
		{
			...
			features: [
				...
				{
					icon: "bi-terminal",
					text: "Test endpoints live in the API Explorer",
				},
		...
		},
		{
			...
			features: [
				{
					icon: "bi-braces",
					text: "Auto-generated request bodies from schema",
				},
				{
					icon: "bi-clock-history",
					text: "Request history with one-click replay",
				},
				{ icon: "bi-clipboard", text: "Export to cURL, Node, Python & Go" },
				{
					icon: "bi-shield-lock",
					text: "Sandbox-scoped auth, never production",
				},
			],
			actions: [
		...
		},
		{
			...
			features: [
				...
				{
					icon: "bi-credit-card",
					text: "Issue test cards with fixed outcomes",
				},
				{
					icon: "bi-lightning-charge",
					text: "Trigger webhook events manually",
				},
		...
		},
		{
			...
			features: [
				{
					icon: "bi-braces",
					text: "Fully typed Node, Python, Go, Java, PHP, Ruby",
				},
		...
		},
		{
			...
			icon: "bi-exclamation-triangle",
			pill: "RELIABILITY",
			titlePre: "Catch errors ",
			titleAccent: "before users do.",
			...
			features: [
				{
					icon: "bi-layers",
					text: "Automatic error grouping by code & endpoint",
				},
...
export const linkedAccounts: LinkedAccount[] = [
	{ key: "primary", label: "Primary Account", icon: "bi-wallet2", linked: true, id: "ACC-001-7842" },
	...
	{ key: "developer", label: "Developer Account", icon: "bi-code-slash", linked: true, id: "ACC-004-3190" },
