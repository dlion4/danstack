 ...
 * features + actions. Unknown modules render a friendly empty state.
 * ========================================================================== */
import type { CSSProperties } from 'react';
import { Link } from '@tanstack/react-router';
import { useQuery } from '@tanstack/react-query';
import { cx, fetchBusinessLayoutContent, findModule, initialMockData } from '../data/businessLayoutData';
...
interface BusinessModulePageProps {
  module: string;
}
...
export default function BusinessModulePage({ module }: BusinessModulePageProps) {
  const { showToast, openAside } = useBusinessShell();
        ...
        <section className={d.sectionCard}>
          <div className={d.emptyState}>
            ...
            <div className={d.actionRow} style={{ justifyContent: 'center' }}>
              <Link to="/business" className={c.btnPrimary} style={{ textDecoration: 'none' }}>
  ...
  return (
    <div className={d.pageWrap}>
      ...
      <div className={d.actionRow}>
        <Link to="/business" className={c.btnLink} style={{ textDecoration: 'none' }}>
          <i className="bi bi-arrow-left" /> Back to dashboard
        </Link>
      </div>
    </div>
