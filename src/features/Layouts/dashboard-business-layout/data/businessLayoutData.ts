...
export type AsideKind = "compliance" | "entity" | "payroll" | "security" | "apiKeys";
...
export const initialMockData: BusinessLayoutContent = {
        ...
        notifications: [
                ...
                },
                {
                        ...
                        tone: "warning",
                        title: "Operating permit expiring",
                        desc: "Renew within 14 days to stay compliant.",
                        time: "5h",
                        unread: true,
                },
                {
                        ...
                        desc: "Safaricom Ltd added to the vendor book.",
                        time: "1d",
                        unread: true,
                },
                {
                        ...
                        tone: "danger",
                        title: "Failed payout",
                        desc: "Vendor INV-2291 needs a retry.",
                        time: "1d",
                        unread: true,
                },
        ],
        ...
        modules: [
                {
                        ...
                        features: [
                                ...
                                {
                                        icon: "bi-shield-check",
                                        text: "KYB and compliance status always visible",
                                },
                        ],
                        actions: [
                ...
                },
                {
                        ...
                        features: [
                                { icon: "bi-search", text: "Filter by date, account or counterparty" },
                                {
                                        ...
                                        text: "Reconciliation status per movement",
                                },
                ...
                },
                {
                        ...
                        features: [
                                { icon: "bi-play", text: "One-click payroll runs" },
                                {
                                        ...
                                        text: "Payslip generation and download",
                                },
...
export async function fetchBusinessLayoutContent(): Promise<BusinessLayoutContent> {
        ...
        try {
                ...
                if (!response.ok)
                        throw new Error(`Business layout API responded HTTP ${response.status}`);
...
/* --------------------------------------------------------------------------
 * Security / Session / Policy data for the left drawer.
 * ------------------------------------------------------------------------ */
...
export interface SecurityDrawerData {
        session: SessionInfo;
        authItems: AuthItem[];
        policies: PolicyLink[];
}

export const securityDrawerData: SecurityDrawerData = {
        session: {
                ip: "192.168.1.42",
...
export const linkedAccounts: LinkedAccount[] = [
	{ key: "primary", label: "Primary Account", icon: "bi-person-circle", linked: true, id: "ACC-3942-019" },
