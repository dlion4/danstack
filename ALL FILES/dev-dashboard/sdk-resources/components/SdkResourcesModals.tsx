...
const CHANGELOG = [
	"v3.2.0 — Added maxRetries option and complete Disbursement types.",
	"v3.1.5 — Fixed client timeout behavior on slow networks.",
	"v3.1.0 — Added PesaLink bank-transfer APIs.",
	"v3.0.0 — TypeScript rewrite with new client initialization.",
];
