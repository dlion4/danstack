...
interface CardSecurityFraudPreventionConfig {
	nav: NavItem[];
	headerTitle: string;
	headerSub: string;
...
const initialMockData: CardSecurityFraudPreventionConfig = {
	nav: [
	...
	headerTitle: "Fraud Prevention & Security",
	headerSub:
		"Advanced AI-powered threat detection, risk assessment, and real-time fraud monitoring across all payment channels",
	searchPlaceholder:
		"Search threats, incidents, compliance, security actions...",
	...
	statCards: [
		{
			...
			lines: [
				"2 physical debit, 3 virtual debit, 1 virtual credit and 1 prepaid card",
			],
		},
		{
			key: "score",
		...
		},
		{
			...
			lines: ["Dispute #CDP-44892", "PIN reset #PR-11228"],
		},
		{
			key: "actions",
			col: "col-lg-3 col-md-6",
	...
	sections: {
		preferences: {
			title: "5.4.1 — AI Threat Detection & Monitoring",
			sub: "Configure advanced machine learning models and real-time threat monitoring for fraud prevention.",
			cards: [
				{
					last4: "4521",
					name: "Primary Debit",
		...
		alerts: {
			title: "5.4.2 — Fraud Alert & Response Settings",
			sub: "Configure automated fraud alerts, response protocols, and incident investigation workflows.",
			alerts: [
				{
	...
	openCases: [
		...
		},
		{
			...
			statusTone: "badgeP",
			nextStep: "Card personalized, courier pending",
		},
	],
};

async function fetchCardSecurityConfig(): Promise<CardSecurityFraudPreventionConfig> {
	try {
		const res = await fetch("/api/card-security", {
			headers: { Accept: "application/json" },
		});
		if (!res.ok) throw new Error(`Request failed: ${res.status}`);
		return (await res.json()) as CardSecurityFraudPreventionConfig;
	} catch {
					...
					<div className="row g-3">
						<div className="col-lg-4">
							...
							>
								...
								>
									Threat detection engine is live{" "}
								...
								>
									Advanced AI-powered threat detection across all card
									portfolios with 3D Secure and behavioral analysis.
								</p>
								<div className="mt-3">
									<button
