...
const initialMockData: VirtualDebitCardsConfig = {
	...
	headerSub:
		"Instant digital cards, e-commerce control & subscription management",
	...
	statCards: [
		{
			...
			lines: [
				"Global Web Shopping, Subscriptions, AWS Hosting & more — centralized here.",
			],
		},
		{
			key: "monthlySpend",
			...
			labelColor: "var(--pm-success)",
			value: "KES 48,200",
			badge: { icon: "bi-graph-up", text: "+12% this month", tone: "badgeS" },
			lines: ["Digital shopping across 8 subscription services."],
		},
		{
			key: "subscriptions",
			col: "col-lg-4 col-md-6",
			...
			value: "8 services",
			badge: { icon: "bi-clock", text: "3 due this week", tone: "badgeW" },
			lines: ["Monthly recurring payments totaling KES 14,500."],
		},
		{
			key: "security",
			col: "col-lg-4 col-md-6",
			...
			lines: [
				"Frozen cards: 1 · Single-use burned: 4 — all preferences centralised here.",
			],
		},
	],
	cards: [
		...
		attention: [
			{
				...
				sub: "AWS Web Services · KES 4,500",
				actionLabel: "Fund",
				actionClass: "btnPmDanger",
				modal: "topUpCardModal",
			},
			{
				...
				iconText: "EX",
				title: "Card expiring in 15 days",
				sub: "Global Shopping Card · **3841",
				actionLabel: "Renew",
			...
			},
			{
				...
				sub: "Netflix · +KES 300 this month",
				actionLabel: "Review",
				actionModal: "subManagerModal",
			},
			{
				icon: "bi-clock",
				...
				iconText: "3D",
				title: "Pending 3D Secure Auth",
				sub: "AliExpress · KES 2,100",
				actionLabel: "Approve",
				actionModal: "auth3DSModal",
			},
		],
		suggestions: [
			{
				...
				title: "Lock card to single merchant",
				sub: "Secure your Netflix card further",
				actionLabel: "Lock",
				actionModal: "merchantLockModal",
			},
			{
				icon: "bi-arrow-clockwise",
				iconBg: "var(--pm-info-soft)",
				iconColor: "var(--pm-info)",
				title: "Enable Dynamic CVV",
				sub: "Rotate CVV daily on Shopping Card",
				actionLabel: "Enable",
				actionModal: "rotateCvvModal",
			},
			{
				icon: "bi-trash",
				iconBg: "var(--pm-danger-soft)",
				...
				sub: "Spotify not used in 60 days",
				actionLabel: "Cancel",
				actionModal: "cancelSubModal",
			},
			{
				icon: "bi-bar-chart",
				iconBg: "var(--pm-warning-soft)",
				iconColor: "var(--pm-warning)",
				title: "Lower spending limit",
				sub: "Card rarely uses >KES 10k",
				actionLabel: "Adjust",
				actionModal: "editLimitsModal",
			},
		],
		quickActions: [
			{
			...
			},
			{
				...
				iconColor: "var(--pm-warning)",
				label: "Single-Use",
				modal: "singleUseCardModal",
			},
			{
				icon: "bi-plus-circle",
				iconColor: "var(--pm-success)",
				label: "Top-up Card",
				modal: "topUpCardModal",
			},
			{
			...
			},
			{
				...
				iconColor: "var(--pm-purple)",
				label: "Subs Hub",
				modal: "subManagerModal",
			},
			{
				icon: "bi-file-earmark-text",
				iconColor: "var(--pm-secondary)",
				label: "Statements",
				modal: "cardStatementModal",
			},
			{
				icon: "bi-shield-exclamation",
				iconColor: "var(--pm-danger)",
				label: "Report Fraud",
				modal: "reportFraudModal",
			},
		],
		recentActivity: [
			{
				...
				iconColor: "var(--pm-ink);",
				title: "AWS Web Services",
				sub: "Declined · Insufficient Funds",
				actionLabel: "Fund",
				actionClass: "btnPmDanger",
				modal: "topUpCardModal",
			},
			...
			},
			{
				...
				iconBg: "var(--pm-surface-2)",
				iconColor: "var(--pm-primary);",
				title: "AliExpress Shopping",
				sub: "Approved · 3DS",
				actionLabel: "View",
				actionModal: "cardStatementModal",
			},
			{
				icon: "bi-apple",
				iconBg: "var(--pm-surface-2)",
			...
			},
			{
				...
				iconColor: "var(--pm-danger);",
				title: "Spotify",
				sub: "Cancelled — removed from card **9021",
				actionLabel: "Refund?",
...
async function fetchVirtualDebitCardsConfig(): Promise<VirtualDebitCardsConfig> {
	try {
		const res = await fetch("/api/virtual-debit-cards", {
				...
				<div className={styles.pageBar}>
					...
					<div className="d-flex flex-wrap" style={{ gap: 8 }}>
						<button
							...
							onClick={() => setActiveModal("cardSecurityModal")}
						>
							<i className="bi bi-shield-lock" /> Security
						</button>
						<button
							className={styles.btnPm}
							onClick={() => setActiveModal("cardAnalyticsModal")}
						>
						...
						<div
							...
							onClick={() => setActiveModal("profileModal")}
						>
							<div
					...
					<div className="row g-3">
						<div className="col-lg-4">
							...
							>
								...
								>
									Virtual issuance engine is live{" "}
								...
								>
									Used for global shopping, Netflix, AWS hosting, and secure
								...
								<div className="d-flex flex-wrap mt-3" style={{ gap: 8 }}>
									<button
										...
										onClick={() => setActiveModal("createCardModal")}
									>
										New card
									</button>
									<button
										...
										onClick={() => setActiveModal("singleUseCardModal")}
									>
										Single-use
									</button>
									<button
										...
										onClick={() => setActiveModal("bulkCreateModal")}
									>
										Bulk issue
									</button>
								</div>
						...
						<div className="col-lg-2 col-md-4 col-6">
							<div className={styles.card} style={{ minHeight: 170 }}>
								...
								<span className={`${styles.badge} ${styles.badgeSuccess}`}>
									<i className="bi bi-graph-up" /> +12% this month
								</span>
								<div className={styles.miniBars} style={{ marginTop: 12 }}>
									...
									<div
										className={styles.miniBar}
										style={{ height: "60%", background: "var(--pm-primary)" }}
									></div>
									<div
										className={styles.miniBar}
										style={{ height: "35%", background: "var(--pm-info)" }}
									></div>
									<div
										className={styles.miniBar}
									...
									<div
										className={styles.miniBar}
										style={{ height: "90%", background: "var(--pm-danger)" }}
									></div>
									<div
										className={styles.miniBar}
										style={{ height: "60%", background: "var(--pm-primary)" }}
						...
						<div className="col-lg-3 col-md-4 col-6">
							<div className={styles.card} style={{ minHeight: 170 }}>
								...
								<span className={`${styles.badge} ${styles.badgeWarning}`}>
									<i className="bi bi-clock" /> 3 due this week
								</span>
								<div className="mt-2">
									<div
									...
									>
										...
										<span>KES 14,500/mo</span>
									</div>
									<div className={styles.progress} style={{ marginTop: 8 }}>
										<div
											className={styles.progressBar}
											style={{ width: "40%", background: "var(--pm-warning)" }}
										></div>
									</div>
								</div>
							</div>
						...
						<div className="col-lg-3 col-md-4">
							...
							>
								...
								<span className={`${styles.badge} ${styles.badgeSuccess}`}>
									<i className="bi bi-shield-check" /> Blocked attempts
								</span>
								<div
									className="mt-2"
								...
								>
									<div>
										Frozen cards: <strong>1</strong>
									</div>
									<div>
										Single-use burned: <strong>4</strong>
									</div>
								</div>
							</div>
						</div>
						...
						>
							<div>
								<h3 className={styles.sectionTitle}>
									...
									/>{" "}
									5.3.1 — Virtual Card Issuance & Portfolio
								</h3>
								<p className={styles.sectionSub}>
									Manage your active virtual cards. Click on any card to reveal
									details, copy numbers, or manage security settings.
								</p>
							</div>
							<div className="d-flex" style={{ gap: 8 }}>
								<button
									...
									onClick={() => setActiveModal("bulkCreateModal")}
								>
									<i className="bi bi-files" /> Bulk Issue
								</button>
								<button
									className={`${styles.btnPm} ${styles.btnSm} ${styles.btnPmPrimary}`}
									onClick={() => setActiveModal("createCardModal")}
								>
									<i className="bi bi-plus-lg" /> Issue New Card
								</button>
							</div>
						</div>
									...
									<div>
										<h3 className={styles.sectionTitle}>
											<i
												...
												style={{ color: "var(--pm-accent)" }}
											/>{" "}
											5.3.2 — Card Details & Security Controls
										</h3>
										<p className={styles.sectionSub}>
											Advanced security settings for selected virtual cards.
										</p>
									</div>
									<div className={styles.tabPills}>
										<button className={`${styles.tabPill} ${styles.active}`}>
											Security
										</button>
										<button
											className={styles.tabPill}
											onClick={() => setActiveModal("editLimitsModal")}
										>
											Limits
										</button>
									</div>
									...
									<div className="col-md-6">
										<div className={styles.utilityBlock}>
											...
											<div className="d-flex justify-content-between align-items-center mb-3">
												...
												<button
													className={`${styles.btnPm} ${styles.btnSm} ${styles.btnPmOutline}`}
											...
											<div className="d-flex justify-content-between align-items-center mb-3">
												...
												<button
													className={`${styles.btnPm} ${styles.btnSm} ${styles.btnPmDangerSoft}`}
													onClick={() => setActiveModal("deleteCardModal")}
												>
													Delete
												</button>
											</div>
											<div className="d-flex justify-content-between align-items-center">
												...
												<button
													className={`${styles.btnPm} ${styles.btnSm} ${styles.btnPmOutline}`}
													onClick={() => setActiveModal("editAliasModal")}
												>
													Edit
												</button>
											</div>
						...
						<div className="col-lg-5">
							<div className={styles.card} style={{ height: "100%" }}>
								<div className="d-flex justify-content-between align-items-center mb-3">
									...
									<button
										className={`${styles.btnPm} ${styles.btnSm}`}
										onClick={() => setActiveModal("cardStatementModal")}
									>
										View All
									</button>
								</div>
									...
									<div key={item.title} className={styles.feedItem}>
										...
										<div style={{ flex: 1 }}>
											...
											<div style={{ fontSize: 10, color: "var(--pm-muted)" }}>
												Card **
												{item.title === "AWS Web Services"
													? "4418"
													: item.title === "Netflix Subscription"
														? "9021"
														: item.title === "AliExpress Shopping"
															? "3841"
															: "9021"}
											</div>
										</div>
								...
								<button
									...
									onClick={() => setActiveModal("disputeTxModal")}
								>
						...
						>
							<div>
								<h3 className={styles.sectionTitle}>
									...
									/>{" "}
									5.3.3 — Online Subscriptions & E-commerce
								</h3>
								<p className={styles.sectionSub}>
									Auto-detected recurring payments linked to your virtual cards.
									Manage, block, or migrate subscriptions.
								</p>
							</div>
							<div className="d-flex" style={{ gap: 8 }}>
								<button
									className={`${styles.btnPm} ${styles.btnSm}`}
									onClick={() => setActiveModal("addSubscriptionModal")}
								>
									<i className="bi bi-plus" /> Add Sub
								</button>
								<button
									className={`${styles.btnPm} ${styles.btnSm} ${styles.btnPmPrimary}`}
									onClick={() => setActiveModal("subManagerModal")}
								>
									<i className="bi bi-gear" /> Manage All
								</button>
							</div>
						</div>
								...
								<tbody>
									<tr>
										...
										<td>
											<button
												className={`${styles.btnPm} ${styles.btnSm} ${styles.btnPmOutline}`}
												onClick={() => setActiveModal("manageSingleSubModal")}
											>
												Manage
											</button>
										</td>
									...
									<tr>
										...
										<td>
											<button
												className={`${styles.btnPm} ${styles.btnSm} ${styles.btnPmOutline}`}
												onClick={() => setActiveModal("cancelSubModal")}
											>
												Cancel
											</button>
										</td>
									...
									<tr>
										...
										<td>
											<button
												className={`${styles.btnPm} ${styles.btnSm} ${styles.btnPmPrimary}`}
												onClick={() => setActiveModal("topUpCardModal")}
											>
												Fund Card
											</button>
										</td>
