						...
						>
							<div>
								<h3 className={styles.st}>
									...
									/>{" "}
									1.8.1 — Analytics Overview Dashboard
								</h3>
						...
						>
							<div>
								<h3 className={styles.st}>
									...
									/>{" "}
									1.8.2 — Transaction Trends & Patterns
								</h3>
								<p className={styles.ss}>
						...
						>
							<div>
								<h3 className={styles.st}>
									...
									/>{" "}
									1.8.3 — Failed & Declined Transaction Analysis
								</h3>
								<p className={styles.ss}>
						...
						>
							<div>
								<h3 className={styles.st}>
									...
									/>{" "}
									1.8.4 — Merchant & Category Insights
								</h3>
								<p className={styles.ss}>
						...
						>
							<div>
								<h3 className={styles.st}>
									...
									/>{" "}
									1.8.6 — Scheduled & Automated Reports
								</h3>
								<p className={styles.ss}>
