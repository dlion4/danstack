...
export default function OpenBankingModals({
	active,
	onClose,
	onOpen,
}: ModalsProps) {
	...
	useEffect(() => {
		if (active === null) {
			setResults({});
			setFlows({ connect: 1, transfer: 1, recon: 1 });
			setBusy(null);
		}
	}, [active]);
			...
			>
					...
					<div className={s.fstepActive}>
						...
						<div className="row g-2">
							{[
								...
								<div key={b} className="col-md-4 col-6">
									<button
										className={cx(s.btnPm, "w-100")}
										style={{ padding: 12 }}
									>
										{b}
									</button>
				...
				{step === 3 && (
					<div className={s.fstepActive}>
						...
						>
							<strong>Open Banking Consent</strong>
							<br />
							<span style={{ fontSize: 12 }}>
								You are granting PayMo read access to your account balance and
								transactions. No write access is granted.
							</span>
						</div>
						<div className="form-check mb-2">
							<input
								...
								defaultChecked
							/>
							<label className="form-check-label">Share account balance</label>
						</div>
						<div className="form-check mb-2">
							<input
								className="form-check-input"
						...
						<div className="form-check">
							...
							<label className="form-check-label">
								Enable payment initiation (write access)
							</label>
						</div>
					</div>
				)}
				{step === 4 &&
					renderActionBody(
						...
						<div className={s.fstepActive}>
							...
							>
								Complete Connection <i className="bi bi-check-lg" />
							</button>
						</div>,
					)}
			</MBox>
				...
				{step === 1 && (
					<div className={s.fstepActive}>
						<div className="mb-3">
							...
							<select className={s.formControl}>
								<option>Equity ****4521 (KES 4.25M)</option>
								<option>Co-op ****3390 (KES 8.9M)</option>
							</select>
						</div>
						<div className="mb-3">
							<label className={s.formLabel}>To Bank</label>
							<select className={s.formControl}>
						...
						<div className={s.fstepActive}>
							...
							>
								<div className="d-flex justify-content-between mb-2">
									...
									<strong>Equity ****4521</strong>
								</div>
								<div className="d-flex justify-content-between mb-2">
									<span className="text-muted">To</span>
									<strong>KCB ****7782</strong>
								</div>
							...
							<button
								...
								onClick={() =>
									doAction(
										"transferModal",
										"Transfer completed successfully! KES 500,000 sent.",
										"PL-442201",
									)
								}
							>
								Confirm & Send <i className="bi bi-check-lg" />
							</button>
						</div>,
					)}
				{step === 3 &&
		...
		return (
			...
			>
				...
				{step === 1 && (
					<div className={s.fstepActive}>
						<div className="mb-3">
							<label className={s.formLabel}>Banks to Reconcile</label>
							<div className="form-check mb-1">
								<input
									...
									defaultChecked
								/>
								<label className="form-check-label">Equity Bank ****4521</label>
							</div>
							<div className="form-check mb-1">
								<input
									className="form-check-input"
									...
									defaultChecked
								/>
								<label className="form-check-label">KCB Bank ****7782</label>
							</div>
							<div className="form-check mb-1">
								<input className="form-check-input" type="checkbox" />
								<label className="form-check-label">Co-op Bank ****3390</label>
							</div>
						</div>
						<div className="mb-3">
				...
				{step === 2 &&
					renderActionBody(
						...
						<div className={s.fstepActive}>
							...
							>
								<strong>412 transactions auto-matched</strong>
								<br />
								<span style={{ fontSize: 12 }}>14 require manual review</span>
							</div>
							<button
								className={cx(s.btnPm, s.btnPmP, "w-100")}
								onClick={() =>
									doAction(
										"reconcileModal",
										"Reconciliation complete. 412 matched, 14 flagged.",
										"REC-20250627-8821",
									)
								}
							>
								Finalize Reconciliation <i className="bi bi-check-lg" />
							</button>
						</div>,
					)}
				{step === 3 &&
		...
		>
			{renderActionBody(
				...
				<>
					...
					<div className="mb-3">
						<label className={s.formLabel}>Amount (KES)</label>
						<input className={s.formControl} defaultValue="2400000" />
					</div>
					<div className="mb-3">
	...
	const renderAccountDetail = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-bank text-primary me-2" />
					Account Details
				</>
			}
			footer={
			...
			<div className="row g-3 mb-3">
				...
				<div className="col-md-6">
					...
					>
						...
						<br />
						<strong style={{ color: "#1D4ED8" }}>Active • Live</strong>
					</div>
				</div>
			</div>
								...
								<div className="d-flex" style={{ gap: 4 }}>
									...
									<button
										...
										onClick={() =>
											doAction(
												"manageLinksModal",
												"Bank link removed successfully.",
												"",
											)
										}
									>
			...
			footer={
				<>
					...
					<button
						className={cx(s.btnPm, s.btnPmP)}
						onClick={() =>
							doAction("reauthModal", "Bank re-authenticated successfully!", "")
						}
					>
						Re-authenticate
					</button>
			...
			{renderActionBody(
				...
				<>
					...
					>
						...
						<br />
						Your open banking consent has expired or is about to expire.
					</div>
					<div className="mb-3">
						<label className={s.formLabel}>Bank</label>
						<select className={s.formControl}>
							<option>Family Bank ****5543</option>
							<option>Co-op Bank ****3390</option>
						</select>
					</div>
					<div className="form-check">
						<input
	...
	const renderExportStatement = () => (
					...
					<button
						...
						onClick={() =>
							doAction(
								...
								"Multi-bank statement exported successfully.",
								"",
							)
						}
					>
		...
		>
			{renderActionBody(
				...
				<>
					<div className="mb-3">
						<label className={s.formLabel}>Banks</label>
						<select className={s.formControl} multiple>
							<option selected>Equity Bank</option>
					...
					<div className="mb-3">
						...
						<select className={s.formControl}>
							<option>PDF (Consolidated)</option>
							<option>Excel (Multi-sheet)</option>
							<option>CSV (Combined)</option>
							<option>MT940 (Bank format)</option>
						</select>
					</div>
				</>,
			)}
	...
	const renderOBSettings = () => (
			...
			footer={
				<>
					...
					<button
						className={cx(s.btnPm, s.btnPmP)}
						onClick={() =>
							doAction("obSettingsModal", "Settings saved successfully.", "")
						}
					>
						Save
					</button>
		...
		>
			{renderActionBody(
				...
				<>
					<div className="mb-3">
						<label className={s.formLabel}>Default Transfer Bank</label>
						<select className={s.formControl}>
					...
					<div className="mb-3">
						<label className={s.formLabel}>Reconciliation Auto-Run</label>
						<select className={s.formControl}>
					...
					<div className="form-check form-switch mb-2">
						...
						/>
						<label className="form-check-label">
							Email daily reconciliation summary
						</label>
					</div>
					<div className="form-check form-switch mb-2">
						<input
						...
						/>
						<label className="form-check-label">
							SMS for large unmatched amounts
						</label>
					</div>
	...
	const renderAttention = () => (
		...
		>
			<div className={s.statusRow}>
				<div>
					<strong>KCB balance below minimum</strong>
			...
			<div className={s.statusRow}>
				<div>
					<strong>14 unreconciled transactions</strong>
					<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
						Equity & Stanbic
					</div>
				</div>
			...
			<div className={s.statusRow}>
				<div>
					<strong>Co-op consent expires</strong>
					<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
						7 days remaining
					</div>
				</div>
			...
			<div className={s.statusRow}>
				<div>
					<strong>Family Bank link expired</strong>
					<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
						Reconnect needed
					</div>
				</div>
			...
			footer={
				<>
					...
					<button
						className={cx(s.btnPm, s.btnPmP)}
						onClick={() =>
							doAction("optimizeModal", "Optimisation plan saved.", "")
						}
					>
						Adopt Plan
					</button>
		...
		>
			{renderActionBody(
				...
				<p style={{ fontSize: 13, color: "var(--pm-ink-soft)" }}>
					Analysis shows 3 low-activity accounts can be closed with minimal
					operational impact, saving KES 18,200 annually in fees.
				</p>,
			)}
		</MBox>
	);
	...
	const renderMatchDetail = () => (
		...
		>
			...
			>
				<div className="d-flex justify-content-between mb-2">
					<span className="text-muted">Bank Transaction</span>
					<strong>Equity • 27 Jun • KES 1,850,000</strong>
				</div>
				<div className="d-flex justify-content-between">
					<span className="text-muted">Matched To</span>
					<strong>Invoice INV-4421 • ABC Ltd</strong>
				</div>
			</div>
			<div className="row g-3">
				...
				<div className="col-md-6">
					...
					>
						...
						<div
							style={{ fontSize: 18, fontWeight: 700, color: "var(--pm-info)" }}
						>
							Amount + Reference
						</div>
					</div>
	...
	const renderNotif = () => (
		<MBox
			...
			footer={
				<>
					<button className={s.btnPm} onClick={() => onOpen("obSettingsModal")}>
		...
		>
			<div style={{ maxHeight: 500, overflowY: "auto" }}>
				...
				<div
					...
					style={{ background: "var(--pm-warning-soft)", fontSize: 13 }}
				>
					<strong>Co-op consent expires in 7 days</strong>
					<div style={{ fontSize: 11, color: "#92400E" }}>
						Re-authenticate before 04 Jul
					</div>
				</div>
				<div
					className="p-3 rounded mb-2"
				...
				>
					<strong>14 transactions unmatched</strong>
					<div style={{ fontSize: 11, color: "#1E40AF" }}>
						Requires reconciliation review
					</div>
				</div>
				<div
					className="p-3 rounded mb-2"
				...
				>
					<strong>Transfer PL-442189 completed</strong>
					<div style={{ fontSize: 11, color: "#065F46" }}>
						KES 850,000 to KCB ****7782
					</div>
				</div>
				<div
					className="p-3 rounded mb-2"
				...
				<div className="row g-2 text-start mt-3" style={{ fontSize: 13 }}>
					<div className="col-6">
						<div
							...
							style={{ background: "var(--pm-surface-2)" }}
						>
							<span className="text-muted">Linked Banks</span>
							<br />
							<strong>7 accounts</strong>
						</div>
					</div>
					<div className="col-6">
						<div
					...
					<div className="col-6">
						<div
							...
							style={{ background: "var(--pm-surface-2)" }}
						>
							<span className="text-muted">Transfers (MTD)</span>
							<br />
							<strong>186</strong>
						</div>
					</div>
					<div className="col-6">
						<div
							...
							style={{ background: "var(--pm-surface-2)" }}
						>
							<span className="text-muted">Open Exceptions</span>
							<br />
							<strong>14</strong>
						</div>
					</div>
