...
export default function VirtualAccountsModals({
	active,
	onClose,
	onOpen,
}: ModalsProps) {
			...
			>
				...
				{step === 2 && (
					<div className={s.fstepActive}>
						...
						<div className="mb-3">
							<label className={s.formLabel}>Auto-Sweep</label>
							<div className="form-check form-switch">
								...
								<label className="form-check-label">
									Enable auto-sweep to treasury
								</label>
							</div>
						</div>
						<div className="mb-3">
							<label className={s.formLabel}>Approval Level</label>
							<select className={s.formControl}>
								<option>Auto</option>
								<option>Manager</option>
								<option>Director</option>
								<option>CFO + Board</option>
							</select>
						</div>
					</div>
				)}
					...
					renderActionBody(
						...
						<div className={s.fstepActive}>
							...
							>
								...
								>
									Account: Client Escrow • Type: Collections • Limit: KES 5M
								</div>
							</div>
							<button
							...
							>
								Create Account <i className="bi bi-check-lg" />
							</button>
						</div>,
					)}
			</MBox>
		...
		return (
			...
			>
				...
				{step === 1 && (
					<div className={s.fstepActive}>
						<div className="mb-3">
							<label className={s.formLabel}>Parent VA</label>
							<select className={s.formControl}>
						...
						<div className="mb-3">
							<label className={s.formLabel}>Sub-Account Name</label>
							<input
								className={s.formControl}
						...
						<div className="mb-3">
							<label className={s.formLabel}>Monthly Budget (KES)</label>
				...
				{step === 2 && (
					<div className={s.fstepActive}>
						<div className="mb-3">
							<label className={s.formLabel}>Spending Limit (KES)</label>
							<input className={s.formControl} defaultValue="2000000" />
						</div>
						<div className="mb-3">
							<label className={s.formLabel}>Approval Required</label>
							<div className="form-check">
								...
								/>
								<label className="form-check-label">
									Require manager approval for spending
								</label>
							</div>
						</div>
						<div className="mb-3">
							<label className={s.formLabel}>Notification Threshold</label>
							<select className={s.formControl}>
					...
					renderActionBody(
						...
						<div className={s.fstepActive}>
							...
							>
								...
								>
									Sub: Project Delta • Parent: VA-003 • Limit: KES 2M
								</div>
							</div>
							<button
								className={cx(s.btnPm, s.btnPmP, "w-100")}
							...
							>
								Create Sub-Account <i className="bi bi-check-lg" />
							</button>
						</div>,
					)}
			</MBox>
	...
	const renderBulkFund = () => {
		...
		return (
			<MBox
				...
				title={
					<>
						<i className="bi bi-upload text-primary me-2" />
						Bulk Fund Virtual Accounts
					</>
				}
				footer={
					<>
			...
			>
				...
				{step === 1 && (
					<div className={s.fstepActive}>
						<div className="mb-3">
							<label className={s.formLabel}>Upload CSV</label>
							<input type="file" className={s.formControl} accept=".csv" />
						</div>
						<div
							className="p-3 rounded"
							style={{ background: "var(--pm-info-soft)", fontSize: 12 }}
						>
							<i className="bi bi-info-circle me-1" /> Format: VA-ID, Amount,
							Source, Reference
						</div>
					</div>
				)}
						...
						<div className={s.fstepActive}>
							<button
								...
								onClick={() =>
									doAction(
										"bulkFundModal",
										"3 accounts funded successfully! KES 8.5M distributed.",
										"BF-20250627-9912",
									)
								}
							>
								Execute Batch <i className="bi bi-check-all" />
							</button>
						</div>,
					)}
			</MBox>
	...
	const renderFundVA = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-cash-stack text-warning me-2" />
			...
			footer={
				<>
					...
					<button
						className={cx(s.btnPm, s.btnPmP)}
						onClick={() =>
							doAction("fundVA", "VA funded successfully!", "FND-20250627-4410")
						}
					>
						Fund Now
					</button>
		...
		>
			{renderActionBody(
				...
				<>
					<div className="mb-3">
						<label className={s.formLabel}>Target Account</label>
						<select className={s.formControl}>
							<option>VA-003 — Client Collections</option>
							<option>VA-007 — Payroll</option>
							<option>VA-009 — Marketing</option>
					...
					<div className="mb-3">
						...
						<input className={s.formControl} defaultValue="1000000" />
					</div>
					<div className="mb-3">
						<label className={s.formLabel}>Source</label>
						<select className={s.formControl}>
					...
					<div className="mb-3">
						...
						<input className={s.formControl} placeholder="Optional reference" />
					</div>
				</>,
			)}
		</MBox>
	...
	const renderTransfer = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-arrow-left-right text-info me-2" />
					Internal Transfer
				</>
			}
			footer={
			...
			{renderActionBody(
				...
				<>
					...
					<div className="mb-3">
						...
						<input
							className={s.formControl}
							defaultValue="Inter-departmental transfer"
						/>
					</div>
				</>,
			)}
	...
	const renderRecon = () => (
				...
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"reconModal",
								"Reconciliation completed. 3 accounts cleared.",
								"REC-20250627-7720",
							)
						}
					>
		...
		>
			{renderActionBody(
				...
				<>
					<div className="mb-3">
						<label className={s.formLabel}>Accounts to Reconcile</label>
						<div className="form-check mb-1">
							<input
								...
								defaultChecked
							/>
							<label className="form-check-label">VA-001 — Operations</label>
						</div>
						<div className="form-check mb-1">
							<input
								className="form-check-input"
						...
						<div className="form-check mb-1">
							<input
								...
								defaultChecked
							/>
							<label className="form-check-label">VA-007 — Payroll</label>
						</div>
					</div>
					<div className="mb-3">
						<label className={s.formLabel}>Statement Period</label>
					...
					<div
						...
						style={{ background: "var(--pm-info-soft)", fontSize: 12 }}
					>
						<i className="bi bi-info-circle me-1" /> Auto-match enabled.
						Unmatched items will be flagged for manual review.
					</div>
				</>,
			)}
		</MBox>
			...
			{renderActionBody(
				...
				<>
					...
					<div className="mb-3">
						...
						<select className={s.formControl}>
							<option>Client payment — ABC Corp</option>
							<option>Refund from supplier</option>
			...
			footer={
				<>
					...
					<button
						className={cx(s.btnPm, s.btnPmP)}
						onClick={() =>
							doAction("autoSweepModal", "Auto-sweep rules updated.", "")
						}
					>
						Save Rules
					</button>
			...
			{renderActionBody(
				...
				<>
					...
					<div className="mb-3">
						...
						<select className={s.formControl}>
							<option>Treasury Main Account</option>
							<option>Reserve Account</option>
						</select>
					</div>
					<div className="mb-3">
						<label className={s.formLabel}>Trigger</label>
						<select className={s.formControl}>
							<option>Balance exceeds KES 5M</option>
					...
					<div className="form-check form-switch">
						<input
							...
							defaultChecked
						/>
						<label className="form-check-label">Enable auto-sweep</label>
					</div>
				</>,
			)}
		</MBox>
			...
			footer={
				<>
					...
					<button
						className={cx(s.btnPm, s.btnPmP)}
						onClick={() =>
							doAction("exportReportModal", "Report exported successfully!", "")
						}
					>
						Export
					</button>
				...
				<>
					<div className="mb-3">
						...
						<select className={s.formControl}>
							...
							<option>Sub-Account Report</option>
	...
	const renderSubLimit = () => (
				...
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"subLimitModal",
								"Limit updated successfully. New limit: KES 2,500,000.",
								"LIM-20250627-4493",
							)
						}
					>
		...
		>
			{renderActionBody(
				...
				<>
					<div className="mb-3">
						<label className={s.formLabel}>Sub-Account</label>
						<select className={s.formControl}>
							<option>SUB-0144 — Project Gamma</option>
						</select>
					</div>
					<div className="mb-3">
						<label className={s.formLabel}>Current Monthly Limit</label>
						<input className={s.formControl} defaultValue="2000000" />
					</div>
					<div className="mb-3">
						<label className={s.formLabel}>New Monthly Limit</label>
						<input className={s.formControl} defaultValue="2500000" />
					</div>
					<div className="mb-3">
						...
						<textarea
							className={s.formControl}
							rows={2}
							defaultValue="Increased project scope approved by client. Additional budget allocated."
						/>
					</div>
				</>,
			)}
	...
	const renderVelocity = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-speedometer2 text-warning me-2" />
			...
			footer={
				<>
					...
					<button
						className={cx(s.btnPm, s.btnPmP)}
						onClick={() =>
							doAction("velocityModal", "Velocity controls updated.", "")
						}
					>
						Save Controls
					</button>
				...
				<>
					<div className="row g-3 mb-3">
						<div className="col-md-6">
							<label className={s.formLabel}>Max Transactions per Hour</label>
							<input className={s.formControl} defaultValue="50" />
						</div>
						<div className="col-md-6">
							<label className={s.formLabel}>Max Transactions per Day</label>
							<input className={s.formControl} defaultValue="300" />
						</div>
						<div className="col-md-6">
							<label className={s.formLabel}>Max Single Transaction</label>
							<input className={s.formControl} defaultValue="5000000" />
						</div>
						<div className="col-md-6">
							<label className={s.formLabel}>Cool-down Period (minutes)</label>
							<input className={s.formControl} defaultValue="5" />
						</div>
					</div>
					...
					<div className="form-check">
						<input
							...
							defaultChecked
						/>
						<label className="form-check-label">Alert on velocity breach</label>
					</div>
				</>,
			)}
		</MBox>
	...
	const renderApprovalRules = () => (
		<MBox
			id="approvalRulesModal"
			active={active}
			size="lg"
			onClose={onClose}
			title={
				<>
					<i className="bi bi-shield-check text-accent me-2" /> Approval Rules
					Configuration
				</>
			}
			footer={
				<>
					...
					<button
						className={cx(s.btnPm, s.btnPmP)}
						onClick={() =>
							doAction("approvalRulesModal", "Approval rules updated.", "")
						}
					>
						Save Rules
					</button>
			...
			{renderActionBody(
				...
				<>
					...
					<div className="form-check mt-3">
						...
						/>
						<label className="form-check-label">
							Require dual authorization for amounts above KES 500K
						</label>
					</div>
				</>,
			)}
				...
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"bankErrorModal",
								"Follow-up note added to ticket BNK-88291.",
								"",
							)
						}
					>
				...
				<>
					...
					>
						...
						<div style={{ fontSize: 12, color: "#7F1D1D" }}>
							KES 125,000 debited twice on 22 Jun from VA-001. Ticket #BNK-88291
							raised with Equity Bank.
						</div>
					</div>
					<div className="mb-3">
						<label className={s.formLabel}>Ticket Status</label>
						<div>
							<span className={cx(s.badge, s.badgeI)}>
								Under investigation • Expected resolution: 3 business days
							</span>
						</div>
					</div>
					<div className="mb-3">
						...
						<textarea
							className={s.formControl}
							rows={2}
							defaultValue="Bank confirmed error. Reversal expected by 30 Jun. Temporary credit of KES 125,000 applied to VA-001."
						/>
					</div>
				</>,
			)}
	...
	const renderAttention = () => (
		...
		>
			...
			<div className={s.statusRow}>
				<div>
					<strong>Sub-account SUB-0144 over limit</strong>
					<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
						KES 450K over monthly budget
					</div>
				</div>
				<button
					className={cx(s.btnPm, s.btnSm)}
			...
			<div className={s.statusRow}>
				<div>
					<strong>Bank error ticket open</strong>
					<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
						Duplicate debit KES 125K
					</div>
				</div>
				<button
					className={cx(s.btnPm, s.btnSm)}
				...
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"consolidateModal",
								"3 accounts consolidated successfully. KES 2.54M moved to Operations VA.",
								"CON-20250627-9912",
							)
						}
					>
				...
				<>
					<div className="mb-3">
						...
						<div className="form-check mb-1">
							...
							<label className="form-check-label">
								VA-012 — Old Project Reserve (KES 1.2M)
							</label>
						</div>
						<div className="form-check mb-1">
							<input className="form-check-input" type="checkbox" />
							<label className="form-check-label">
								VA-015 — Legacy Marketing (KES 890K)
							</label>
						</div>
						<div className="form-check mb-1">
							<input className="form-check-input" type="checkbox" />
							<label className="form-check-label">
								VA-018 — Inactive Campaign (KES 450K)
							</label>
						</div>
					</div>
					<div className="mb-3">
					...
					>
						<i className="bi bi-info-circle me-1" /> Estimated annual fee
						savings: <strong>KES 12,500</strong>
					</div>
				</>,
			)}
		</MBox>
	...
	const renderIntegration = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-plug text-primary me-2" />
					VA Integration Settings
				</>
			}
			footer={
				<>
					...
					<button
						className={cx(s.btnPm, s.btnPmP)}
						onClick={() =>
							doAction("integrationModal", "Integration settings saved.", "")
						}
					>
						Save
					</button>
		...
		>
			{renderActionBody(
				...
				<>
					...
					<div className={s.statusRow}>
						<div>
							<strong>Accounting (QuickBooks)</strong>
							<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
			...
			footer={
				<>
					...
					<button
						className={cx(s.btnPm, s.btnPmP)}
						onClick={() =>
							doAction("securityModal", "Security settings updated.", "")
						}
					>
						Apply
					</button>
			...
			{renderActionBody(
				...
				<>
					<div className="mb-3">
						...
						<select className={s.formControl}>
							<option>Change Treasury PIN</option>
							<option>Enable 2FA for VA operations</option>
							<option>Review authorized signatories</option>
							<option>Download audit log</option>
						</select>
					</div>
					<div
						className="p-3 rounded"
						style={{ background: "var(--pm-info-soft)", fontSize: 12 }}
					>
						<i className="bi bi-info-circle me-1" /> All transfers above KES 5M
			...
			<div style={{ maxHeight: 500, overflowY: "auto" }}>
				...
				>
					...
					<div style={{ fontSize: 11, color: "#1E40AF" }}>
						Collections VA • 3 days inactive
					</div>
				</div>
				<div
					className="p-3 rounded mb-2"
				...
				>
					...
					<div style={{ fontSize: 11, color: "#065F46" }}>
						Duplicate debit KES 125K reversed
					</div>
				</div>
				<div
					className="p-3 rounded mb-2"
			...
			{renderActionBody(
				...
				<>
					...
					<div className="form-check form-switch mb-2">
						...
						/>
						<label className="form-check-label">
							SMS: Large unmatched amounts
						</label>
					</div>
					<div className="form-check form-switch mb-2">
						<input className="form-check-input" type="checkbox" />
						<label className="form-check-label">Push: Daily VA summary</label>
					</div>
					<div className="form-check form-switch">
						<input
							className="form-check-input"
						...
						/>
						<label className="form-check-label">
							Email: Monthly reconciliation report
						</label>
					</div>
				</>,
			)}
		...
		>
			<div className="text-center">
				...
				<p style={{ fontSize: 13, color: "var(--pm-muted)" }}>
					finance.director@company.co.ke
				</p>
				<div className="row g-2 text-start mt-3" style={{ fontSize: 13 }}>
					<div className="col-6">
						...
						>
							<span className="text-muted">Virtual Accounts</span>
							<br />
		...
		<MBox
			...
			title={
				<>
					...
					Virtual Account Portfolio Health
				</>
			}
			footer={
				<>
