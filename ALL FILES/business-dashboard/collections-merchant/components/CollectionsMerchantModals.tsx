...
export default function CollectionsMerchantModals({
	active,
	onClose,
	onOpen,
}: ModalsProps) {
			...
			>
				...
				{step === 1 && (
					<div className={s.fstepActive}>
						...
						<div className="mb-3">
							...
							<input className={s.formControl} defaultValue="Alice Wanjiku" />
						</div>
						<div className="mb-3">
							<label className={s.formLabel}>Phone / Account</label>
							<input className={s.formControl} defaultValue="0722 345 112" />
						</div>
						<div className="mb-3">
							...
							<div className={s.amountChips}>
								{AMOUNTS.map((amt) => (
									<button
										...
										className={cx(
											s.amountChip,
											selectedAmount === amt && s.amountChipActive,
										)}
							...
							{[
								{
									...
									desc: "STK Push to customer phone",
								},
								{
									icon: "bi-shop",
									label: "M-Pesa Till",
									desc: "Customer pays to Till number",
								},
								{
									icon: "bi-credit-card",
									label: "Card Payment",
									desc: "Visa/Mastercard checkout link",
								},
							].map((m) => (
				...
				{step === 3 && (
					<div className={s.fstepActive}>
						...
						>
							<i className="bi bi-info-circle me-1" /> STK Push will be sent to
							0722 345 112 for KES {selectedAmount}.
						</div>
					</div>
				)}
				{step === 4 && (
				...
				{step === 1 && (
					<div className={s.fstepActive}>
						...
						<div className="mb-3">
							...
							<input className={s.formControl} defaultValue="TXN-892109" />
						</div>
						<div className="mb-3">
						...
						<div className="mb-3">
							<label className={s.formLabel}>Refund Amount (KES)</label>
							<input
								type="number"
	...
	const renderPaybillConfig = () => (
				...
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"paybillConfigModal",
								"PayBill configuration saved. KYC document uploaded.",
							)
						}
					>
						Save Settings
		...
		>
			{renderActionBody(
				...
				<>
					<div className="mb-3">
						<label className={s.formLabel}>PayBill Number</label>
						<input
							className={s.formControl}
							defaultValue="512234"
							disabled
					...
					<div className="mb-3">
						...
						<input className={s.formControl} defaultValue="TechSolutions Ltd" />
					</div>
					<div className="mb-3">
						<label className={s.formLabel}>Account Validation Mode</label>
						<select className={s.formControl}>
							<option>Enabled (Strict API Lookup)</option>
							<option>Regex Pattern matching</option>
							<option>Disabled (Accept any)</option>
						</select>
					</div>
					<div className="mb-3">
						<label className={s.formLabel}>Customer Fee Configuration</label>
						<select className={s.formControl}>
							<option>Customer pays M-Pesa fee</option>
							<option>Merchant absorbs fee (Zero-rated)</option>
						</select>
					</div>
					<div
					...
					>
						<i className="bi bi-exclamation-triangle me-1" /> KYC Update
						Required: Please upload your latest CR12 document to avoid service
						suspension.
					</div>
				</>,
			)}
	...
	const renderTillConfig = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-shop text-info me-2" />
			...
			footer={
				<>
					...
					<button
						className={cx(s.btnPm, s.btnPmP)}
						onClick={() =>
							doAction("tillConfigModal", "Till settings updated successfully.")
						}
					>
						Save Settings
					</button>
		...
		>
			{renderActionBody(
				...
				<>
					<div className="mb-3">
						<label className={s.formLabel}>Till Number</label>
						<input
							className={s.formControl}
							defaultValue="882001"
							disabled
					...
					<div className="mb-3">
						<label className={s.formLabel}>Store / Branch Name</label>
						<input
							className={s.formControl}
							defaultValue="Nairobi CBD Branch"
						/>
					</div>
					<div className="form-check form-switch mb-3">
						...
						<label className="form-check-label">
							Enable LNMO API for online checkout
						</label>
					</div>
					<div className="form-check form-switch mb-3">
						<input className="form-check-input" type="checkbox" />
						<label className="form-check-label">
							Allow staff to initiate reversals
						</label>
					</div>
					<div
						className="p-3 rounded mt-3"
					...
					>
						<div className="d-flex justify-content-between mb-1">
							<span>Current MDR Rate</span>
							<strong>1.0%</strong>
						</div>
						<div className="d-flex justify-content-between">
							<span>Settlement</span>
							<strong>Real-time to Wallet</strong>
						</div>
					</div>
				</>,
			)}
		...
		>
			<div className="text-center p-4">
				...
				<p style={{ fontSize: 13, color: "var(--pm-ink-soft)" }}>
					Your PesaLink merchant account request is currently under review by
					the acquiring bank. This usually takes 24-48 hours.
				</p>
			</div>
				...
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"cardConfigModal",
								"Card settings updated. Tokenization activated.",
							)
						}
					>
						Save Settings
				...
				<>
					<div className="form-check form-switch mb-3">
						<input
							...
							defaultChecked
						/>
						<label className="form-check-label">Accept Visa / Mastercard</label>
					</div>
					<div className="form-check form-switch mb-3">
						<input
							className="form-check-input"
					...
					>
						<div className="d-flex justify-content-between align-items-center">
							<div>
								<strong style={{ fontSize: 13 }}>Enable Tokenization</strong>
								<div style={{ fontSize: 11, color: "var(--pm-ink-soft)" }}>
									Allow customers to save cards securely for 1-click checkout.
									Recommended by AI.
								</div>
							</div>
					...
					<div className="mb-3">
						<label className={s.formLabel}>Accepted Currencies</label>
						<div className="d-flex gap-2">
							<span className={cx(s.badge, s.badgeS)}>KES</span>
							<span
								className={s.badge}
								style={{ background: "var(--pm-surface-2)" }}
							>
		...
		return (
			...
			>
				<div className={cx(s.pills, "mb-3")}>
					<button
						className={cx(s.pill, currentTab === "keys" && s.pillActive)}
						onClick={() => switchTab("api", "keys")}
					>
						API Keys
					</button>
					<button
						className={cx(s.pill, currentTab === "webhooks" && s.pillActive)}
						onClick={() => switchTab("api", "webhooks")}
					>
						Webhooks
					</button>
					<button
						className={cx(s.pill, currentTab === "logs" && s.pillActive)}
				...
				{currentTab === "keys" && (
					<div className={s.tpanelActive}>
						<div
							className="p-3 rounded mb-3"
							style={{ background: "var(--pm-purple-soft)", fontSize: 12 }}
						>
							<i className="bi bi-exclamation-triangle me-1" /> Your LNMO
							Production Keys will expire in 3 days. Please rotate them.
						</div>
						<div className="mb-3">
							<label className={s.formLabel}>Consumer Key</label>
							<div className="d-flex gap-2">
								<input
									className={s.formControl}
									type="password"
						...
						<div className="mb-3">
							<label className={s.formLabel}>Consumer Secret</label>
							<div className="d-flex gap-2">
								<input
									className={s.formControl}
									type="password"
						...
						<button
							...
							onClick={() =>
								doAction(
									"apiConfigModal",
									"Keys rotated successfully. Update your application.",
								)
							}
						>
				...
				{currentTab === "webhooks" && (
					<div className={s.tpanelActive}>
						<div className="mb-3">
							<label className={s.formLabel}>Validation URL</label>
							<input
								className={s.formControl}
								defaultValue="https://api.yourdomain.com/paymo/validate"
							/>
						</div>
						<div className="mb-3">
							<label className={s.formLabel}>Confirmation URL</label>
							<input
								className={s.formControl}
								defaultValue="https://api.yourdomain.com/paymo/confirm"
							/>
						</div>
						<button className={cx(s.btnPm, s.btnSm, s.btnPmP)}>
							Save Endpoints
						</button>
					</div>
				)}
	...
	const renderSettlement = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-bank text-info me-2" />
					Settlement Pipeline
				</>
			}
			footer={
			...
			<div className="mt-3">
				<button
					...
					onClick={() =>
						doAction(
							"settlementModal",
							"Manual withdrawal of KES 304,100 initiated to Equity Bank.",
						)
					}
				>
					Withdraw Available Funds to Bank
				</button>
			</div>
		</MBox>
	);
				...
				<div className="col-lg-4">
					...
					<div className="p-3 border rounded">
						...
						>
							...
							<strong style={{ color: "var(--pm-accent)" }}>98.4%</strong>
						</div>
					</div>
				</div>
			</div>
				...
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"disputeModal",
								"Dispute defense submitted successfully!",
								"DSP-88291",
							)
						}
					>
		...
		>
			{renderActionBody(
				...
				<>
					...
					>
						<strong>Chargeback Details</strong>
						<br />
						Visa ***4112 · KES 12,500 · Reason: Service not provided
						<br />
					...
					<div className="mb-3">
						...
						<textarea
							className={s.formControl}
							rows={3}
							defaultValue="Service was delivered on October 15, 2025 as per the contract agreement."
						/>
					</div>
				</>,
			)}
	...
	const renderGenerateQR = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-qr-code text-info me-2" />
					Generate Dynamic QR
				</>
			}
			footer={
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"generateQRModal",
								"QR code generated and ready for deployment!",
							)
						}
					>
						Generate
		...
		>
			{renderActionBody(
				...
				<>
					<div className="mb-3">
						<label className={s.formLabel}>QR Type</label>
						<select className={s.formControl}>
							<option>M-Pesa PayBill (STK Push)</option>
							<option>M-Pesa Till (Buy Goods)</option>
							<option>Payment Link (Universal)</option>
						</select>
					</div>
					<div className="mb-3">
						<label className={s.formLabel}>Amount (KES)</label>
						<input
							...
							className={s.formControl}
							defaultValue="0"
							placeholder="0 = Customer enters amount"
						/>
					</div>
					<div className="mb-3">
						<label className={s.formLabel}>Reference / Account</label>
						<input className={s.formControl} defaultValue="512234" />
					</div>
				...
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"sendReminderModal",
								"Reminders sent to 14 customers via Email & SMS.",
							)
						}
					>
						Send Reminders
		...
		>
			{renderActionBody(
				...
				<>
					...
					<div className="mb-3">
						<label className={s.formLabel}>Message Template</label>
						<textarea
							className={s.formControl}
							rows={3}
							defaultValue="Hi {name}, your invoice of KES {amount} is due. Please pay via PayBill 512234."
						/>
					</div>
					<div
						className="p-3 rounded"
	...
	const renderExportReport = () => (
		...
		>
			{renderActionBody(
				...
				<>
					<div className="mb-3">
						<label className={s.formLabel}>Data Type</label>
						<select className={s.formControl}>
	...
	const renderHealthCheck = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-heart-pulse text-success me-2" />
		...
		>
			...
			<div
				...
				style={{ fontSize: 13 }}
			>
				<span>PayBill Active</span>
				<span className={cx(s.badge, s.badgeS)}>Running</span>
			</div>
			<div
				className="p-3 border rounded mb-2 d-flex justify-content-between"
				style={{ fontSize: 13 }}
			>
				...
				<span className={cx(s.badge, s.badgeS)}>200ms avg</span>
			</div>
			<div
				className="p-3 border rounded mb-2 d-flex justify-content-between"
				style={{ fontSize: 13 }}
			>
				<span>PesaLink Status</span>
				<span className={cx(s.badge, s.badgeW)}>Pending KYC</span>
			</div>
			<div
			...
			>
				...
				<span className={cx(s.badge, s.badgeI)}>2 pending</span>
			</div>
		</MBox>
	);
	...
	const renderNotifications = () => (
		...
		>
			...
			>
				<strong>Chargeback received</strong>
				<div style={{ fontSize: 11 }}>Visa ***4112 · KES 12,500</div>
			</div>
			<div
				className="p-3 rounded mb-2"
				style={{ background: "var(--pm-warning-soft)" }}
			>
				<strong>Refund approval needed</strong>
				<div style={{ fontSize: 11 }}>Customer: John Mark · KES 3,400</div>
			</div>
			<div
				className="p-3 rounded mb-2"
				style={{ background: "var(--pm-info-soft)" }}
			>
				<strong>KYC Update required</strong>
				<div style={{ fontSize: 11 }}>Upload CR12 for PB 512234</div>
			</div>
			<div
				className="p-3 rounded mb-2"
				style={{ background: "var(--pm-purple-soft)" }}
			>
				<strong>API token expires soon</strong>
				<div style={{ fontSize: 11 }}>Rotate keys in 3 days</div>
			</div>
			<div
				className="p-3 rounded"
				style={{ background: "var(--pm-accent-soft)" }}
			>
				<strong>KES 412,500 collected today!</strong>
				<div style={{ fontSize: 11 }}>184 successful transactions</div>
			</div>
		</MBox>
	);
		...
		>
			<div className="text-center">
				...
				<p style={{ fontSize: 13, color: "var(--pm-muted)" }}>
					Finance Admin · TechSolutions Ltd
				</p>
			...
			<div className="row g-3 mb-3">
				<div className="col-md-6">
					...
					>
						...
						<div style={{ fontSize: 16, fontWeight: 700 }}>TXN-892110</div>
					</div>
				</div>
				<div className="col-md-6">
					<div
	...
	const renderCustomerSegment = () => (
		...
		>
			<div className="row g-3 mb-3">
				<div className="col-md-4">
					...
					>
						...
						<div style={{ fontSize: 22, fontWeight: 700 }}>142</div>
					</div>
				</div>
				<div className="col-md-4">
					<div
					...
					>
						...
						<div style={{ fontSize: 22, fontWeight: 700 }}>810</div>
					</div>
				</div>
				<div className="col-md-4">
					<div
					...
					>
						...
						<div style={{ fontSize: 22, fontWeight: 700 }}>252</div>
					</div>
				</div>
			</div>
			<div
			...
			>
				...
				<strong style={{ color: "var(--pm-danger)" }}>18 customers</strong>
			</div>
			<div
				className="p-3 border rounded d-flex justify-content-between"
				style={{ fontSize: 13 }}
			>
				<span>Avg LTV (VIP)</span>
				<strong>KES 142,500</strong>
			</div>
		</MBox>
	);
			...
			footer={
				<>
					...
					<button
						className={cx(s.btnPm, s.btnPmP)}
						onClick={() =>
							doAction("addCustomerModal", "Customer added successfully!")
						}
					>
						Add Customer
					</button>
		...
		>
			{renderActionBody(
				...
				<>
					...
					<div className="mb-3">
						<label className={s.formLabel}>Segment</label>
						<select className={s.formControl}>
