		...
		return (
			...
			>
				...
				{step === 1 && (
					...
					>
						<div className="mb-2">
							Download <a href="#" style={{ color: "var(--pm-primary)", fontWeight: 600 }}>template</a> with required columns:
						</div>
		...
		>
			<div className="row g-3 mb-3">
				<div className="col-md-3 col-6">
					...
					>
						...
						<div style={{ fontSize: 10, fontWeight: 700, color: "var(--pm-accent)" }}>
							COMPLIANCE
						</div>
					</div>
				</div>
			...
			<div className="table-responsive mt-3">
				<table className={s.tbl}>
					...
					<tbody>
						<tr>
							<td data-label="Metric">Director Verification Rate</td>
							<td data-label="Value">94%</td>
							<td data-label="Status"><span className={cx(s.badge, s.badgeS)}>Good</span></td>
						</tr>
						<tr>
							<td data-label="Metric">Document Authenticity</td>
							<td data-label="Value">100%</td>
							<td data-label="Status"><span className={cx(s.badge, s.badgeS)}>Excellent</span></td>
						</tr>
						<tr>
							<td data-label="Metric">PEP Screening Coverage</td>
							<td data-label="Value">100%</td>
							<td data-label="Status"><span className={cx(s.badge, s.badgeS)}>Excellent</span></td>
						</tr>
						<tr>
							<td data-label="Metric">Adverse Media Checks</td>
							<td data-label="Value">100%</td>
							<td data-label="Status"><span className={cx(s.badge, s.badgeS)}>Excellent</span></td>
						</tr>
					</tbody>
