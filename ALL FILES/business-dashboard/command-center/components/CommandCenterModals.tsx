					...
					<table className={s.tbl}>
						...
						<tbody>
							<tr>
								...
								<td data-label="Amount"><strong>KES 1.20M</strong></td>
								<td data-label="% of Total">66%</td>
							</tr>
							<tr>
								<td data-label="Source">M-Pesa</td>
								<td data-label="Amount"><strong>KES 420K</strong></td>
								<td data-label="% of Total">23%</td>
							</tr>
							<tr>
								<td data-label="Source">Payment Links</td>
								<td data-label="Amount"><strong>KES 200K</strong></td>
						...
						<tfoot>
							<tr style={{ fontWeight: 700 }}>
								...
								<td data-label="Amount"><strong>KES 1.82M</strong></td>
					...
					<table className={s.tbl}>
						...
						<tfoot>
							<tr style={{ fontWeight: 700 }}>
								...
								<td data-label="Amount"><strong>KES 940K</strong></td>
								<td data-label="% of Total">100%</td>
							</tr>
						</tfoot>
					</table>
					...
					<table className={s.tbl}>
						...
						<tbody>
							<tr>
								...
								<td data-label="Amount"><strong>KES 4,200,000</strong></td>
								<td data-label="Timestamp">26 Jun 14:20</td>
								<td data-label="Action">
									<button className={cx(s.btnPm, s.btnSm)} onClick={() => onOpen("runPayrollModal")}>Review</button>
								</td>
							</tr>
							<tr>
								<td data-label="Request">Supplier: OfficeMart Stationers</td>
								<td data-label="Maker">James K.</td>
								<td data-label="Amount"><strong>KES 120,000</strong></td>
							...
							<tr>
								...
								<td data-label="Amount"><strong>KES 85,000</strong></td>
			...
			<>
				...
				<div className="row g-3 mb-3">
					<div className="col-6">
						...
						<input type="date" className={s.formControl} defaultValue="2025-06-01" />
					</div>
					<div className="col-6">
						<label className={s.formLabel}>To</label>
						<input type="date" className={s.formControl} defaultValue="2025-06-27" />
					</div>
				</div>
				<div className="mb-3">
		...
		>
			<>
				<div className="text-center mb-4">
					<div style={{ fontSize: 48, fontWeight: 800, color: "var(--pm-accent)", fontFamily: "var(--pm-font-display)" }}>92</div>
					<div style={{ fontSize: 12, color: "var(--pm-muted)", fontWeight: 600 }}>HEALTH SCORE</div>
				</div>
				<div className={s.statusRow}>
					<div><strong>Liquidity Ratio</strong></div>
					<span className={cx(s.badge, s.badgeS)}>Excellent</span>
				</div>
				<div className={s.statusRow}>
					<div><strong>Collections Rate</strong></div>
