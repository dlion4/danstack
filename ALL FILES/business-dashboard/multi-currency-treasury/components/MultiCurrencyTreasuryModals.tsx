...
export default function MultiCurrencyTreasuryModals({
	active,
	onClose,
	onOpen,
}: ModalsProps) {
	...
	const renderTrade = () => {
		...
		return (
			<MBox
				...
				title={
					<>
						<i className="bi bi-currency-exchange text-primary me-2" />
						Execute FX Trade
					</>
				}
				footer={
			...
			>
				...
				{step === 1 && (
					<div className={s.fstepActive}>
						...
						<div className="mb-3">
							<label className={s.formLabel}>Pair</label>
							<select className={s.formControl}>
								<option>USD/KES (129.42)</option>
								<option>EUR/KES (139.80)</option>
								<option>GBP/KES (167.90)</option>
								<option>USD/EUR (0.926)</option>
							</select>
						</div>
						<div className="mb-3">
							<label className={s.formLabel}>Trade Type</label>
							<select className={s.formControl}>
								<option>Spot (T+2)</option>
								<option>Forward (Custom date)</option>
								<option>Swap</option>
							</select>
						</div>
					</div>
				...
				{step === 2 && (
					<div className={s.fstepActive}>
						...
						<div className="mb-3">
							...
							<input className={s.formControl} defaultValue="50000" />
						</div>
						<div className="mb-3">
							<label className={s.formLabel}>Direction</label>
							<select className={s.formControl}>
								<option>Buy USD / Sell KES</option>
								<option>Sell USD / Buy KES</option>
							</select>
						</div>
						<div
				...
				{step === 3 &&
					renderActionBody(
						...
						<div className={s.fstepActive}>
							...
							<div className="mb-3">
								<label className={s.formLabel}>Settlement Date</label>
								<input
									type="date"
							...
							<button
								...
								onClick={() =>
									doAction(
										"tradeModal",
										"FX trade executed successfully!",
										"FX-8921",
									)
								}
							>
								Confirm Trade <i className="bi bi-check-lg" />
							</button>
						</div>,
					)}
				{step === 4 &&
			...
			>
				...
				{step === 1 && (
					<div className={s.fstepActive}>
						<div className="mb-3">
							...
							<select className={s.formControl}>
								<option>USD Account (USD 318,400)</option>
								<option>EUR Account (EUR 142,800)</option>
								<option>GBP Account (GBP 84,200)</option>
							</select>
						</div>
						<div className="mb-3">
				...
				{step === 2 && (
					<div className={s.fstepActive}>
						...
						>
							<div className="d-flex justify-content-between mb-1">
								<span className="text-muted">FX Rate</span>
								<strong>129.42</strong>
							</div>
							<div className="d-flex justify-content-between">
				...
				{step === 3 &&
					renderActionBody(
						...
						<div className={s.fstepActive}>
							<div className="mb-3">
								<label className={s.formLabel}>Purpose / Narrative</label>
								<textarea
									className={s.formControl}
									rows={2}
									defaultValue="Supplier payment — invoice ref INV-8829"
								/>
							</div>
							<button
								className={cx(s.btnPm, s.btnPmP, "w-100")}
							...
							>
								Confirm Transfer <i className="bi bi-check-lg" />
							</button>
						</div>,
					)}
				{step === 4 &&
	...
	const renderHedge = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-shield text-accent me-2" />
					Set FX Hedge
				</>
			}
			footer={
				<>
					...
					<button
						className={cx(s.btnPm, s.btnPmP)}
						onClick={() =>
							doAction("hedgeModal", "Forward contract created!", "FX-8922")
						}
					>
						Create Hedge
					</button>
		...
		>
			{renderActionBody(
				...
				<>
					...
					<div className="mb-3">
						<label className={s.formLabel}>Forward Period</label>
						<select className={s.formControl}>
					...
					>
						<i className="bi bi-info-circle me-1" /> Forward rate: 129.55
						(current spot: 129.42). Points: +0.13
					</div>
				</>,
			)}
		</MBox>
			...
			<div className="row g-3 mb-3">
				...
				<div className="col-md-6">
					...
					>
						...
						<br />
						<strong style={{ color: "#047857" }}>+KES 42,000</strong>
					</div>
				</div>
			</div>
			<div
	...
	const renderRollContract = () => (
				...
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"rollContractModal",
								"Contract rolled. New ID: FX-8922",
								"FX-8922",
							)
						}
					>
		...
		>
			{renderActionBody(
				...
				<>
					<div className="mb-3">
						<label className={s.formLabel}>Contract</label>
						<select className={s.formControl}>
							<option>FX-8821 • USD 120K • 27 Jun</option>
						</select>
					</div>
					<div className="mb-3">
						<label className={s.formLabel}>New Expiry</label>
						<select className={s.formControl}>
							<option>30 days</option>
							<option>60 days</option>
							<option>90 days</option>
		...
		<MBox
			...
			footer={
				<>
					...
					<button
						className={cx(s.btnPm, s.btnPmP)}
						onClick={() => doAction("rateAlertModal", "Rate alert saved.", "")}
					>
						Save Alert
					</button>
				</>
		...
		>
			{renderActionBody(
				...
				<>
					...
					<div className="mb-3">
						<label className={s.formLabel}>Alert When</label>
						<select className={s.formControl}>
							<option>Rate crosses above</option>
							<option>Rate drops below</option>
						</select>
					</div>
					<div className="mb-3">
						<label className={s.formLabel}>Threshold</label>
						<input className={s.formControl} defaultValue="130.00" />
					</div>
					<div className="form-check form-switch mb-2">
						<input
							...
							defaultChecked
						/>
						<label className="form-check-label">Email notification</label>
					</div>
					<div className="form-check form-switch">
						<input className="form-check-input" type="checkbox" />
						<label className="form-check-label">SMS notification</label>
					</div>
				</>,
			)}
		</MBox>
	...
	const renderMarket = () => (
		...
		>
			...
			>
				<h6 style={{ fontWeight: 700, color: "#1D4ED8" }}>
					CBK Policy Meeting — Tomorrow
				</h6>
				<p style={{ fontSize: 13, color: "#1E40AF", margin: "4px 0 0" }}>
					Consensus: 25bps rate cut expected. USD/KES likely to weaken to
					130.50–131.00 range.
				</p>
			</div>
			<div
			...
			>
				...
				<p style={{ fontSize: 13, color: "#92400E", margin: "4px 0 0" }}>
					UK inflation data tomorrow — potential 1.5% volatility. Consider
					hedging before event.
				</p>
			</div>
			<div
				className="p-3 rounded"
				style={{ background: "var(--pm-accent-soft)" }}
			>
				<h6 style={{ fontWeight: 700, color: "#047857" }}>
					TZS Devaluation Risk
				</h6>
				<p style={{ fontSize: 13, color: "#065F46", margin: "4px 0 0" }}>
					Tanzania central bank under pressure. 2–3% devaluation possible in
					next 30 days.
				</p>
			</div>
		</MBox>
	...
	const renderCompliance = () => (
		<MBox
			...
			title={
				<>
					<i className="bi bi-file-earmark-text text-warning me-2" />
				...
				<>
					...
					<button
						...
						onClick={() =>
							doAction(
								"complianceModal",
								"STR filed successfully!",
								"CBK-STR-20250627-9914",
							)
						}
					>
						File STR
		...
		>
			{renderActionBody(
				...
				<>
					...
					>
						<strong>Suspicious Transaction Report (STR) Required</strong>
						<br />
						Large USD inflow of KES 12.4M from US client requires CBK filing
						within 24 hours.
					</div>
					<div className="mb-3">
						<label className={s.formLabel}>Transaction</label>
						<select className={s.formControl}>
							<option>USD 95,500 incoming • 26 Jun</option>
						</select>
					</div>
					<div className="mb-3">
						<label className={s.formLabel}>Report Category</label>
						<select className={s.formControl}>
							<option>Large cash transaction</option>
							<option>Cross-border transfer</option>
					...
					<div className="mb-3">
						...
						<textarea
							className={s.formControl}
							rows={2}
							defaultValue="Legitimate import payment — supporting documents attached."
						/>
					</div>
				</>,
			)}
	...
	const renderFXNotif = () => (
		<MBox
			...
			footer={
				<>
					<button className={s.btnPm} onClick={() => onOpen("rateAlertModal")}>
						Manage Alerts
					</button>
					<button className={s.btnPm} onClick={onClose}>
						Close
		...
		>
			<div style={{ maxHeight: 500, overflowY: "auto" }}>
				...
				>
					<strong>Forward FX-8821 expires today</strong>
					<div style={{ fontSize: 11, color: "#7F1D1D" }}>
						USD 120K • Action required before 5 PM
					</div>
				</div>
				<div
					className="p-3 rounded mb-2"
					style={{ background: "var(--pm-warning-soft)", fontSize: 13 }}
				>
					<strong>GBP volatility alert triggered</strong>
					<div style={{ fontSize: 11, color: "#92400E" }}>
						1.8% move in last 4 hours
					</div>
				</div>
				<div
					className="p-3 rounded mb-2"
				...
				>
					<strong>USD 85K settlement confirmed</strong>
				...
				>
					<strong>STR filed successfully</strong>
					<div style={{ fontSize: 11, color: "#065F46" }}>
						Reference CBK-STR-20250627-9914
					</div>
				</div>
				<div
					className="p-3 rounded mb-2"
				...
				>
					<strong>Rate alert: USD/KES crossed 129.50</strong>
	...
	const renderMarketComment = () => (
		...
		>
			...
			>
				...
				<p style={{ fontSize: 13, color: "var(--pm-ink-soft)", marginTop: 8 }}>
					CBK expected to cut policy rate by 25bps tomorrow. This should put
					downward pressure on KES, pushing USD/KES toward 130.00–130.80 range.
					Recommend locking in any USD receivables above 130.00.
				</p>
			</div>
			<div
				className="p-3 rounded"
			...
			>
				...
				<p style={{ fontSize: 13, color: "var(--pm-ink-soft)", marginTop: 8 }}>
					UK CPI data tomorrow could trigger 1.5% volatility. Consider hedging
					50% of July GBP exposure before the event.
				</p>
			</div>
		</MBox>
	);
				...
				<>
					<div className="mb-3">
						...
						<select className={s.formControl}>
							...
							<option>Enable 2FA for FX trades</option>
					...
					<div
						...
						style={{ background: "var(--pm-info-soft)", fontSize: 12 }}
					>
						<i className="bi bi-info-circle me-1" /> All FX trades above USD 50K
		...
		>
			<div className="text-center">
				...
				<p style={{ fontSize: 13, color: "var(--pm-muted)" }}>
					james.kamau@company.co.ke · +254 712 345 890
				</p>
				<div className="row g-2 text-start mt-3" style={{ fontSize: 13 }}>
					<div className="col-6">
						<div
							...
							style={{ background: "var(--pm-surface-2)" }}
						>
							<span className="text-muted">Treasury Score</span>
							<br />
					...
					<div className="col-6">
						<div
							...
							style={{ background: "var(--pm-surface-2)" }}
						>
							<span className="text-muted">Open Contracts</span>
							<br />
							<strong>4</strong>
						</div>
					</div>
					...
					<div className="col-6">
						<div
							...
							style={{ background: "var(--pm-surface-2)" }}
						>
							<span className="text-muted">STRs Filed</span>
							<br />
							<strong>12 YTD</strong>
						</div>
					</div>
				</div>
			</div>
	...
	const renderAttention = () => (
		...
		>
			<div className={s.statusRow}>
				<div>
					<strong>USD 45K forward expires today</strong>
					<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>FX-8821</div>
				</div>
				<button
					className={cx(s.btnPm, s.btnSm)}
					onClick={() => onOpen("rollContractModal")}
				>
					Roll
				</button>
			</div>
			...
			<div className={s.statusRow}>
				<div>
					<strong>GBP volatility alert</strong>
					<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
						1.8% in 4hrs
					</div>
				</div>
			...
			<div className={s.statusRow}>
				<div>
					<strong>Hedge ratio below target</strong>
					<div style={{ fontSize: 11, color: "var(--pm-muted)" }}>
						68% vs 75%
					</div>
				</div>
						...
						<tr>
							...
							<td data-label="Actions">
								<button
									className={cx(s.btnPm, s.btnSm)}
									onClick={() =>
										doAction("accountModal", "Account settings updated.", "")
									}
								>
									Edit
								</button>
	...
	const renderReportExport = () => (
			...
			footer={
				<>
					...
					<button
						className={cx(s.btnPm, s.btnPmP)}
						onClick={() =>
							doAction("reportExportModal", "Report downloaded.", "")
						}
					>
						Export
					</button>
		...
		>
			{renderActionBody(
				...
				<>
					<div className="mb-3">
						<label className={s.formLabel}>Report</label>
						<select className={s.formControl}>
							<option>Daily Treasury Position</option>
							<option>FX P&L</option>
							<option>Hedging Report</option>
	...
	const renderFAQ = () => (
		...
		>
			<div className={s.statusRow}>
				<div>
					<strong>How do I roll a forward contract?</strong>
					<div style={{ fontSize: 12, color: "var(--pm-ink-soft)" }}>
						Go to FX Contracts → select contract → Roll. New rate based on
			...
			<div className={s.statusRow}>
				<div>
					<strong>What is the cut-off time for same-day FX?</strong>
					<div style={{ fontSize: 12, color: "var(--pm-ink-soft)" }}>
						Spot trades before 2 PM EAT settle T+2. After 2 PM → T+3.
					</div>
				</div>
			</div>
		</MBox>
